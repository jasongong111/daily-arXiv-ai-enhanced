...
TL;DR: CALM integrates symbolic reasoning with neural networks for context-sensitive decision-making in multi-modal environments, outperforming classical logic and LLMs.


<details>
  <summary>Details</summary>
Motivation: Classic logic systems lack nuance and grounding in multi-modal data, while neural networks lack interpretable reasoning. CALM bridges this gap.

Method: CALM uses domain trees for predicates, refining analog truth values via neural networks and symbolic reasoning.
...
TL;DR: MEAL is the first benchmark for continual multi-agent reinforcement learning (CMARL), addressing gaps in current benchmarks by enabling GPU acceleration for longer task sequences.
...
Method: MEAL leverages JAX for GPU acceleration, allowing continual learning across 100 tasks on a standard desktop PC. It evaluates naive combinations of CL and MARL methods.

Result: Naive CL and MARL combinations perform well in simple environments but fail in complex settings requiring sustained coordination. Ablation studies highlight critical CMARL features.

Conclusion: MEAL provides a scalable benchmark for CMARL, revealing the need for specialized methods to handle complex, adaptive multi-agent tasks.
...
TL;DR: The paper introduces Truncated Proximal Policy Optimization (T-PPO) to enhance training efficiency for reasoning LLMs by addressing inefficiencies in PPO, achieving up to 2.5x speedup.
...
Method: T-PPO improves efficiency via Extended Generalized Advantage Estimation (EGAE) and a mechanism for independent optimization of policy and value models, reducing redundant computations.

Result: T-PPO achieves a 2.5x training efficiency improvement on AIME 2024 with a 32B model, outperforming competitors.
...
<details>
  <summary>Details</summary>
Motivation: Traditional heuristic designs for combinatorial optimization rely on manual expertise and lack generalization. HeurAgenix aims to automate and improve heuristic selection.

Method: HeurAgenix uses LLMs to evolve heuristics by comparing solutions and extracting strategies, then dynamically selects the best heuristic for each problem state. It includes a dual-reward mechanism for fine-tuning.

Result: HeurAgenix outperforms LLM-based hyper-heuristics and matches or exceeds specialized solvers in benchmarks.

Conclusion: HeurAgenix demonstrates the potential of LLMs in automating heuristic design and selection for combinatorial optimization.
...
TL;DR: The paper explores using Reinforcement Learning (RL) and Multi-Agent RL (MARL) for autonomous Earth Observation (EO) mission planning in multi-satellite systems, addressing challenges like real-time decision-making, resource constraints, and coordination.


<details>
  <summary>Details</summary>
Motivation: The rapid growth of LEO satellites has created a need for efficient autonomous coordination in EO missions, which traditional methods fail to address.
...
Conclusion: The findings provide a foundation for autonomous satellite operations and practical guidelines for improving policy learning in decentralised EO missions.
...
TL;DR: The paper proposes a cooperative MEC framework using UAVs and vessels for efficient computation offloading and resource allocation in maritime IoT, addressing uncertain tasks with Lyapunov optimization and a heterogeneous-agent soft actor-critic method.


<details>
  <summary>Details</summary>
Motivation: The rapid growth of maritime IoT demands efficient computation offloading and resource allocation, challenged by uncertain tasks and heterogeneous resources.
...
Conclusion: The proposed approach successfully addresses maritime computation offloading and resource allocation challenges, validated by simulation results.
...
Result: CAN outperforms baselines in various tasks and environments, with gains attributed to the Causal Understanding Module.

Conclusion: The causal framework improves navigation performance effectively in both Reinforcement and Supervised Learning settings without added computational cost.
...
<details>
  <summary>Details</summary>
Motivation: FA is complex and knowledge-intensive; AI integration can automate tasks like defect detection, case retrieval, and report generation, but orchestrating multiple AI models is challenging.

Method: The LPA combines LLMs with advanced planning and external tools to autonomously process queries, retrieve data, and generate responses.

Result: Evaluation shows the LPA is effective and reliable in supporting FA tasks.

Conclusion: The LPA successfully addresses the challenge of integrating AI models into FA workflows, enhancing efficiency and reliability.
...
TL;DR: A framework for constructing natural language state representations for LLM agents in multi-agent games, showing how state representation affects behavior and stability.


<details>
  <summary>Details</summary>
Motivation: Address the ad hoc and inconsistent approaches in encoding game history for LLM agents, which hinder comparability and understanding of state representation impact.

Method: Proposes a framework with three axes: action informativeness, reward informativeness, and prompting style. Applied to a dynamic selfish routing game.

Result: Summarized history, regret-based rewards, and limited action info lead to behavior closer to equilibrium and stable play. Other representations cause deviations or instability.

Conclusion: State representation significantly impacts LLM agent behavior, with specific methods aligning better with game theory predictions.
...
TL;DR: The paper introduces an AI Policy Module for CS curricula to address gaps in preparing students for AI ethics and policy challenges, showing positive impacts on student attitudes and confidence.
...
Method: Developed an AI Policy Module, including a technical assignment on AI regulation, and evaluated its impact via pre- and post-module surveys.
...
TL;DR: The paper addresses the inefficiency of large reasoning models (LRMs) due to overthinking and proposes two methods to enhance efficiency without compromising accuracy.


<details>
  <summary>Details</summary>
Motivation: LRMs often generate verbose and redundant content, increasing inference costs. The study aims to uncover and leverage their inherent capacity for concise reasoning.

Method: Two methods are introduced: Efficiency Steering (a training-free activation technique) and Self-Rewarded Efficiency RL (a reinforcement learning framework).

Result: Experiments on seven LRM backbones show reduced reasoning length while maintaining or improving task performance.

Conclusion: The study demonstrates that LRMs' intrinsic capabilities can be guided to improve reasoning efficiency.
...
Method: Uses language-driven exploration and PSO-inspired feedback-guided updates to evolve candidate systems.

Result: Achieves significant improvements (e.g., +261.8% over ADAS) on real-world tasks like planning and coordination.

Conclusion: SwarmAgentic advances scalable, autonomous agentic system design by combining swarm intelligence with automated generation.
...
TL;DR: The paper introduces Embodied Web Agents, a new AI paradigm integrating physical embodiment and web-scale reasoning, along with a benchmark for tasks requiring both.
...
Method: Developed a unified simulation platform (3D environments + web interfaces) and a benchmark for diverse tasks like cooking and navigation.

Result: Revealed performance gaps between state-of-the-art AI and humans, highlighting challenges and opportunities.

Conclusion: The work establishes a foundation for cross-domain AI intelligence, with public datasets and tools available.
...
Method: Proposed MedSyn, a framework for multi-step, interactive dialogues between physicians and LLMs, allowing dynamic exchanges and challenge of suggestions.
...
TL;DR: The paper introduces a 2D extension of parallel tempering (2D-PT) to improve sampling in constrained Ising problems, eliminating the need for penalty strength tuning and achieving faster mixing.
...
Method: The authors propose a two-dimensional parallel tempering algorithm (2D-PT) that interpolates penalty strengths, ensuring constraint satisfaction and improving mixing.

Result: 2D-PT achieves near-ideal mixing (O(1/t) in graph sparsification and provides significant speedup over conventional PT in Wishart instances.
...
TL;DR: The paper compares two AI approaches: DeepSeek-V3, a large-scale generalist LLM, and NetraAI, a specialized framework for clinical data. NetraAI combines dynamical systems, information geometry, and evolutionary algorithms to identify predictive patient subgroups, enhanced by an LLM Strategist for meta-evolutionary guidance. Case studies show significant improvements in classification accuracy.


<details>
  <summary>Details</summary>
Motivation: To address the need for stable, interpretable AI in clinical trials, where small datasets require robust and explainable models.

Method: NetraAI integrates contraction mappings, information geometry, and evolutionary algorithms to embed features in a metric space and identify stable subgroups. An LLM Strategist acts as a meta-evolutionary layer for guidance.
...
Result: Superior performance in BLEU/Rouge scores for text generation and 10% F1 improvement in sentiment classification.
...
Method: Train a ConvNet offline, freeze most weights, and retrain selected layers for transfer learning. Tested on steady CFD data for domain and task adaptation.
...
Conclusion: The approach shows promise for real-time prediction but requires refinement for noisy data scenarios.
...
<details>
  <summary>Details</summary>
Motivation: Existing multimodal approaches neglect visual data in time series, missing key physical information like geospatial context in satellite imagery.
...
<details>
  <summary>Details</summary>
Motivation: Addressing retrieval challenges in multi-deep storage systems due to lane blockages and the limitations of homogeneous storage strategies.

Method: Graph-based state representation with GNN and Transformer for priority assignment, tested against heuristic methods.

Result: Superior performance in minimizing tardiness compared to heuristic approaches.

Conclusion: The framework effectively optimizes retrieval in diverse storage layouts.
...
TL;DR: AZT1D is a new dataset for T1D research, offering detailed patient data (CGM, insulin, carbs, device modes) to advance AI/ML applications in diabetes management.


<details>
  <summary>Details</summary>
Motivation: The scarcity of comprehensive public datasets for T1D limits progress in personalized therapy and glucose prediction. AZT1D addresses this gap.

Method: Collected data from 25 T1D patients on AID systems over 6-8 weeks, including CGM, insulin pump data, carbs, and device modes.

Result: AZT1D provides granular details (e.g., bolus insulin specifics) rarely found in existing datasets, enabling diverse AI/ML applications.

Conclusion: AZT1D supports improved clinical decision-making and individualized T1D care through rich, naturalistic data.
...
Method: CEP stores forecasters for different concepts, retrieves the nearest forecaster for test samples, and evolves new models for emerging concepts while eliminating outdated knowledge.
...
Conclusion: CEP is a robust solution for handling recurring concept drift, enhancing prediction performance by leveraging past knowledge.
...
TL;DR: Adding dropout at inference time in PLMs like ESM2 improves zero-shot prediction of protein fitness without retraining.
...
TL;DR: The paper introduces 'Assembly-of-Experts' (AoE), a method to efficiently create child models from Mixture-of-Experts parents by interpolating weights, reducing computational costs while maintaining capability.


<details>
  <summary>Details</summary>
Motivation: The high computational cost (10^13-10^15 FLOPs) for pretraining LLMs is inefficient. AoE aims to leverage existing pretrained models more effectively.
...
Result: The method produces functional child models (e.g., DeepSeek R1T 'Chimera') with inherited intelligence, reduced token usage, and compact reasoning.

Conclusion: AoE efficiently generates capable child models without fine-tuning, demonstrating potential for cost-effective model development.
...
TL;DR: The paper explores the trade-off between generalization and identification in intelligent systems, deriving universal limits and demonstrating them in neural networks.


<details>
  <summary>Details</summary>
Motivation: To understand how internal representations balance structured generalization and selective identification, and to quantify the fundamental limits of this trade-off.

Method: Theoretical derivation of closed-form expressions for generalization and identification probabilities, extended to noisy and heterogeneous spaces, and validated using minimal ReLU networks, CNNs, and vision-language models.

Result: Reveals a universal Pareto front for the trade-off, predicts a sharp collapse in multi-input capacity, and shows empirical validation in neural networks.
...
TL;DR: ss-Mamba is a foundation model for time series forecasting, combining semantic-aware embeddings and adaptive spline-based encoding in a selective state-space framework, offering efficiency and interpretability.


<details>
  <summary>Details</summary>
Motivation: To improve time series forecasting by addressing computational inefficiencies of Transformers and enhancing interpretability through semantic and temporal encoding.

Method: Integrates semantic-aware embeddings from pretrained language models and spline-based Kolmogorov-Arnold Networks (KAN) for dynamic temporal encoding within a selective state-space model (Mamba).
...
Result: A continuous-time model for the Heavy-Ball method with controlled discretization error, applied to implicit regularization and implicit bias in deep learning.

Conclusion: The work offers theoretical insights and numerical validation, enhancing understanding of momentum methods in optimization.
...
<details>
  <summary>Details</summary>
Motivation: VLMs, like LLMs, are prompt-sensitive, but their sensitivity in the vision domain is understudied. This work aims to understand which prompt variations affect VLMs most and which models are resilient.
...
Result: VLMs show language-like prompt sensitivity in vision, with destructive variations altering expected answers. InternVL2 models are notably robust among 22 tested.
...
TL;DR: A Model-Router framework dynamically selects the best forecasting model for sparse/intermittent demand, improving accuracy by 11.8% and speeding inference by 4.67x.


<details>
  <summary>Details</summary>
Motivation: Traditional models struggle with zero-demand periods in supply chains, impacting inventory management.
...
Result: Outperforms alternative methods in benchmark continuous control and visual tasks, achieving better knowledge transfer and performance.
...
TL;DR: TRAINCHECK is a framework for detecting silent errors in DL training by inferring invariants and providing debugging support. It detected 18/20 errors in tests and found 6 unknown bugs.
...
Method: TRAINCHECK infers invariants for DL training and uses them to detect errors during training.

Result: Detected 18 out of 20 real-world errors in one iteration and uncovered 6 unknown bugs in libraries.

Conclusion: TRAINCHECK effectively addresses silent training errors and improves debugging in DL training.
...
TL;DR: The paper proposes a semi-supervised $p$-Laplacian regression model to predict body composition variables (ALM, BFP, BMD) from 3D optical images, overcoming data limitations. It outperforms supervised models in data-scarce scenarios.
...
Method: A $p$-Laplacian regression model is applied to biomarkers from 3D images, alongside supervised models (SVR, Least Squares SVR), tested on a dataset of 847 patients.

Result: The $p$-Laplacian model achieved errors of ~13% (ALM), ~10% (BMD), ~20% (BFP) with 10% training data. Supervised models performed better (~8% for ALM/BMD, ~11% for BFP) with 80% data.

Conclusion: The $p$-Laplacian model is viable for healthcare in data-limited settings, while supervised models excel with more data.
...
TL;DR: Smaller VLMs trained with GRPO and external tools (like zoom) outperform baselines in visual reasoning tasks.


<details>
  <summary>Details</summary>
Motivation: Address the challenge of detailed visual reasoning in VLMs under limited compute resources.

Method: Train smaller models using GRPO, a simple reward structure, a tool-calling interface, and a data mix favoring visually difficult examples.

Result: Improved performance on VQA tasks due to detailed visual information from tools.

Conclusion: Combining GRPO with external tools enhances visual reasoning in smaller VLMs.
...
<details>
  <summary>Details</summary>
Motivation: Deploying MLLMs in real-world scenarios is challenging due to distributed data, privacy concerns, and high computational/communication demands. Federated Learning (FL) is a solution, but existing FL methods are impractical for large-scale MLLMs.

Method: FedNano centralizes the LLM on the server and introduces NanoEdge, a lightweight client module with modality-specific encoders, connectors, and low-rank adaptation (NanoAdapters). This reduces client-side storage and communication overhead.

Result: FedNano reduces client-side storage by 95% and communication overhead to 0.01% of model parameters. It outperforms prior FL baselines, handling data heterogeneity and resource constraints while preserving privacy.
...
TL;DR: The study evaluates four surrogate models for predicting material properties in high-entropy alloys, finding Deep Gaussian Processes (DGP) with machine learning-based priors as the most effective.


<details>
  <summary>Details</summary>
Motivation: To accelerate the discovery and optimization of high-entropy alloys by integrating computational predictions with sparse experimental data.

Method: Systematic evaluation of four surrogate models (cGP, DGP, encoder-decoder neural networks, XGBoost) on a hybrid dataset of experimental and computational properties in the AlCoCrCuFeMnNiV HEA system.

Result: DGP with machine learning-based priors outperformed other models in capturing inter-property correlations and input-dependent uncertainty.

Conclusion: Advanced surrogate models, particularly DGP, are powerful tools for robust and data-efficient materials design.
...
TL;DR: The paper proposes a hybrid BiGRU-MHA model for SSD health prediction, combining bidirectional GRU and multi-head attention to improve accuracy and generalization. It achieves high classification accuracy and robust performance, offering practical benefits for storage systems.
...
Method: The model integrates bidirectional GRU (BiGRU) for temporal feature extraction and multi-head attention (MHA) for dynamic feature weighting, enhancing sensitivity to key health indicators.

Result: The model achieves 92.70% training and 92.44% test accuracy, with a minimal performance gap (0.26%) and an AUC of 0.94, demonstrating strong generalization and binary classification performance.

Conclusion: The hybrid BiGRU-MHA model provides a reliable solution for SSD health prediction, reducing data loss risks and optimizing maintenance costs, with applications in cloud and edge storage systems.
...
TL;DR: CACTUS, a tool for AMD stage classification, improves explainability and performance over standard ML models by integrating genetic, dietary, clinical, and demographic factors.
...
Method: Introduces CACTUS, a tool for AMD stage classification that integrates multiple factors, provides explainability, and identifies key features to enhance decision-making.

Result: CACTUS outperforms standard ML models, offers transparency, and identifies important features, aligning with medical knowledge and reducing bias.

Conclusion: CACTUS improves AMD classification by addressing data limitations and biases, enhancing trust and usability in clinical settings.
...
TL;DR: Proposes an event-driven online VFL framework to address asynchronous data challenges, introducing dynamic local regret for stability and efficiency.


<details>
  <summary>Details</summary>
Motivation: Online learning in VFL faces challenges due to asynchronous data arrival and non-intersecting feature sets, overlooked by prior research.

Method: Developed an event-driven framework activating subset of clients per event, incorporating dynamic local regret for non-convex, non-stationary environments.

Result: Framework outperforms existing methods in stability, reduces communication/computation costs, and handles non-stationary data effectively.

Conclusion: The event-driven approach with DLR is a robust solution for online VFL, addressing real-world asynchronous data challenges.
...
Method: Proposed FedOne framework, a federated black-box discrete prompt learning method, activating one client per round for optimal query efficiency.

Result: Theoretical and experimental results showed FedOne significantly improves query efficiency in federated black-box prompt learning.

Conclusion: FedOne effectively addresses query cost issues in federated black-box prompt tuning, aligning theory with practical performance.
...
<details>
  <summary>Details</summary>
Motivation: The non-standardized threshold in Autoencoders for anomaly detection impacts performance, necessitating an automated solution.

Method: Evaluated three algorithms (K-Nearest Neighbors, K-Means, Support Vector Machine) to define the threshold.

Result: The study demonstrates the potential of machine learning to optimize anomaly detection thresholds.

Conclusion: Automating threshold definition with machine learning enhances the effectiveness of anomaly detection systems.
...
TL;DR: The paper identifies and characterizes special channels in neural network loss landscapes where loss decreases slowly, leading to diverging neuron weights and gated linear units at convergence.


<details>
  <summary>Details</summary>
Motivation: To understand the structure and behavior of loss landscapes in neural networks, particularly focusing on quasi-flat regions and their implications for optimization.

Method: Analyzes gradient dynamics, geometry, and functional interpretation of channels in the loss landscape where neuron weights diverge to infinity.

Result: Gradient flow solvers often reach these channels, which appear as flat local minima but lead to gated linear units at convergence.
...
TL;DR: The paper introduces Guru, a curated RL reasoning corpus with 92K examples across six domains, addressing the lack of scalable RL rewards. It revisits RL findings for LLM reasoning, showing domain-specific performance variations. Guru-7B and Guru-32B models achieve SOTA results, improving base models' reasoning, especially in complex tasks.


<details>
  <summary>Details</summary>
Motivation: To broaden understanding of RL's applicability in general reasoning beyond math and code, addressing the challenge of scalable RL rewards across diverse domains.

Method: Developed Guru, a corpus of 92K verifiable examples across six reasoning domains, using domain-specific reward design, deduplication, and filtering. Evaluated RL training effects across domains and released Guru-7B and Guru-32B models.

Result: Guru-7B and Guru-32B outperform baselines by 7.9% and 6.7% on a 17-task suite, showing RL's potential for genuine skill acquisition in less pretrained domains.

Conclusion: RL's effectiveness varies by domain, with in-domain training crucial for less pretrained areas. Guru models demonstrate significant improvements, especially in complex tasks, advancing general-purpose reasoning.
...
TL;DR: The paper introduces Overlap-aware Disagreement Discrepancy (ODD) to improve error estimation of ML models in unseen test domains by focusing on non-overlapping target regions, outperforming prior methods like DIS².


<details>
  <summary>Details</summary>
Motivation: Accurate error estimation in unseen domains is crucial for safe ML systems. Prior methods like DIS² have limitations due to competition in overlapping regions between source and target domains.
...
Result: ODD-based bounds outperform DIS² in predicting target performance, validated through experiments on various benchmarks.

Conclusion: ODD provides a more reliable and accurate error estimation method for ML models under distribution shifts, with practical benefits demonstrated in experiments.
...
TL;DR: The paper predicts MS disability progression using sparse clinical data and digital Floodlight data, employing advanced models like transformers and FMs. Multimodal approaches outperformed unimodal ones, showing promise for complex disease prognostics.
...
Method: The study used tabular and time-series foundation models, a custom multimodal attention-based transformer, and machine learning methods to predict 48- and 72-week disability.

Result: Despite challenges (AUROC 0.63), integrating digital data improved performance. A transformer with unimodal embeddings performed best, but the multimodal transformer consistently outperformed unimodal models.

Conclusion: The findings highlight the potential of foundation models and multimodal approaches for extracting predictive signals from diverse clinical and digital data, improving prognostics for MS and other complex diseases.
...
TL;DR: Proposes a multi-agent multi-armed bandit (MA-MAB) framework for fair outcomes and system performance, with novel probing and algorithms for offline/online settings.


<details>
  <summary>Details</summary>
Motivation: Addresses fair decision-making under limited information about arm rewards in multi-agent systems.

Method: Introduces a probing framework for strategic information gathering; designs greedy probing (offline) and sublinear regret algorithms (online).

Result: Outperforms baselines in fairness and efficiency on synthetic/real-world datasets.

Conclusion: The approach effectively balances fairness and performance in MA-MAB problems.
...
TL;DR: The paper shows that Controlled Differential Equations (CDE) can improve RL for sepsis treatment by ensuring training stability and acuity-aware representations, leading to better policy performance.


<details>
  <summary>Details</summary>
Motivation: The need for stable and clinically meaningful state representations in RL for sepsis treatment, addressing overlooked training instability issues.

Method: Uses CDE state representation with training stability methods (early stopping, stabilization) and acuity-aware regularization (correlation with clinical scores).
...
Conclusion: Training stability and acuity-awareness are critical for effective CDE-based representation learning in clinical RL.
...
TL;DR: SFT-GO introduces a novel supervised fine-tuning method for LLMs by grouping tokens based on importance and optimizing with a weighted loss, improving performance over uniform methods.
...
Result: Models trained with SFT-GO outperform baselines across benchmarks, datasets, and base models, showing robustness.

Conclusion: SFT-GO effectively addresses the limitations of uniform token treatment in SFT, enhancing LLM performance and learning dynamics.
...
TL;DR: SPG introduces a lightweight online hyperparameter optimization method using sequential policy gradient modeling, outperforming traditional methods with lower computational costs.
...
Method: SPG extends the base model with temporary modules to generate state-action trajectories in a single forward pass, reducing computational overhead.
...
Conclusion: SPG offers an efficient, scalable solution for hyperparameter optimization, demonstrating consistent improvements and practical applicability.
...
<details>
  <summary>Details</summary>
Motivation: Training highly accurate neural networks is difficult due to non-convex optimization and hyperparameter tuning, with traditional methods often neglecting $L^{\infty}$ error.

Method: The framework refines staged training by learning residuals sequentially, optimizing loss functions, parameter choices, and adaptive data sampling.
...
TL;DR: The paper studies hallucinations in LLM-based embodied agents, revealing high hallucination rates under scene-task inconsistencies and providing insights for robust planning.


<details>
  <summary>Details</summary>
Motivation: To understand and quantify hallucinations in LLMs when used as cognitive cores for embodied agents, especially under scene-task mismatches.
...
TL;DR: The paper proposes a Neural Canonical Polyadic Factorization (NCPF) model for robust traffic data imputation, combining low-rank tensor algebra and deep learning to handle missing data in intelligent transportation systems.


<details>
  <summary>Details</summary>
Motivation: Missing traffic data due to sensor failures and heterogeneous sensing gaps hinders reliable traffic modeling, necessitating a robust solution.
...
<details>
  <summary>Details</summary>
Motivation: Addressing the lack of unified taxonomy and systematic evaluation framework for verifying machine unlearning operations, driven by privacy, security, and regulatory needs.

Method: Proposes a taxonomy categorizing verification methods into behavioral and parametric verification, reviews representative techniques, and evaluates their assumptions and vulnerabilities.

Result: Identifies gaps and vulnerabilities in current verification methods, providing a structured overview of the field.

Conclusion: Calls for future research to develop robust, efficient, and theoretically grounded unlearning verification mechanisms.
...
Conclusion: ImprovDML effectively combines resilience, privacy, and accuracy, outperforming prior approaches.
...
TL;DR: The paper rigorously evaluates ML techniques for solving the 1D Poisson equation, revealing critical factors like data function space and generalization issues, and proposes a new cross-validation method.


<details>
  <summary>Details</summary>
Motivation: To address the gap between promising ML applications in science and the need for quantitative accuracy, especially in differential equations.

Method: Quantifies accuracy of ML techniques on the 1D Poisson equation, analyzing training dynamics, deriving generalization bounds, and testing models like deep linear models and Neural Operators.
...
TL;DR: SoKA (SVD on Kronecker Adaptation) is a parameter-efficient fine-tuning method combining Kronecker-product factorization and SVD-driven initialization, reducing trainable parameters by 25% while maintaining or improving performance.


<details>
  <summary>Details</summary>
Motivation: Full fine-tuning of large Transformer models is resource-intensive, and existing PEFT methods have drawbacks like latency, suboptimal convergence, or inflexible rank choices.
...
Result: On LLaMA2-7B, SoKA achieves comparable or better performance with only 0.99M parameters, 25% fewer than LoRA/PiSSA, and shows faster convergence.

Conclusion: SoKA is a robust and efficient PEFT method for large-scale model adaptation, offering reduced resource usage without compromising performance.
...
TL;DR: The paper investigates the robustness of federated learning to Byzantine behavior, revealing a tradeoff between centroid approximation and validity conditions. It provides theoretical bounds and a new algorithm, validated empirically.


<details>
  <summary>Details</summary>
Motivation: To determine if federated learning is resilient to Byzantine faults and explore the tradeoff between averaging and validity conditions in distributed computing.

Method: Theoretical analysis of centroid approximation under validity conditions, complemented by empirical evaluations in federated learning settings.

Result: Lower and upper bounds on centroid approximation are established, and a new algorithm achieves tight approximation under convex validity. Empirical results support the theoretical findings.

Conclusion: Federated learning's robustness to Byzantine behavior is limited by tradeoffs in validity and approximation, but new algorithms can improve resilience.
...
TL;DR: The paper proposes a method to generate synthetic held-out data for Dataset Inference (DI), enabling detection of unauthorized training data use without requiring in-distribution private data.


<details>
  <summary>Details</summary>
Motivation: Existing DI methods need in-distribution held-out data, which is rarely available, limiting their practicality. The goal is to overcome this by synthetically generating such data.

Method: A data generator is trained on a suffix-based completion task to create high-quality synthetic data. Post-hoc calibration bridges likelihood gaps between real and synthetic data.
...
TL;DR: DOVA-PATBM is a geo-computational framework for optimizing EV charging infrastructure, balancing urban, suburban, and rural needs while ensuring coverage and equity.


<details>
  <summary>Details</summary>
Motivation: The need for scalable infrastructure planning tools to support widespread EV adoption, addressing diverse geographic and socio-economic challenges.

Method: Combines hierarchical H3 grid rasterization, graph neural network centrality, Voronoi tessellation, and a greedy heuristic for site selection under constraints.

Result: In Georgia, USA, it improves coverage, reduces travel distance for low-income residents, and ensures power capacity, remaining scalable for national use.
...
### [63] [Acoustic Waveform Inversion with Image-to-Image Schrödinger Bridges](https://arxiv.org/abs/2506.15346)
*A. S. Stankevich,I. B. Petrov*

Main category: cs.LG

TL;DR: The paper introduces a conditional Image-to-Image Schrödinger Bridge (cI2SB) framework to improve deep learning-based Full Waveform Inversion (FWI) by addressing limitations of diffusion models, such as iterative sampling and output control.


<details>
  <summary>Details</summary>
Motivation: Current diffusion models in FWI struggle with iterative sampling and heuristic output control, and lack clarity on integrating approximate velocity models.

Method: The authors propose cI2SB, extending the Image-to-Image Schrödinger Bridge to conditional sampling, to interpolate between ground truth and smoothed velocity models.

Result: Experiments show cI2SB outperforms prior conditional diffusion models, achieving high sample fidelity with fewer neural function evaluations (NFEs).

Conclusion: The cI2SB framework offers a more efficient and effective solution for FWI, validated by superior performance and code availability.
...
### [64] [Capturing Polysemanticity with PRISM: A Multi-Concept Feature Description Framework](https://arxiv.org/abs/2506.15538)
...
<details>
  <summary>Details</summary>
Motivation: Current methods assume monosemanticity (one concept per neuron), limiting their ability to describe complex neural network behaviors accurately.

Method: PRISM provides nuanced descriptions for both polysemantic and monosemantic features, addressing the limitations of single-concept assumptions.
...
### [65] [When and How Unlabeled Data Provably Improve In-Context Learning](https://arxiv.org/abs/2506.15329)
...
<details>
  <summary>Details</summary>
Motivation: To understand why ICL remains effective despite imperfect labels and to improve semi-supervised learning in tabular data.

Method: Theoretical analysis of binary Gaussian mixture models (GMM) with missing labels, comparing single-layer and multilayer transformers. Polynomial estimators are derived and connected to Expectation Maximization.

Result: Multilayer transformers exploit unlabeled data effectively, with performance scaling exponentially with depth. Looping tabular foundation models improves semi-supervised learning.

Conclusion: Depth in transformers enhances semi-supervised learning by implicitly constructing powerful estimators, validated by real-world experiments.
...
### [66] [Enhancing One-run Privacy Auditing with Quantile Regression-Based Membership Inference](https://arxiv.org/abs/2506.15349)
...
Conclusion: Utilizing quantile regression for MIA improves black-box DP auditing, bridging the gap between empirical and theoretical bounds without sacrificing efficiency.
...
### [67] [LoX: Low-Rank Extrapolation Robustifies LLM Safety Against Fine-tuning](https://arxiv.org/abs/2506.15606)
...
Method: Proposes Low-Rank Extrapolation (LoX), which extrapolates safety-critical subspaces in LLM parameters without additional training.

Result: LoX reduces attack success rates by 11-54% against benign/malicious fine-tuning, maintaining task adaptability.

Conclusion: LoX effectively improves LLM safety robustness by moving parameters to a flatter, less perturbation-sensitive zone.
...
### [68] [Sampling 3D Molecular Conformers with Diffusion Transformers](https://arxiv.org/abs/2506.15378)
...
Method: Proposes DiTMC, a modular architecture separating 3D coordinate processing from atomic connectivity conditioning, using graph-based strategies and flexible attention mechanisms.

Result: DiTMC achieves state-of-the-art precision and physical validity on benchmarks (GEOM-QM9, -DRUGS, -XL).

Conclusion: Architectural choices and symmetry priors significantly impact sample quality and efficiency, offering promising directions for large-scale molecular modeling.
...
Method: AutoRule uses a reasoning model to interpret preferences, extracts candidate rules, synthesizes them, and employs verifiers for auxiliary rewards during policy optimization.

Result: AutoRule improves win rates by 28.6% on AlpacaEval2.0 and 6.1% on MT-Bench, with reduced reward hacking and better alignment with preferences.

Conclusion: AutoRule effectively automates rule extraction, enhancing RLHF performance and capturing dataset-specific qualities.
...
### [70] [Unifying VXAI: A Systematic Review and Framework for the Evaluation of Explainable AI](https://arxiv.org/abs/2506.15408)
...
Method: A systematic literature review following PRISMA guidelines, analyzing 362 publications and categorizing metrics into 41 groups.

Result: Proposes a three-dimensional categorization scheme for XAI evaluation and introduces the VXAI framework.

Conclusion: The VXAI framework provides a structured, comprehensive overview for evaluating XAI methods, enhancing comparability and future research.
...
### [71] [Global Ground Metric Learning with Applications to scRNA data](https://arxiv.org/abs/2506.15383)
...
<details>
  <summary>Details</summary>
Motivation: Traditional ground metrics in optimal transport are either predefined (e.g., Euclidean) or learned supervisedly, lacking adaptability to data structure or generalization across classes.

Method: The approach learns a global ground metric for arbitrary distributions over a shared metric space, using only class labels at the distribution level for training.

Result: The learned metric enhances optimal transport distances, improving performance in embedding, clustering, and classification tasks.

Conclusion: The method is validated on patient-level scRNA-seq data, showing effectiveness and interpretability across multiple diseases.
...
### [72] [Reward Models in Deep Reinforcement Learning: A Survey](https://arxiv.org/abs/2506.15421)
*Rui Yu,Shenghua Wan,Yucen Wang,Chen-Xiao Gao,Le Gan,Zongzhang Zhang,De-Chuan Zhan*

Main category: cs.LG

TL;DR: A survey on reward modeling techniques in deep reinforcement learning, covering background, approaches, applications, evaluation methods, and future directions.
...
Result: Provides a comprehensive overview of established and emerging reward modeling techniques.
...
TL;DR: A framework for exploration using diffusion models without explicit uncertainty, leveraging entropy maximization and density estimation.


<details>
  <summary>Details</summary>
Motivation: To enable novel design generation in decision-making problems like scientific discovery, avoiding reliance on existing data distributions.

Method: Uses entropy maximization over a diffusion model's implicit data manifold, connects entropy to the score function, and applies mirror descent for sequential fine-tuning.
...
Conclusion: The framework effectively leverages diffusion models for exploration, offering scalable and theoretically grounded solutions.
...
### [74] [Dense SAE Latents Are Features, Not Bugs](https://arxiv.org/abs/2506.15679)
*Xiaoqing Sun,Alessandro Stolfo,Joshua Engels,Ben Wu,Senthooran Rajamanoharan,Mrinmaya Sachan,Max Tegmark*

Main category: cs.LG

TL;DR: Dense latents in sparse autoencoders (SAEs) are persistent and meaningful, serving functional roles in language models rather than being mere training artifacts.


<details>
  <summary>Details</summary>
Motivation: To investigate the nature and significance of dense latents in SAEs, which are often dismissed as undesirable artifacts.
...
Result: Dense latents form antipodal pairs, reconstruct specific directions, and serve roles like position tracking, context binding, and semantic representation.

Conclusion: Dense latents are intrinsic to the residual space and functionally important in language models, not just noise.
...
### [75] [Learn to Vaccinate: Combining Structure Learning and Effective Vaccination for Epidemic and Outbreak Control](https://arxiv.org/abs/2506.15397)
...
<details>
  <summary>Details</summary>
Motivation: The problem of optimal vaccination is linked to the NP-hard SRM problem, but prior work assumes a known graph, which is often impractical. This work tackles the challenge of an unknown graph.

Method: The approach involves splitting the problem into graph learning and vaccination strategy. A novel inclusion-exclusion-based learning algorithm is proposed, and its sample complexity is established. An optimal algorithm for SRM is detailed, with polynomial runtime for bounded treewidth graphs, alongside a greedy heuristic.

Result: The learning algorithm's sample complexity is proven, and the SRM algorithm's efficiency is demonstrated for bounded treewidth graphs. Experiments validate both learning and vaccination methods.

Conclusion: The work provides a practical solution for minimizing extinction time in SIS models with unknown graphs, combining graph learning and efficient vaccination strategies.
...
### [76] [Zero-Shot Reinforcement Learning Under Partial Observability](https://arxiv.org/abs/2506.15446)
...
<details>
  <summary>Details</summary>
Motivation: To address the performance degradation of zero-shot RL methods under partial observability, as Markov states are often unavailable in real-world applications.

Method: Proposed memory-based architectures for zero-shot RL to handle partially observable states, rewards, and dynamic changes.

Result: Memory-based methods show improved performance over memory-free baselines in partially observable domains.

Conclusion: Memory-based architectures are effective for zero-shot RL in partially observable settings, with open-sourced implementation.
...
### [77] [Warping and Matching Subsequences Between Time Series](https://arxiv.org/abs/2506.15452)
*Simiao Lin,Wannes Meert,Pieter Robberechts,Hendrik Blockeel*

Main category: cs.LG

TL;DR: A novel technique simplifies warping paths to highlight key transformations in time series, improving interpretability.


<details>
  <summary>Details</summary>
Motivation: Existing methods lack qualitative comparison and fail to show broader structural relationships between subsequences.
...
<details>
  <summary>Details</summary>
Motivation: Current GAD methods assume uniform homophily in normal nodes, which fails in real-world datasets where homophily varies. RHO addresses this limitation.

Method: RHO uses adaptive frequency response filters (AdaFreq) and graph normality alignment (GNA) to learn and align diverse homophily patterns.

Result: RHO outperforms state-of-the-art methods on eight real-world datasets by effectively learning varying homophily.

Conclusion: RHO robustly captures diverse homophily in normal nodes, improving anomaly detection in graphs with heterogeneous patterns.
...
### [79] [Creating User-steerable Projections with Interactive Semantic Mapping](https://arxiv.org/abs/2506.15479)
...
Method: Uses zero-shot classification with MLLMs and natural-language prompts to dynamically steer projections.
...
### [80] [Pixel-level Certified Explanations via Randomized Smoothing](https://arxiv.org/abs/2506.15499)
...
<details>
  <summary>Details</summary>
Motivation: Current attribution methods are non-robust; small input changes can drastically alter explanations without affecting predictions, undermining trustworthiness.

Method: The framework uses randomized smoothing to sparsify and smooth attribution maps, treating the task as a segmentation problem and certifying pixel importance against perturbations.
...
Conclusion: The proposed framework provides reliable, robust attributions, enhancing their usability in downstream tasks.
...
### [81] [LIT-LVM: Structured Regularization for Interaction Terms in Linear Predictors using Latent Variable Models](https://arxiv.org/abs/2506.15492)
...
<details>
  <summary>Details</summary>
Motivation: Linear predictors with interaction terms can model non-linear relationships, but accurately estimating these terms is challenging, especially in high-dimensional settings.

Method: Proposes LIT-LVM, which represents features with low-dimensional latent vectors to regularize interaction term coefficients, reducing overfitting.

Result: LIT-LVM achieves better prediction accuracy than elastic net and factorization machines, especially with many interaction terms and few samples.

Conclusion: LIT-LVM is effective for high-dimensional settings and provides interpretable low-dimensional feature representations.
...
TL;DR: The paper formalizes spatiotemporal over-squashing in STGNNs, showing its unique challenges and revealing counterintuitive propagation biases. It provides theoretical and empirical validation for efficient designs.


<details>
  <summary>Details</summary>
Motivation: To address the unexplored issue of over-squashing in Spatiotemporal GNNs (STGNNs), where temporal dimensions exacerbate information propagation limitations.

Method: Formalizes the problem, analyzes its distinct characteristics, and compares propagation biases in convolutional STGNNs. Validates findings on synthetic and real-world datasets.

Result: Convolutional STGNNs favor distant temporal information over close-in-time data. Both time-and-space and time-then-space paradigms are equally affected.

Conclusion: The study offers insights into STGNN dynamics and principled guidance for designing more effective architectures.
...
TL;DR: RePCS is a model-agnostic method to detect if LLMs rely on memorized data instead of retrieved context in RAG systems, using KL divergence between two inference paths.
...
Result: Achieves 0.918 ROC-AUC on Prompt-WNQA, outperforming prior methods by 6.5%, with low latency overhead.

Conclusion: RePCS provides a lightweight, black-box safeguard for verifying retrieval usage in RAG systems, crucial for safety-critical applications.
...
### [84] [Insights on Adversarial Attacks for Tabular Machine Learning via a Systematic Literature Review](https://arxiv.org/abs/2506.15506)
*Salijona Dyrmishi,Mohamed Djilani,Thibault Simonetto,Salah Ghamizi,Maxime Cordy*

Main category: cs.LG

TL;DR: This paper presents the first systematic literature review on adversarial attacks targeting tabular machine learning models, summarizing trends, attack strategies, and practical considerations.
...
Result: Key trends and attack strategies are identified, along with current challenges and open research questions.
...
Result: Shows that learning computable functions is possible with computational constraints or time-bound observations, and connects policy-trajectory learning to finite-state transducer inference. Also proves negative results for linear-time computable functions.

Conclusion: The study advances the understanding of learnability under computational constraints and reveals connections to other inference problems, though challenges remain for certain function classes.
...
### [86] [A Simplified Analysis of SGD for Linear Regression with Weight Averaging](https://arxiv.org/abs/2506.15535)
...
<details>
  <summary>Details</summary>
Motivation: To make the analysis of SGD in overparameterized models more accessible and facilitate further improvements in practical training methods.
...
Conclusion: The simplified method makes SGD analysis more accessible, aiding future research on mini-batching and learning rate scheduling.
...
TL;DR: DAILOC is a domain-incremental learning framework for Wi-Fi fingerprinting-based indoor localization, addressing device and temporal domain shifts. It outperforms existing methods with lower errors.
...
TL;DR: LogNet is a logic gate-based framework for interpreting and improving DL-based indoor localization, offering transparency, better performance, and long-term reliability.


<details>
  <summary>Details</summary>
Motivation: Existing DL models for indoor localization lack interpretability, making it hard to understand predictions or adapt to environmental noise over time.

Method: LogNet uses logic gates to identify influential access points and analyze noise impact, enabling transparent reasoning and model adaptation.
...
Conclusion: LogNet enhances DL-based indoor localization by providing interpretability and improved performance for long-term reliability.
...
### [89] [Stable Gradients for Stable Learning at Scale in Deep Reinforcement Learning](https://arxiv.org/abs/2506.15544)
*Roger Creus Castanyer,Johan Obando-Ceron,Lu Li,Pierre-Luc Bacon,Glen Berseth,Aaron Courville,Pablo Samuel Castro*

Main category: cs.LG

TL;DR: The paper identifies gradient pathologies and non-stationarity as root causes of degraded performance in scaled deep reinforcement learning networks, proposing simple interventions to stabilize gradient flow for robust performance.


<details>
  <summary>Details</summary>
Motivation: Understanding and addressing the challenges of scaling deep reinforcement learning networks, which often degrade in performance, without relying on overly complex solutions.

Method: Conducting empirical analyses to identify gradient pathologies and non-stationarity issues, followed by proposing and testing simple architectural interventions to stabilize gradient flow.

Result: The proposed interventions stabilize gradient flow, enabling robust performance across varying network depths and widths, validated on multiple agents and environments.

Conclusion: Simple architectural interventions can effectively address scaling challenges in deep reinforcement learning, providing a practical solution for robust performance at scale.
...
### [90] [Task-Agnostic Experts Composition for Continual Learning](https://arxiv.org/abs/2506.15566)
...
Result: Higher accuracy with fewer computational resources compared to baseline algorithms.
...
### [91] [MicroRicci: A Greedy and Local Ricci Flow Solver for Self-Tuning Mesh Smoothing](https://arxiv.org/abs/2506.15571)
...
<details>
  <summary>Details</summary>
Motivation: Real-time mesh smoothing is challenging due to costly global updates in classical methods and slow convergence or brittle tuning in greedy heuristics.

Method: MicroRicci combines a greedy syndrome-decoding step (O(E) time) with two neural modules for adaptive vertex and step-size selection, using only 1K + 200 parameters.

Result: On 110 SJTU-TMQA meshes, MicroRicci reduces iterations (2.4x speedup), tightens curvature spread, and achieves high UV-distortion-to-MOS correlation (r = -0.93), with minimal overhead (0.25 ms per iteration).

Conclusion: MicroRicci's linear-time updates, automatic adaptation, and high-quality results make it ideal for real-time, resource-limited applications in graphics and simulation.
...
<details>
  <summary>Details</summary>
Motivation: Fairness in ML is crucial as AI impacts society, but biased training data undermines fairness. Addressing label bias is essential for trustworthy systems.
...
Conclusion: GFLC effectively addresses label bias and enhances fairness in ML models, offering a robust solution for real-world applications.
...
### [93] [Memory-Efficient Differentially Private Training with Gradient Random Projection](https://arxiv.org/abs/2506.15588)
*Alex Mulrooney,Devansh Gupta,James Flemings,Huanyu Zhang,Murali Annavaram,Meisam Razaviyayn,Xinwei Zhang*

Main category: cs.LG

TL;DR: DP-GRAPE reduces memory overhead in DP training by privatizing gradients after projection, using random matrices, and applying projection during backpropagation, achieving comparable utility to DP-SGD with significant memory savings.


<details>
  <summary>Details</summary>
Motivation: Standard DP methods like DP-Adam have high memory overhead due to per-sample gradient clipping, limiting scalability in neural network training.
...
Result: DP-GRAPE reduces memory usage by over 63% for Vision Transformers and 70% for RoBERTa-Large, maintaining performance and scaling to large models like OPT (6.7B parameters).
...
### [94] [Federated Learning for MRI-based BrainAGE: a multicenter study on post-stroke functional outcome prediction](https://arxiv.org/abs/2506.15626)
...
<details>
  <summary>Details</summary>
Motivation: To address privacy concerns in training robust BrainAGE models by evaluating FL's performance and its link to clinical phenotypes and functional outcomes.

Method: Used FLAIR images from 1674 stroke patients across 16 centers, comparing centralized learning, FL, and single-site learning. Examined associations with vascular risk factors and functional outcomes.

Result: FL outperformed single-site models; BrainAGE was higher in diabetes patients and significantly associated with post-stroke recovery.

Conclusion: FL enables accurate BrainAGE predictions without data centralization, highlighting its prognostic potential in stroke care.
...
### [95] [CAWR: Corruption-Averse Advantage-Weighted Regression for Robust Policy Optimization](https://arxiv.org/abs/2506.15654)
*Ranting Hu*
...
<details>
  <summary>Details</summary>
Motivation: To tackle the issue of over-conservative policies in offline RL caused by poor explorations in suboptimal data, which affects policy optimization.

Method: Proposes CAWR, incorporating robust loss functions and advantage-based prioritized experience replay to mitigate poor explorations.
...
### [96] [SemIRNet: A Semantic Irony Recognition Network for Multimodal Sarcasm Detection](https://arxiv.org/abs/2506.14791)
...
<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of identifying implicit correlations in multimodal irony detection tasks.
...
Conclusion: Knowledge fusion and semantic similarity detection significantly enhance model performance, as validated by ablation studies.
...
### [97] [Argus Inspection: Do Multimodal Large Language Models Possess the Eye of Panoptes?](https://arxiv.org/abs/2506.14805)
...
Result: Highest performance in visual fine-grained reasoning is 0.46 among 26 MLLMs, indicating need for improvement.

Conclusion: The research provides insights for refining MLLMs' capabilities in detailed visual and causal reasoning.
...
### [98] [A Hybrid ConvNeXt-EfficientNet AI Solution for Precise Falcon Disease Detection](https://arxiv.org/abs/2506.14816)
...
Method: Uses a hybrid of ConvNeXt and EfficientNet AI models trained on a large dataset, focusing on accuracy, precision, recall, and F1-score.

Result: The hybrid model outperforms traditional diagnostic methods and individual model architectures.

Conclusion: The hybrid AI model advances precise falcon disease detection and supports future AI-powered avian healthcare solutions.
...
### [99] [ViLLa: A Neuro-Symbolic approach for Animal Monitoring](https://arxiv.org/abs/2506.14823)
*Harsha Koduri*
...
<details>
  <summary>Details</summary>
Motivation: To create a transparent and modular system for monitoring animal populations by integrating visual data and natural language queries, unlike opaque end-to-end models.

Method: ViLLa integrates three components: visual detection for animal identification, a language parser for query understanding, and symbolic reasoning for logic-based inference.

Result: The system effectively bridges visual content with structured queries, demonstrating accuracy in tasks like counting and locating animals in images.

Conclusion: ViLLa offers a transparent, modular approach to animal monitoring, combining perception, understanding, and reasoning for interpretable results.
...
### [100] [GraphGSOcc: Semantic and Geometric Graph Transformer for 3D Gaussian Splating-based Occupancy Prediction](https://arxiv.org/abs/2506.14825)
*Ke Song,Yunhe Wu,Chunchit Siu,Huiyuan Xiong*

Main category: cs.CV

TL;DR: The paper introduces GraphGSOcc, a framework for 3D semantic occupancy prediction, addressing feature aggregation and boundary ambiguities in 3DGS methods using dual graph structures and multi-scale attention.
...
Method: Proposes GraphGSOcc with Dual Gaussians Graph Attention (geometric and semantic graphs) and Multi-scale Graph Attention for feature aggregation and boundary optimization.

Result: Achieves 24.10% mIoU on SurroundOcc dataset, with 1.97% improvement and 13.7% memory reduction (6.1 GB GPU memory).

Conclusion: GraphGSOcc effectively improves semantic occupancy prediction by integrating semantic and geometric constraints, outperforming existing methods.
...
### [101] [DAVID-XR1: Detecting AI-Generated Videos with Explainable Reasoning](https://arxiv.org/abs/2506.14827)
...
TL;DR: DAVID-X introduces a dataset and model (DAVID-XR1) for explainable detection of AI-generated videos, providing detailed annotations and rationales to enhance transparency and trust.


<details>
  <summary>Details</summary>
Motivation: The rise of AI-generated videos necessitates reliable and transparent detection methods beyond binary classification, requiring fine-grained evidence to convince users and auditors.

Method: DAVID-X pairs AI-generated videos with defect-level annotations and rationales. DAVID-XR1, a video-language model, uses these annotations for interpretable reasoning, including defect categorization and localization.

Result: The model, fine-tuned on DAVID-X and enhanced with chain-of-thought distillation, generalizes well across various generators and modes, offering transparent detection.

Conclusion: Explainable detection methods like DAVID-XR1 promise trustworthy identification of AI-generated videos, transforming detection into a verifiable process.
...
### [102] [Recent Advances in Multi-Agent Human Trajectory Prediction: A Comprehensive Review](https://arxiv.org/abs/2506.14831)
...
TL;DR: A survey of recent deep learning-based advancements in multi-agent human trajectory prediction (HTP), focusing on methods from 2020-2024, categorized by design, inputs, and strategies, with insights from ETH/UCY benchmarks and future challenges.
...
Method: Review and categorization of deep learning-based HTP methods, emphasizing architectural design, input representations, and prediction strategies, with ETH/UCY benchmark evaluation.

Result: Identifies key advancements and trends in multi-agent HTP, highlighting the effectiveness of recent deep learning approaches.

Conclusion: The survey outlines current progress, challenges, and future research directions in multi-agent HTP, emphasizing the need for continued innovation.
...
### [103] [ArchShapeNet:An Interpretable 3D-CNN Framework for Evaluating Architectural Shapes](https://arxiv.org/abs/2506.14832)
...
### [104] [Real-Time, Low-Latency Surveillance Using Entropy-Based Adaptive Buffering and MobileNetV2 on Edge Devices](https://arxiv.org/abs/2506.14833)
...
<details>
  <summary>Details</summary>
Motivation: To address the need for efficient video surveillance in resource-constrained settings while maintaining high performance and compliance with privacy regulations.
...
Result: Achieved sub-50ms end-to-end latency, over 92% detection accuracy, and robustness to varying conditions. Validated through comparative and ablation experiments.
...
### [105] [MonoVQD: Monocular 3D Object Detection with Variational Query Denoising and Self-Distillation](https://arxiv.org/abs/2506.14835)
...
<details>
  <summary>Details</summary>
Motivation: To overcome inherent limitations of DETR-like architectures in monocular 3D detection, particularly in stability and efficiency of denoising processes.

Method: Proposes Mask Separated Self-Attention for stable optimization, Variational Query Denoising to mitigate gradient vanishing, and a self-distillation strategy to refine queries iteratively.
...
Conclusion: MonoVQD advances monocular 3D detection with its innovative components, offering broad applicability and significant performance gains.
...
### [106] [Improved Iterative Refinement for Chart-to-Code Generation via Structured Instruction](https://arxiv.org/abs/2506.14837)
...
<details>
  <summary>Details</summary>
Motivation: Current MLLMs perform suboptimally on chart-to-code generation due to the complexity of translating visual elements into structured code.

Method: ChartIR splits the task into visual understanding (using description and difference instructions) and code translation, followed by iterative refinement.

Result: The method outperforms others on models like Qwen2-VL and GPT-4o.

Conclusion: ChartIR effectively enhances MLLMs' chart-to-code generation by leveraging structured instructions and iterative refinement.
...
### [107] [PictSure: Pretraining Embeddings Matters for In-Context Learning Image Classifiers](https://arxiv.org/abs/2506.14842)
...
### [108] [Finding Optimal Kernel Size and Dimension in Convolutional Neural Networks An Architecture Optimization Approach](https://arxiv.org/abs/2506.14846)
...
<details>
  <summary>Details</summary>
Motivation: Kernel size in CNNs is crucial but often overlooked, impacting performance and computational cost.

Method: Proposes BKSEF, integrating information theory, signal processing, and learning theory for layer-wise kernel size determination.

Result: BKSEF achieves up to 3.1% accuracy improvement and 42.8% FLOPs reduction on multiple datasets.
...
### [109] [Efficient Retail Video Annotation: A Robust Key Frame Generation Approach for Product and Customer Interaction Analysis](https://arxiv.org/abs/2506.14854)
*Varun Mannam,Zhenyu Shi*

Main category: cs.CV

TL;DR: A deep learning-based approach automates key-frame identification and annotation in retail videos, reducing costs and improving efficiency.


<details>
  <summary>Details</summary>
Motivation: Manual video annotation in retail is time-consuming and costly, prompting the need for automation.

Method: Uses deep neural networks for feature learning and object detection tailored to retail environments.

Result: Achieves human-level accuracy with 2x cost savings and minimal human intervention (less than 5%).

Conclusion: The method significantly reduces operational costs and enhances efficiency in retail video annotation.
...
### [110] [Peering into the Unknown: Active View Selection with Neural Uncertainty Maps for 3D Reconstruction](https://arxiv.org/abs/2506.14856)
...
<details>
  <summary>Details</summary>
Motivation: Determining the most valuable viewpoints for accurate 3D reconstruction is challenging. Current methods rely on learning radiance fields or computing uncertainty per viewpoint, which is computationally expensive.

Method: UPNet predicts uncertainty maps from a single input image, leveraging heuristics to learn viewpoint appearance to uncertainty mapping. It aggregates uncertainty maps to select optimal viewpoints.
...
Conclusion: UPNet offers an efficient, scalable solution for AVS, outperforming baselines in speed, resource usage, and generalization.
...
### [111] [DETONATE: A Benchmark for Text-to-Image Alignment and Kernelized Direct Preference Optimization](https://arxiv.org/abs/2506.14903)
...
TL;DR: The paper introduces DPO-Kernels for T2I models, enhancing alignment via Hybrid Loss, Kernelized Representations, and Divergence Selection. It also presents DETONATE, a benchmark for social bias evaluation, and the AQI metric.


<details>
  <summary>Details</summary>
Motivation: To improve alignment in T2I models for better faithfulness to user intent, safety, and fairness, extending DPO from LLMs to T2I systems.
...
Result: DPO-Kernels show strong generalization via HT-SR. DETONATE provides a large-scale evaluation of social bias in T2I models.

Conclusion: DPO-Kernels enhance alignment in T2I models, with DETONATE and AQI offering tools for evaluating and improving fairness and safety.
...
### [112] [PeRL: Permutation-Enhanced Reinforcement Learning for Interleaved Vision-Language Reasoning](https://arxiv.org/abs/2506.14907)
...
TL;DR: PeRL is a reinforcement learning approach for interleaved multimodal tasks, improving learning efficiency and performance on multi-image benchmarks while maintaining single-image task performance.


<details>
  <summary>Details</summary>
Motivation: Existing RL approaches for vision-language models struggle with multi-image positional reasoning, limiting their generalization to complex real-world scenarios.

Method: Proposes PeRL, a multi-stage RL strategy with permutation of image sequences and a rollout filtering mechanism for resampling.

Result: PeRL outperforms R1-related and interleaved VLM baselines on multi-image benchmarks and matches performance on single-image tasks.

Conclusion: PeRL effectively addresses the challenge of multi-image positional reasoning, achieving state-of-the-art results.
...
### [113] [Frequency-Calibrated Membership Inference Attacks on Medical Image Diffusion Models](https://arxiv.org/abs/2506.14919)
...
<details>
  <summary>Details</summary>
Motivation: Privacy concerns in medical imaging due to diffusion models necessitate better methods to detect if specific images were used in training. Existing MIA methods are flawed for medical images due to inherent image difficulty and high-frequency reconstruction challenges.

Method: The FCRE method analyzes the reverse diffusion process, computes mid-frequency reconstruction errors, and uses structural similarity scores to determine membership. It excludes high and low-frequency regions to mitigate confounding factors.

Result: Experiments show FCRE outperforms existing MIA methods on medical image datasets.

Conclusion: FCRE provides a more effective and reliable approach for MIAs in medical image diffusion models, addressing privacy risks.
...
### [114] [Vision Transformers for End-to-End Quark-Gluon Jet Classification from Calorimeter Images](https://arxiv.org/abs/2506.14934)
...
<details>
  <summary>Details</summary>
Motivation: Improving jet tagging in high-energy physics is crucial for new physics searches and precision measurements, yet ViTs remain underexplored for direct calorimeter image analysis.
...
Conclusion: This work provides a systematic framework and performance baselines for ViT applications in jet classification, with a dataset for further research.
...
### [115] [Advances in Compliance Detection: Novel Models Using Vision-Based Tactile Sensors](https://arxiv.org/abs/2506.14980)
...
Method: Two models (LRCNs and Transformer) are developed, leveraging RGB tactile images from GelSight for compliance prediction.
...
Conclusion: The proposed models enhance compliance estimation accuracy, though harder objects remain difficult to predict.
...
### [116] [Hyper-Local Deformable Transformers for Text Spotting on Historical Maps](https://arxiv.org/abs/2506.15010)
*Yijun Lin,Yao-Yi Chiang*

Main category: cs.CV

TL;DR: PALETTE is an end-to-end text spotter for historical maps, using hyper-local sampling and positional embeddings to improve text extraction. It outperforms SOTA methods and is trained with SynthMap+, a synthetic data generator.
...
Method: PALETTE introduces hyper-local sampling for precise feature learning and positional embeddings for spatial interactions. SynthMap+ generates synthetic training data.

Result: PALETTE outperforms SOTA text spotters on historical map benchmarks, especially for long and angled text. It processed 60,000+ maps and generated 100M+ labels.

Conclusion: PALETTE and SynthMap+ provide an effective solution for text extraction from historical maps, enabling large-scale processing and improved accuracy.
...
### [117] [Break Stylistic Sophon: Are We Really Meant to Confine the Imagination in Style Transfer?](https://arxiv.org/abs/2506.15033)
...
<details>
  <summary>Details</summary>
Motivation: To overcome limitations in traditional style transfer methods and unify frameworks for different tasks, enabling high-quality, artist-level style transfer and text-driven stylization.
...
Result: Achieves high-quality, artist-level style transfer, preserves original content, and introduces image color editing during transfer.

Conclusion: StyleWallfacer revolutionizes style transfer with a unified, efficient framework, delivering superior results and new capabilities like color editing.
...
### [118] [Enhancing Vector Quantization with Distributional Matching: A Theoretical and Empirical Study](https://arxiv.org/abs/2506.15078)
...
<details>
  <summary>Details</summary>
Motivation: Existing vector quantization methods suffer from training instability and codebook collapse due to distribution mismatches between features and code vectors.
...
### [119] [SynPo: Boosting Training-Free Few-Shot Medical Segmentation via High-Quality Negative Prompts](https://arxiv.org/abs/2506.15153)
...
Method: Combines DINOv2 and SAM for reliable confidence maps, selects top-k positive points and Gaussian-distributed negative points, and applies K-means clustering for high-quality prompts.

Result: Achieves performance comparable to state-of-the-art training-based few-shot methods.

Conclusion: SynPo effectively addresses the limitations of LVMs in medical image segmentation by optimizing prompt quality.
...
### [120] [Enhancing point cloud analysis via neighbor aggregation correction based on cross-stage structure correlation](https://arxiv.org/abs/2506.15160)
...
Method: PDSA leverages high-dimensional correlations to correct feature distribution, uses a lightweight cross-stage structural descriptor, and introduces a key point mechanism to optimize computational overhead.
...
Conclusion: The proposed PDSA module effectively addresses limitations of existing methods, offering improved efficiency, robustness, and generalization, as demonstrated by ablation and visualization results.
...
### [121] [Echo-DND: A dual noise diffusion model for robust and precise left ventricle segmentation in echocardiography](https://arxiv.org/abs/2506.15166)
*Abdur Rahman,Keerthiveena Balraj,Manojkumar Ramteke,Anurag Singh Rathore*

Main category: cs.CV

TL;DR: Echo-DND, a dual-noise diffusion model, improves LV segmentation in noisy echocardiograms using Gaussian and Bernoulli noises, multi-scale fusion, and spatial coherence calibration, outperforming SOTA models.
...
Method: Echo-DND combines Gaussian and Bernoulli noises, uses a multi-scale fusion module, and spatial coherence calibration for precise segmentation.
...
### [122] [ReSeDis: A Dataset for Referring-based Object Search across Large-Scale Image Collections](https://arxiv.org/abs/2506.15180)
...
### [123] [Conquering the Retina: Bringing Visual in-Context Learning to OCT](https://arxiv.org/abs/2506.15200)
...
Method: Uses VICL to train models for generalization across tasks based on few examples at inference time, with a tailored evaluation protocol for OCT.

Result: Evaluates a state-of-the-art VICL approach on multiple OCT datasets, establishing a baseline and highlighting potential and limitations.

Conclusion: The work demonstrates the promise of VICL for OCT, releases code to encourage further research and adoption.
...
### [124] [Privacy-Shielded Image Compression: Defending Against Exploitation from Vision-Language Pretrained Models](https://arxiv.org/abs/2506.15201)
*Xuelin Shen,Jiayin Xu,Kangsheng Yin,Wenhan Yang*

Main category: cs.CV

TL;DR: PSIC is a flexible image compression method that protects privacy by preventing VLP model interpretation while retaining original compression functionality. It uses CLTG and UAEO for customizable decoding and optimization.


<details>
  <summary>Details</summary>
Motivation: To safeguard user privacy against exploitation by VLP models and search engines, ensuring images remain protected while maintaining usability.

Method: Proposes PSIC with CLTG for conditional decoding and UAEO for optimization, integrating adaptive multi-objective optimization for performance and quality.

Result: Effective across multiple downstream tasks, balancing privacy protection and perceptual quality.

Conclusion: PSIC is a versatile, plug-and-play solution for privacy-preserving image compression, compatible with existing LIC models.
...
### [125] [DM-FNet: Unified multimodal medical image fusion via diffusion process-trained encoder-decoder](https://arxiv.org/abs/2506.15218)
...
Conclusion: DM-FNet effectively improves MMIF quality by leveraging diffusion models and adaptive fusion modules, validated across diverse medical image types.
...
### [126] [video-SALMONN 2: Captioning-Enhanced Audio-Visual Large Language Models](https://arxiv.org/abs/2506.15220)
...
Method: Uses low-rank adaptation (LoRA) and directed preference optimisation (DPO), with a novel multi-round DPO (MrDPO) approach for training.

Result: Reduces captioning error rates by 28%, surpassing GPT-4o and Gemini-1.5-Pro in video captioning.

Conclusion: Video-SALMONN 2 achieves state-of-the-art performance in video captioning and competitive results in video question-answering benchmarks.
...
TL;DR: The paper proposes C-AFBiFPN, a feature enhancement and fusion framework for SAR ship detection, improving accuracy for small targets and multi-scale adaptability.


<details>
  <summary>Details</summary>
Motivation: SAR ship detection faces challenges like scale variations, noise from small vessels, and complex backgrounds.

Method: C-AFBiFPN includes a Convolutional Feature Enhancement (CFE) module and integrates BiFormer attention into BiFPN for better feature fusion.

Result: Experiments on SSDD show improved detection accuracy for small targets, robustness to occlusions, and multi-scale adaptability.

Conclusion: C-AFBiFPN effectively addresses SAR ship detection challenges, enhancing feature representation and fusion.
...
Result: RA-NeRF achieves state-of-the-art performance in pose estimation and visual quality on Tanks&Temple and NeRFBuster datasets.
...
### [129] [Retrospective Memory for Camouflaged Object Detection](https://arxiv.org/abs/2506.15244)
...
Method: Two-stage training: learning (DMA for multi-scale info) and recall (DMM and IPR for dynamic memory use).
...
### [130] [Domain Adaptation for Image Classification of Defects in Semiconductor Manufacturing](https://arxiv.org/abs/2506.15260)
*Adrian Poniatowski,Natalie Gentner,Manuel Barusco,Davide Dalle Pezze,Samuele Salti,Gian Antonio Susto*

Main category: cs.CV

TL;DR: The paper explores Domain Adaptation (DA) techniques in the semiconductor sector, proposing the DBACS model to improve defect classification without extensive manual labeling.


<details>
  <summary>Details</summary>
Motivation: High demand and competition in semiconductors necessitate efficient methods like DA to reduce costs and improve quality.

Method: Proposes DBACS, a CycleGAN-inspired model with additional loss terms, tested on Electron Microscope images in semi-supervised and unsupervised settings.

Result: Validated effectiveness of DA techniques, showing improved robustness and scalability in semiconductor applications.

Conclusion: DBACS advances DA for semiconductors, reducing resource costs and enhancing defect classification.
...
### [131] [MSNeRV: Neural Video Representation with Multi-Scale Feature Fusion](https://arxiv.org/abs/2506.15276)
...
Method: Proposes MSNeRV with temporal windows for consistency, GoP-level grids for background, and a multi-scale spatial decoder with adaptive loss.
...
Conclusion: MSNeRV addresses limitations of INR-based video compression, offering improved performance for complex video content.
...
TL;DR: BCRNet improves landmark detection in laparoscopic liver surgery using Bezier curve refinement, outperforming existing methods.
...
Result: BCRNet outperforms state-of-the-art methods on L3D and P2ILF datasets.

Conclusion: BCRNet offers a robust solution for landmark detection in laparoscopic surgery, improving surgical navigation.
...
### [133] [AI-driven visual monitoring of industrial assembly tasks](https://arxiv.org/abs/2506.15285)
...
<details>
  <summary>Details</summary>
Motivation: To enable flexible visual monitoring of industrial assembly tasks without workspace constraints or markers, ensuring safety and preventing errors.

Method: Combines a perception module for multi-view video analysis with a reasoning module to infer actions based on observed states and task knowledge.

Result: Effectively monitored assembly tasks in challenging real-world scenarios with partial/uncertain observations, validated quantitatively and qualitatively.

Conclusion: ViMAT offers a practical, marker-free solution for real-time assembly task monitoring in industrial settings.
...
### [134] [MEGC2025: Micro-Expression Grand Challenge on Spot Then Recognize and Visual Question Answering](https://arxiv.org/abs/2506.15298)
*Xinqi Fan,Jingting Li,John See,Moi Hoon Yap,Wen-Huang Cheng,Xiaobai Li,Xiaopeng Hong,Su-Jing Wang,Adrian K. Davision*

Main category: cs.CV

TL;DR: The paper discusses advancements in facial micro-expression (ME) analysis, highlighting the limitations of conventional separate spotting and recognition tasks. It introduces two new tasks for MEGC 2025: ME-STR (unified spotting and recognition) and ME-VQA (visual question answering using MLLMs/LVLMs).


<details>
  <summary>Details</summary>
Motivation: Current ME analysis methods are suboptimal for long-duration videos in realistic settings, and the rise of MLLMs/LVLMs offers new opportunities for improved ME understanding.

Method: The paper proposes two tasks: ME-STR (sequential spotting and recognition) and ME-VQA (using MLLMs/LVLMs for ME-related questions).

Result: The MEGC 2025 challenge will evaluate algorithms on these tasks, with results submitted to a leaderboard.

Conclusion: The paper aims to advance ME analysis by integrating spotting and recognition and leveraging multimodal models for deeper understanding.
...
### [135] [MapFM: Foundation Model-Driven HD Mapping with Multi-Task Contextual Learning](https://arxiv.org/abs/2506.15313)
...
Result: The approach enhances feature representation and prediction quality, yielding higher accuracy in vectorized HD maps.

Conclusion: MapFM demonstrates improved scene understanding and map quality, with open-source code available for further development.
...
### [136] [OpenPath: Open-Set Active Learning for Pathology Image Classification via Pre-trained Vision-Language Models](https://arxiv.org/abs/2506.15318)
*Lanfeng Zhong,Xin Liao,Shichuan Zhang,Shaoting Zhang,Guotai Wang*

Main category: cs.CV

TL;DR: OpenPath is a novel open-set active learning method for pathology image classification, leveraging a pre-trained Vision-Language Model to efficiently select informative in-distribution samples while avoiding out-of-distribution data.
...
Method: OpenPath uses task-specific prompts in the first query to select in-distribution samples. Subsequent queries employ Diverse Informative ID Sampling (DIS), combining Prototype-based ID candidate Selection (PIS) and Entropy-Guided Stochastic Sampling (EGSS).

Result: Experiments on two public pathology datasets show OpenPath outperforms state-of-the-art open-set active learning methods, enhancing model performance due to high sample purity.

Conclusion: OpenPath effectively addresses the challenges of open-set active learning in pathology image classification, offering a practical solution for real-world clinical environments.
...
### [137] [Open-World Object Counting in Videos](https://arxiv.org/abs/2506.15368)
*Niki Amini-Naieni,Andrew Zisserman*

Main category: cs.CV

TL;DR: A new task of open-world object counting in videos is introduced, where the goal is to count unique instances of target objects specified by text or image. The proposed model, CountVid, combines image-based counting and video segmentation/tracking to address challenges like occlusions and double counting. A new dataset, VideoCount, is introduced for evaluation, showing CountVid's superior performance.


<details>
  <summary>Details</summary>
Motivation: The task addresses the challenge of accurately counting unique object instances in videos, especially in crowded scenes with occlusions and similar objects, where traditional methods may fail.

Method: CountVid integrates an image-based counting model with a promptable video segmentation and tracking model to automate object counting across video frames.

Result: CountVid demonstrates accurate object counting and outperforms strong baselines on the VideoCount dataset, which includes diverse scenarios like penguin videos and x-ray footage of metal alloy crystallization.

Conclusion: The paper presents a novel solution for open-world object counting in videos, validated by a new dataset, with CountVid showing promising results. The dataset and model are publicly available.
...
### [138] [Unsupervised Pelage Pattern Unwrapping for Animal Re-identification](https://arxiv.org/abs/2506.15369)
*Aleksandr Algasov,Ekaterina Nepovinnykh,Fedor Zolotarev,Tuomas Eerola,Heikki Kälviäinen,Pavel Zemčík,Charles V. Stewart*

Main category: cs.CV

TL;DR: A geometry-aware texture mapping method improves animal re-identification by unwarping deformable fur patterns into a canonical UV space, enhancing feature matching without ground truth UV annotations.


<details>
  <summary>Details</summary>
Motivation: Existing methods struggle with deformable animal fur/skin patterns due to body movement and posture changes, necessitating a robust solution.
...
Conclusion: The self-supervised framework enhances re-identification accuracy across diverse poses and viewing angles without requiring UV annotations.
...
### [139] [When Model Knowledge meets Diffusion Model: Diffusion-assisted Data-free Image Synthesis with Alignment of Domain and Class](https://arxiv.org/abs/2506.15381)
*Yujin Kim,Hyunsoo Kim,Hyunwoo J. Kim,Suhyun Kim*

Main category: cs.CV

TL;DR: DDIS introduces a diffusion-assisted method for data-free image synthesis, leveraging a text-to-image diffusion model and domain alignment guidance to generate high-quality synthetic images aligned with the training data distribution.


<details>
  <summary>Details</summary>
Motivation: Existing DFIS methods produce samples deviating from the training data due to lack of natural image priors. DDIS aims to improve synthetic image quality by incorporating a diffusion model as a prior.

Method: DDIS uses a text-to-image diffusion model and introduces Domain Alignment Guidance (DAG) and Class Alignment Token (CAT) to align synthetic images with the training data distribution.
...
Conclusion: DDIS effectively addresses the limitations of DFIS by leveraging diffusion models and alignment techniques, enabling high-quality synthetic data generation without access to original training data.
...
### [140] [NERO: Explainable Out-of-Distribution Detection with Neuron-level Relevance](https://arxiv.org/abs/2506.15404)
*Anju Chhetri,Jari Korhonen,Prashnna Gyawali,Binod Bhattarai*

Main category: cs.CV

TL;DR: The paper proposes NERO, a novel OOD scoring mechanism for medical imaging, leveraging neuron-level relevance and clustering to improve OOD detection, validated on gastrointestinal benchmarks.
...
Method: NERO clusters neuron-level relevance for ID classes into centroids and uses a relevance distance metric to quantify deviations. It also incorporates scaled relevance and feature norms.
...
### [141] [Hunyuan3D 2.1: From Images to High-Fidelity 3D Assets with Production-Ready PBR Material](https://arxiv.org/abs/2506.15442)
...
<details>
  <summary>Details</summary>
Motivation: The field of 3D AIGC is complex and inaccessible to many; this tutorial aims to simplify the process using Hunyuan3D 2.1.

Method: The tutorial covers data preparation, model architecture (Hunyuan3D-DiT for shape, Hunyuan3D-Paint for texture), training strategies, and evaluation.

Result: Participants will learn to develop or finetune a 3D generative model for applications like gaming and VR.

Conclusion: The tutorial equips users with practical knowledge to create high-resolution, textured 3D assets.
...
### [142] [Multimodal Large Language Models for Medical Report Generation via Customized Prompt Tuning](https://arxiv.org/abs/2506.15477)
...
Method: MRG-LLM uses a frozen LLM, a learnable visual encoder, and dynamic prompt customization (prompt-wise and promptbook-wise) via conditional affine transformations.

Result: Achieves state-of-the-art performance on IU X-ray and MIMIC-CXR datasets.

Conclusion: MRG-LLM effectively integrates LLMs with medical imaging for precise report generation, with code to be publicly released.
...
### [143] [GenHOI: Generalizing Text-driven 4D Human-Object Interaction Synthesis for Unseen Objects](https://arxiv.org/abs/2506.15483)
*Shujia Li,Haiyu Zhang,Xinyuan Chen,Yaohui Wang,Yutong Ban*

Main category: cs.CV

TL;DR: GenHOI is a two-stage framework for 4D human-object interaction synthesis, addressing generalization to unseen objects and high-fidelity sequence generation using Object-AnchorNet and ContactDM.


<details>
  <summary>Details</summary>
Motivation: The challenge lies in the limited availability of large-scale 4D HOI datasets, hindering progress in text-driven human motion synthesis for 4D HOI.

Method: 1) Object-AnchorNet reconstructs sparse 3D HOI keyframes for unseen objects. 2) ContactDM interpolates these into 4D sequences using a Contact-Aware Encoder and HOI Attention.
...
Conclusion: GenHOI effectively addresses dataset limitations and achieves high-quality 4D HOI synthesis, advancing the field.
...
### [144] [NTIRE 2025 Image Shadow Removal Challenge Report](https://arxiv.org/abs/2506.15524)
...
<details>
  <summary>Details</summary>
Motivation: To advance shadow removal techniques by evaluating diverse solutions in fidelity and visual perception.

Method: Two evaluation tracks: reconstruction fidelity and visual perception via user study, using the WSRD+ dataset.

Result: 17 teams submitted solutions, showcasing diverse approaches to shadow removal.

Conclusion: The challenge highlights progress in shadow removal, with fidelity and perception as key metrics.
...
### [145] [CLAIM: Clinically-Guided LGE Augmentation for Realistic and Diverse Myocardial Scar Synthesis and Segmentation](https://arxiv.org/abs/2506.15549)
*Farheen Ramzan,Yusuf Kiberu,Nikesh Jathanna,Shahnaz Jamil-Copley,Richard H. Clayton,Chen,Chen*

Main category: cs.CV

TL;DR: CLAIM is a framework for generating realistic and diverse myocardial scar images using clinical guidance, improving scar segmentation accuracy.
...
Method: CLAIM uses a diffusion-based generator (SMILE module) guided by the AHA 17-segment model and joint training of the generator and segmentation network.
...
### [146] [One-Step Diffusion for Detail-Rich and Temporally Consistent Video Super-Resolution](https://arxiv.org/abs/2506.15591)
*Yujing Sun,Lingchen Sun,Shuaizheng Liu,Rongyuan Wu,Zhengqiang Zhang,Lei Zhang*

Main category: cs.CV

TL;DR: DLoRAL introduces a Dual LoRA Learning paradigm for Real-VSR, combining Cross-Frame Retrieval and LoRA modules to balance spatial detail and temporal consistency in one-step diffusion.


<details>
  <summary>Details</summary>
Motivation: Existing SD-based Real-VSR methods often sacrifice spatial details for temporal coherence, leading to suboptimal visual quality.

Method: Proposes a Dual LoRA Learning (DLoRAL) paradigm with Cross-Frame Retrieval (CFR) and Consistency-LoRA (C-LoRA) for temporal consistency, followed by Detail-LoRA (D-LoRA) for spatial enhancement.

Result: DLoRAL achieves strong performance in accuracy and speed, delivering consistent and detail-rich outputs.

Conclusion: The method effectively balances spatial detail and temporal consistency in Real-VSR, outperforming existing approaches.
...
### [147] [Mono-Modalizing Extremely Heterogeneous Multi-Modal Medical Image Registration](https://arxiv.org/abs/2506.15596)
*Kyobin Choo,Hyunkyung Han,Jinyeong Kim,Chanyong Yoon,Seong Jae Hwang*

Main category: cs.CV

TL;DR: M2M-Reg is a novel framework for multi-modal deformable image registration (DIR) that uses mono-modal similarity, outperforming prior methods on PET-MRI and FA-MRI alignment.
...
Method: Proposes M2M-Reg, leveraging mono-modal similarity and GradCyCon regularization for diffeomorphism, and extends to semi-supervised settings.

Result: Achieves up to 2x higher Dice Similarity Coefficient (DSC) than prior methods on ADNI dataset for PET-MRI and FA-MRI registration.

Conclusion: M2M-Reg effectively addresses multi-modal DIR challenges, offering seamless integration and superior performance.
...
### [148] [BoxFusion: Reconstruction-Free Open-Vocabulary 3D Object Detection via Real-Time Multi-View Box Fusion](https://arxiv.org/abs/2506.15610)
...
<details>
  <summary>Details</summary>
Motivation: Addressing computational overhead and memory constraints in existing dense point cloud reconstruction methods for 3D object detection.

Method: Uses Cubify Anything and CLIP for single-view detection, with association and optimization modules for multi-view fusion.
...
Conclusion: The proposed framework offers efficient, real-time 3D detection with strong generalization across diverse scenarios.
...
### [149] [HOIDiNi: Human-Object Interaction through Diffusion Noise Optimization](https://arxiv.org/abs/2506.15625)
*Roey Ron,Guy Tevet,Haim Sawdayee,Amit H. Bermano*

Main category: cs.CV

TL;DR: HOIDiNi is a text-driven diffusion framework for realistic human-object interaction (HOI) generation, optimizing noise space for realism and physical correctness.


<details>
  <summary>Details</summary>
Motivation: HOI generation is challenging due to strict contact accuracy and diverse motion requirements. Current methods trade off realism and correctness; HOIDiNi aims to achieve both.

Method: Uses Diffusion Noise Optimization (DNO) in two phases: object-centric (hand-object contact) and human-centric (full-body motion refinement).

Result: Outperforms prior works in contact accuracy, physical validity, and quality on the GRAB dataset. Generates complex interactions like grasping and placing.

Conclusion: HOIDiNi successfully generates realistic and controllable HOIs from text prompts, balancing precision and natural motion.
...
### [150] [FindingDory: A Benchmark to Evaluate Memory in Embodied Agents](https://arxiv.org/abs/2506.15635)
*Karmesh Yadav,Yusuf Ali,Gunshi Gupta,Yarin Gal,Zsolt Kira*

Main category: cs.CV

TL;DR: The paper introduces a new benchmark for long-range embodied tasks in the Habitat simulator to evaluate memory-based capabilities in robotics, addressing limitations of current VLMs in handling long-term memory.


<details>
  <summary>Details</summary>
Motivation: Current vision-language models (VLMs) struggle with long-term memory in embodied contexts, limiting their real-world robotics applications. Existing benchmarks lack focus on embodied challenges like object manipulation and navigation.

Method: A new benchmark is introduced in the Habitat simulator, featuring 60 tasks requiring sustained engagement and contextual awareness. Tasks can be procedurally extended for scalable evaluation. Baselines integrate state-of-the-art VLMs with navigation policies.

Result: The benchmark evaluates VLMs on memory-intensive tasks, identifying areas for improvement in memory integration and action execution.

Conclusion: The work highlights the need for better memory mechanisms in VLMs for embodied robotics and provides a scalable benchmark for future research.
...
### [151] [Demystifying the Visual Quality Paradox in Multimodal Large Language Models](https://arxiv.org/abs/2506.15645)
*Shuo Xing,Lanqing Guo,Hongyuan Hua,Seoyoung Lee,Peiran Li,Yufei Wang,Zhangyang Wang,Zhengzhong Tu*

Main category: cs.CV

TL;DR: Higher visual quality doesn't always improve MLLM performance; controlled degradations can enhance results. VQ-TTT, a lightweight adaptation module, dynamically adjusts images to align with model preferences, boosting accuracy.


<details>
  <summary>Details</summary>
Motivation: To understand how visual quality impacts MLLM performance and address the paradox where degraded images sometimes improve results.

Method: Systematic study with controlled image degradations and stylistic shifts. Introduces VQ-TTT, a module with a learnable kernel and LoRA fine-tuning for dynamic image adjustment.
...
Conclusion: MLLMs benefit from adaptive visual inputs, challenging the notion of universally "better" quality. VQ-TTT offers a practical solution for aligning inputs with model preferences.
...
### [152] [Dual-Stage Value-Guided Inference with Margin-Based Reward Adjustment for Fast and Faithful VLM Captioning](https://arxiv.org/abs/2506.15649)
...
### [153] [UniRelight: Learning Joint Decomposition and Synthesis for Video Relighting](https://arxiv.org/abs/2506.15673)
...
TL;DR: A novel joint approach for image/video relighting using video diffusion models to improve realism and generalization.


<details>
  <summary>Details</summary>
Motivation: Overcome limitations of existing relighting methods, such as data scarcity and error accumulation, by integrating albedo estimation and relighting synthesis.
...
Conclusion: The proposed approach effectively addresses relighting challenges, offering realistic results and broad applicability.
...
### [154] [Sekai: A Video Dataset towards World Exploration](https://arxiv.org/abs/2506.15675)
...
Method: Sekai includes 5,000+ hours of videos from 100+ countries, annotated with location, scene, weather, etc., and a toolbox for processing.

Result: Experiments confirm dataset quality, and a subset trains YUME, an interactive video world exploration model.
...
### [155] [Evolutionary Caching to Accelerate Your Off-the-Shelf Diffusion Model](https://arxiv.org/abs/2506.15682)
...
Method: ECAD uses a genetic algorithm to learn efficient caching schedules, forming a Pareto frontier with minimal calibration prompts.
...
### [156] [Adverse Event Extraction from Discharge Summaries: A New Dataset, Annotation Scheme, and Initial Findings](https://arxiv.org/abs/2506.14900)
...
Method: A manually annotated dataset of 14 clinically significant AEs with contextual attributes is created. Multiple models, including transformer-based ones, are evaluated across three annotation granularities using FlairNLP.

Result: BERT-cased models excel in coarse-grained extraction (F1 = 0.943) but perform poorly on fine-grained tasks (F1 = 0.675), especially for rare events and complex attributes.

Conclusion: Despite strong high-level performance, challenges persist in detecting underrepresented AEs and nuanced clinical language. The dataset serves as a benchmark for future AE extraction research.
...
### [157] [Combining Constrained and Unconstrained Decoding via Boosting: BoostCD and Its Application to Information Extraction](https://arxiv.org/abs/2506.14901)
...
<details>
  <summary>Details</summary>
Motivation: Address low-quality output in constrained decoding by exploiting complementary errors from constrained and unconstrained decoding.
...
Conclusion: BoostCD effectively improves structured NLP tasks by dynamically combining constrained and unconstrained decoding.
...
### [158] [CrEst: Credibility Estimation for Contexts in LLMs via Weak Supervision](https://arxiv.org/abs/2506.14912)
...
Method: CrEst uses inter-document agreement for automated credibility estimation and integrates it into LLMs via black-box and white-box strategies.
...
### [159] [MDBench: A Synthetic Multi-Document Reasoning Benchmark Generated with Knowledge Guidance](https://arxiv.org/abs/2506.14927)
...
Method: MDBench uses a synthetic generation process involving LLM-assisted edits on structured seed knowledge to create document sets and QA examples.

Result: MDBench proves challenging for current LLMs and prompting techniques, even with short documents.
...
### [160] [From Chat to Checkup: Can Large Language Models Assist in Diabetes Prediction?](https://arxiv.org/abs/2506.14949)
*Shadman Sakib,Oishy Fatema Akhand,Ajwad Abrar*

Main category: cs.CL

TL;DR: LLMs like GPT-4o and Gemma-2-27B outperform traditional ML models in diabetes prediction, but performance varies with prompting strategies.


<details>
  <summary>Details</summary>
Motivation: To explore the effectiveness of LLMs for structured numerical data in diabetes prediction, an area not well-studied.

Method: Empirical analysis using PIDD, testing six LLMs (four open-source, two proprietary) with zero-shot, one-shot, and three-shot prompting, compared to three traditional ML models.

Result: Proprietary LLMs (GPT-4o, Gemini Flash 2.0) and Gemma-2-27B perform best, with Gemma-2-27B surpassing traditional ML models in F1-score.

Conclusion: LLMs show promise for medical predictions but need prompt engineering and hybrid approaches for better performance.
...
### [161] [Memory Tokens: Large Language Models Can Generate Reversible Sentence Embeddings](https://arxiv.org/abs/2506.15001)
...
Method: Introduce a memory token whose embedding is optimized for reconstructing fixed sequences when prompted.

Result: Successful reconstruction across English/Spanish datasets, sequences up to 240 tokens, and model scales (100M-8B). Llama 3.1 8B achieved perfect reconstruction.
...
### [162] [Identifying social isolation themes in NVDRS text narratives using topic modeling and text-classification methods](https://arxiv.org/abs/2506.15030)
*Drew Walker,Swati Rajwal,Sudeshna Das,Snigdha Peddireddy,Abeed Sarker*

Main category: cs.CL

TL;DR: The paper uses NLP to identify social isolation and loneliness in suicide narratives, revealing higher risks for men, gay individuals, and divorced people.


<details>
  <summary>Details</summary>
Motivation: Social isolation and loneliness are rising and linked to suicide, but not tracked in NVDRS. NLP can help identify these factors.
...
Result: High-quality classifiers (F1: .86, accuracy: .82) identified 1,198 cases of chronic social isolation, with higher odds for men, gay, and divorced individuals.

Conclusion: NLP methods can enhance surveillance and prevention of social isolation and loneliness in the US.
...
### [163] [Semantically-Aware Rewards for Open-Ended R1 Training in Free-Form Generation](https://arxiv.org/abs/2506.15068)
...
### [164] [Learning-Time Encoding Shapes Unlearning in LLMs](https://arxiv.org/abs/2506.15076)
*Ruihan Wu,Konstantin Garov,Kamalika Chaudhuri*

Main category: cs.CL

TL;DR: The paper explores how learning-time choices in knowledge encoding affect unlearning effectiveness in LLMs, finding paraphrased descriptions improve unlearning and highlighting challenges in unlearning specific knowledge chunks.


<details>
  <summary>Details</summary>
Motivation: To address the need for unlearning in LLMs due to privacy, regulations, and outdated/harmful content, and to understand how learning-time choices impact unlearning.

Method: Empirical investigation of how learning-time knowledge encoding affects unlearning, focusing on paraphrased descriptions and knowledge chunks.

Result: Paraphrased descriptions improve unlearning performance, but unlearning specific knowledge from text chunks is difficult.
...
### [165] [Improving Dialogue Discourse Parsing through Discourse-aware Utterance Clarification](https://arxiv.org/abs/2506.15081)
*Yaxin Fan,Peifeng Li,Qiaoming Zhu*

Main category: cs.CL

TL;DR: The paper proposes a Discourse-aware Clarification Module (DCM) and Contribution-aware Preference Optimization (CPO) to improve dialogue discourse parsing by resolving ambiguities caused by linguistic features like omission and idiom.


<details>
  <summary>Details</summary>
Motivation: Linguistic ambiguities in dialogues obscure discourse relations, challenging parsers. The goal is to enhance parsing accuracy by addressing these ambiguities.

Method: Introduces DCM with two reasoning processes (clarification type and discourse goal) and CPO to optimize clarifications and reduce errors.

Result: Outperforms SOTA baselines on STAC and Molweni datasets, effectively resolving ambiguities.

Conclusion: The proposed DCM and CPO significantly improve dialogue discourse parsing by mitigating ambiguities and optimizing clarifications.
...
### [166] [CKD-EHR:Clinical Knowledge Distillation for Electronic Health Records](https://arxiv.org/abs/2506.15118)
...
Method: Uses knowledge distillation: fine-tunes Qwen2.5-7B as a teacher model, generates soft labels, and transfers knowledge to a BERT student model.

Result: On MIMIC-III, CKD-EHR boosts diagnostic accuracy by 9%, F1-score by 27%, and speeds up inference 22.2x.
...
### [167] [Modeling the One-to-Many Property in Open-Domain Dialogue with LLMs](https://arxiv.org/abs/2506.15131)
...
<details>
  <summary>Details</summary>
Motivation: Most LLM-based dialogue agents do not explicitly model the one-to-many (o2m) property of OD, which limits response diversity. This work aims to address this gap.

Method: Decomposes OD generation into MRG (generating diverse responses) and PS (selecting based on preference). Introduces o2mDial corpus and new in-context learning, instruction-tuning, and evaluation strategies.
...
Conclusion: The proposed two-stage framework effectively enhances OD generation by leveraging the o2m property, improving both diversity and coherence.
...
### [168] [Thunder-Tok: Minimizing Tokens per Word in Tokenizing Korean Texts for Generative Language Models](https://arxiv.org/abs/2506.15138)
...
Result: Reduces fertility by ~10% (improves inference speed by 10%) without performance loss in downstream tasks.
...
### [169] [Emergence of Primacy and Recency Effect in Mamba: A Mechanistic Point of View](https://arxiv.org/abs/2506.15156)
...
Method: Structured recall tasks applied to the Mamba architecture, with targeted ablations and input perturbations on two large-scale Mamba-based models (1.4B and 7B parameters).

Result: A U-shaped accuracy profile emerges, showing strong performance at sequence beginnings and ends. Three mechanisms are identified: sparse channels for long-term memory, delta-modulated recurrence for short-term memory, and dynamic modulation by semantic regularity.

Conclusion: The study uncovers distinct memory mechanisms in state-space models, highlighting the interplay of long-term and short-term memory, and the influence of semantic patterns on memory allocation.
...
### [170] [A Comparative Study of Task Adaptation Techniques of Large Language Models for Identifying Sustainable Development Goals](https://arxiv.org/abs/2506.15208)
*Andrea Cadeddu,Alessandro Chessa,Vincenzo De Leo,Gianni Fenu,Enrico Motta,Francesco Osborne,Diego Reforgiato Recupero,Angelo Salatino,Luca Secchi*

Main category: cs.CL

TL;DR: The paper evaluates LLMs for SDG-related text classification, comparing proprietary and open-source models and testing task adaptation techniques like Zero-Shot, Few-Shot Learning, and Fine-Tuning. Smaller models with optimized prompts can match larger models like GPT.


<details>
  <summary>Details</summary>
Motivation: Tracking progress toward the UN's SDGs is challenging due to data complexity. Text classification models, especially LLMs, are essential for automating analysis.

Method: Analyzes various LLMs for SDG-focused text classification and evaluates task adaptation techniques (Zero-Shot, Few-Shot Learning, Fine-Tuning).
...
### [171] [ProtoReasoning: Prototypes as the Foundation for Generalizable Reasoning in LLMs](https://arxiv.org/abs/2506.15211)
...
<details>
  <summary>Details</summary>
Motivation: To understand and enhance cross-domain generalization in LRMs by identifying shared abstract reasoning prototypes.

Method: Introduces ProtoReasoning, a framework with automated prototype construction, verification, and scalability for reasoning tasks.

Result: Achieves 4.7% (logical), 6.3% (planning), 4.0% (general reasoning), and 1.0% (math) improvements over baselines.
...
### [172] [MinosEval: Distinguishing Factoid and Non-Factoid for Tailored Open-Ended QA Evaluation with LLMs](https://arxiv.org/abs/2506.15215)
*Yongqi Fan,Yating Wang,Guandong Wang,Jie Zhai,Jingping Liu,Qi Ye,Tong Ruan*

Main category: cs.CL

TL;DR: MinosEval is a novel method for evaluating open-ended QA, distinguishing factoid and non-factoid questions for better alignment with human judgments.
...
Method: MinosEval classifies questions into factoid and non-factoid, applying adaptive key-point scoring for the former and instance-aware listwise ranking for the latter.

Result: Experiments show MinosEval aligns better with human annotations and provides more interpretable results than traditional metrics.

Conclusion: MinosEval addresses key challenges in open-ended QA evaluation, offering improved accuracy and interpretability.
...
### [173] [Lost in Variation? Evaluating NLI Performance in Basque and Spanish Geographical Variants](https://arxiv.org/abs/2506.15239)
*Jaione Bengoetxea,Itziar Gonzalez-Dios,Rodrigo Agerri*

Main category: cs.CL

TL;DR: The paper evaluates language technologies' ability to handle Basque and Spanish linguistic variations using NLI, revealing performance drops, especially for Basque, due to linguistic variation rather than lexical overlap.
...
Method: Uses NLI as a pivot task with a manually-curated parallel dataset, testing crosslingual and in-context learning with encoder-only and decoder-based LLMs.

Result: Performance drops when handling linguistic variation, particularly in Basque, with encoder-only models struggling most with Western Basque.

Conclusion: Linguistic variation, not lexical overlap, causes performance declines, aligning with linguistic theory about peripheral dialects. Data and code are publicly available.
...
### [174] [Research on Graph-Retrieval Augmented Generation Based on Historical Text Knowledge Graphs](https://arxiv.org/abs/2506.15241)
...
Method: Proposes Graph RAG, integrating chain-of-thought prompting, self-instruction generation, and process supervision to create a dataset with minimal manual annotation. Uses a collaborative mechanism between knowledge graphs and retrieval-augmented generation.

Result: Domain-specific model Xunzi-Qwen1.5-14B achieves F1=0.68 in relation extraction. GraphRAG improves F1 by 11% on C-CLUE, surpassing Xunzi-Qwen1.5-14B and reducing hallucinations.

Conclusion: Graph RAG provides a low-resource solution for classical text knowledge extraction, enhancing historical knowledge services and humanities research.
...
### [175] [TopClustRAG at SIGIR 2025 LiveRAG Challenge](https://arxiv.org/abs/2506.15246)
*Juli Bakagianni,John Pavlopoulos,Aristidis Likas*

Main category: cs.CL

TL;DR: TopClustRAG is a hybrid RAG system combining sparse and dense retrieval with K-Means clustering for diverse, relevant answers, ranking 2nd in faithfulness and 7th in correctness.
...
### [176] [Thunder-DeID: Accurate and Efficient De-identification Framework for Korean Court Judgments](https://arxiv.org/abs/2506.15266)
*Sungen Hahm,Heejin Kim,Gyuseong Lee,Hyunji Park,Jaejin Lee*

Main category: cs.CL

TL;DR: Thunder-DeID is a framework for de-identifying Korean court judgments, addressing legal and technical challenges with a DNN-based pipeline and achieving top performance.
...
Method: The framework includes constructing a legal dataset, categorizing PII, and developing a DNN-based de-identification pipeline.
...
### [177] [Cohort Discovery: A Survey on LLM-Assisted Clinical Trial Recruitment](https://arxiv.org/abs/2506.15301)
*Shrestha Ghosh,Moritz Schneider,Carina Reinicke,Carsten Eickhoff*

Main category: cs.CL

TL;DR: The paper surveys LLM-based approaches for clinical trial-patient matching, highlighting their potential but criticizing weak evaluation benchmarks and reliance on proprietary models.


<details>
  <summary>Details</summary>
Motivation: Despite LLMs' success in general NLP tasks, their use in critical domains like clinical trial recruitment is limited, despite the task's need for knowledge aggregation and reasoning.

Method: The survey analyzes trial-patient matching, contextualizes emerging LLM-based approaches, and examines benchmarks, methods, and evaluation frameworks.

Result: LLMs show promise for general solutions in trial-patient matching, but current applications suffer from proprietary models and inadequate benchmarks.

Conclusion: The paper identifies challenges in adopting LLMs for clinical research and suggests future directions for improvement.
...
### [178] [ConLID: Supervised Contrastive Learning for Low-Resource Language Identification](https://arxiv.org/abs/2506.15304)
...
### [179] [DeVisE: Behavioral Testing of Medical Large Language Models](https://arxiv.org/abs/2506.15339)
*Camila Zurdo Tagliabue,Heloisa Oss Boll,Aykut Erdem,Erkut Erdem,Iacer Calixto*

Main category: cs.CL

TL;DR: DeVisE framework evaluates LLMs' clinical reasoning by testing sensitivity to demographic and vital sign changes in ICU notes, revealing zero-shot models reason better while fine-tuned ones are more stable but less responsive.
...
Method: Constructed ICU discharge notes dataset (MIMIC-IV) with real-world and synthetic versions, testing five LLMs under zero-shot and fine-tuned settings using counterfactuals for demographics and vital signs.

Result: Zero-shot models showed coherent counterfactual reasoning, while fine-tuned models were stable but less responsive to clinically meaningful changes. Demographic factors subtly influenced outputs.

Conclusion: Behavioral testing like DeVisE is crucial for exposing LLM reasoning strategies and designing safer, transparent medical AI systems.
...
### [180] [SANSKRITI: A Comprehensive Benchmark for Evaluating Language Models' Knowledge of Indian Culture](https://arxiv.org/abs/2506.15355)
...
Result: Evaluation showed significant disparities in models' performance, with many struggling in region-specific contexts.
...
### [181] [COSMMIC: Comment-Sensitive Multimodal Multilingual Indian Corpus for Summarization and Headline Generation](https://arxiv.org/abs/2506.15372)
*Raghvendra Kumar,S. A. Mohammed Salman,Aryan Sahu,Tridib Nandi,Pragathi Y. P.,Sriparna Saha,Jose G. Moreno*

Main category: cs.CL

TL;DR: The paper introduces COSMMIC, a comment-sensitive multimodal, multilingual dataset for nine Indian languages, enhancing summarization by integrating text, images, and user feedback.
...
Method: Developed COSMMIC with 4,959 article-image pairs and 24,484 comments, tested with LLama3 and GPT-4 across four configurations (text, comments, images, combined).

Result: Identified effective configurations for summarization and headline generation, leveraging supportive comments and filtering noise.

Conclusion: COSMMIC bridges gaps in Indian language resources, advancing NLP inclusivity and research.
...
### [182] [Targeted Lexical Injection: Unlocking Latent Cross-Lingual Alignment in Lugha-Llama via Early-Layer LoRA Fine-Tuning](https://arxiv.org/abs/2506.15415)
*Stanley Ngugi*

Main category: cs.CL

TL;DR: The paper introduces Targeted Lexical Injection (TLI), a fine-tuning method to improve lexical alignment in low-resource languages (LRLs) like Swahili for LLMs, achieving significant improvements in cross-lingual similarity.
...
Method: TLI uses Low-Rank Adaptation (LoRA) and contrastive learning to fine-tune embeddings from an optimal early layer (Layer 2) in a Swahili-centric LLM.

Result: TLI improved average cosine similarity for Swahili-English word pairs by 28.08% (trained) and 28.32% (unseen), with high statistical significance.

Conclusion: TLI effectively enhances lexical alignment in LRL-focused LLMs, preserving early-layer cross-lingual knowledge efficiently.
...
### [183] [Understanding GUI Agent Localization Biases through Logit Sharpness](https://arxiv.org/abs/2506.15425)
*Xingjian Tao,Yiwei Wang,Yujun Cai,Zhicheng Yang,Jing Tang*

Main category: cs.CL

TL;DR: The paper proposes a framework to evaluate and improve multimodal large language models (MLLMs) for GUI agents, addressing hallucinations and introducing new metrics and techniques.


<details>
  <summary>Details</summary>
Motivation: MLLMs for GUI agents suffer from systematic localization errors (hallucinations), compromising reliability.

Method: Introduces a fine-grained evaluation framework, the Peak Sharpness Score (PSS), and Context-Aware Cropping to improve performance.

Result: The framework reveals nuanced failure modes, and the proposed methods enhance interpretability and robustness.

Conclusion: The study provides actionable insights to improve MLLMs for GUI agents, addressing reliability and performance issues.
...
### [184] [AgentGroupChat-V2: Divide-and-Conquer Is What LLM-Based Multi-Agent System Need](https://arxiv.org/abs/2506.15451)
*Zhouhong Gu,Xiaoxuan Zhu,Yin Cai,Hao Shen,Xingzhou Chen,Qingyi Wang,Jialin Li,Xiaoran Shi,Haoran Guo,Wenxuan Huang,Hongwei Feng,Yanghua Xiao,Zheyu Ye,Yao Hu,Shaosheng Cao*

Main category: cs.CL

TL;DR: AgentGroupChat-V2 is a novel multi-agent framework addressing challenges in architecture, generalizability, and performance with innovations like parallel task decomposition, adaptive collaboration, and optimization strategies, achieving superior results in complex tasks.
...
Method: Introduces three innovations: (1) parallel hierarchical task decomposition, (2) adaptive LLM collaboration, (3) agent organization optimization.

Result: Achieves 91.50% on GSM8K, 30.4% on AIME, and 79.20% on HumanEval, with significant gains in complex tasks.

Conclusion: AgentGroupChat-V2 offers an efficient, general-purpose solution for LLM multi-agent systems, excelling in complex reasoning.
...
### [185] [RE-IMAGINE: Symbolic Benchmark Synthesis for Reasoning Evaluation](https://arxiv.org/abs/2506.15455)
...
<details>
  <summary>Details</summary>
Motivation: To clarify whether LLMs' high accuracy stems from true reasoning or statistical recall of training data.
...
Conclusion: The framework highlights LLMs' limitations in true reasoning and suggests future research to improve reasoning skills.
...
### [186] [Context-Informed Grounding Supervision](https://arxiv.org/abs/2506.15480)
*Hyunji Lee,Seunghyun Yoon,Yunjae Won,Hanseok Oh,Geewook Kim,Trung Bui,Franck Dernoncourt,Elias Stengel-Eskin,Mohit Bansal,Minjoon Seo*

Main category: cs.CL

TL;DR: CINGS is a post-training method that improves LLM grounding by training models to rely on external context, outperforming standard methods in text and vision domains without degrading performance.


<details>
  <summary>Details</summary>
Motivation: To address the issue of LLMs not effectively grounding responses in external context, despite its potential to reduce hallucination and supplement knowledge.
...
Result: CINGS-trained models show stronger grounding in text and vision domains, outperforming other methods on 11 datasets and reducing hallucinations in vision-language tasks.

Conclusion: CINGS enhances grounding by shifting model behavior to rely more on external context, maintaining downstream performance.
...
### [187] [SPARE: Single-Pass Annotation with Reference-Guided Evaluation for Automatic Process Supervision and Reward Modelling](https://arxiv.org/abs/2506.15498)
...
Conclusion: SPARE offers a competitive, efficient solution for process supervision in LLMs, with public release for reproducibility.
...
### [188] [Enhancing Hyperbole and Metaphor Detection with Their Bidirectional Dynamic Interaction and Emotion Knowledge](https://arxiv.org/abs/2506.15504)
*Li Zheng,Sihang Wang,Hao Fei,Zuquan Peng,Fei Li,Jianming Fu,Chong Teng,Donghong Ji*

Main category: cs.CL

TL;DR: The paper proposes EmoBi, an emotion-guided framework for detecting hyperbole and metaphor in text, outperforming existing methods with significant F1 score improvements.


<details>
  <summary>Details</summary>
Motivation: Existing methods for hyperbole and metaphor detection rely on superficial features, missing deeper associations and implicit emotions. This gap motivates the need for a more nuanced approach.

Method: EmoBi integrates emotion analysis, domain mapping, and bidirectional dynamic interaction to detect hyperbole and metaphor, supported by a verification mechanism for accuracy.

Result: EmoBi achieves F1 score improvements of 28.1% (hyperbole) and 23.1% (metaphor) over state-of-the-art methods on benchmark datasets.

Conclusion: The framework demonstrates effectiveness and potential for advancing hyperbole and metaphor detection, validated by experimental results.
...
### [189] [Lessons from Training Grounded LLMs with Verifiable Rewards](https://arxiv.org/abs/2506.15522)
...
<details>
  <summary>Details</summary>
Motivation: The key challenge is improving the groundedness and trustworthiness of LLM responses, as current methods like retrieval-augmented generation (RAG) often fail in straightforward scenarios.

Method: The study employs GRPO (Group Relative Policy Optimization) for training models with verifiable outcome-based rewards, focusing on answer correctness, citation sufficiency, and refusal quality. A two-stage training setup is also introduced.

Result: Reasoning-augmented models outperform instruction-only variants, particularly in handling unanswerable queries and generating well-cited responses. Combining GRPO with GPT-4 distillation further improves performance.

Conclusion: The findings emphasize the importance of reasoning, stage-wise optimization, and outcome-driven RL for developing more reliable and verifiable LLMs.
...
### [190] [RATTENTION: Towards the Minimal Sliding Window Size in Local-Global Attention Models](https://arxiv.org/abs/2506.15545)
...
<details>
  <summary>Details</summary>
Motivation: Address the limitation of local attention ignoring tokens outside the window, aiming to enhance efficiency without performance loss.

Method: Introduces RATTENTION, combining local attention with a linear attention mechanism to handle out-of-window tokens.

Result: RATTENTION with a 512 window size matches full-attention performance and improves long-context handling, without sacrificing training speed.

Conclusion: RATTENTION shifts the Pareto frontier, offering superior efficiency and performance in both short and long-context scenarios.
...
### [191] [Approximating Language Model Training Data from Weights](https://arxiv.org/abs/2506.15553)
...
<details>
  <summary>Details</summary>
Motivation: Modern language models often have open weights but closed training data, creating a need to approximate data from model weights.
...
Result: The method improves classification performance from 65% to 80% and reduces perplexity from 3.3 to 2.3, nearing expert benchmarks.

Conclusion: The approach effectively approximates training data from model weights, enhancing performance without access to original data.
...
### [192] [PredGen: Accelerated Inference of Large Language Models through Input-Time Speculation for Real-Time Speech Interaction](https://arxiv.org/abs/2506.15556)
*Shufan Li,Aditya Grover*

Main category: cs.CL

TL;DR: PredGen reduces LLM latency in voice chat by predicting responses while the user speaks, cutting delay by ~2x with minimal added cost.
...
Result: Simulations show ~2x latency reduction with minimal extra computation.

Conclusion: PredGen effectively addresses LLM latency in voice chat, improving responsiveness without significant overhead.
...
### [193] [Gender Inclusivity Fairness Index (GIFI): A Multilevel Framework for Evaluating Gender Diversity in Large Language Models](https://arxiv.org/abs/2506.15568)
...
Method: Developed GIFI, a multi-level evaluation metric, and tested it on 22 diverse LLMs.

Result: Found significant variations in gender inclusivity across models, highlighting existing biases.
...
### [194] [SciVer: Evaluating Foundation Models for Multimodal Scientific Claim Verification](https://arxiv.org/abs/2506.15569)
...
<details>
  <summary>Details</summary>
Motivation: To assess and improve foundation models' comprehension and reasoning in multimodal scientific claim verification.
...
Result: Substantial performance gap between models and humans; limitations in open-source models identified.

Conclusion: SciVer provides insights to advance models' reasoning in multimodal scientific tasks.
...
### [195] [DiscoSG: Towards Discourse-Level Text Scene Graph Parsing through Iterative Graph Refinement](https://arxiv.org/abs/2506.15583)
*Shaoqing Lin,Chong Teng,Fei Li,Donghong Ji,Lizhen Qu,Zhuang Li*

Main category: cs.CL

TL;DR: The paper introduces DiscoSG, a task for discourse-level text scene graph parsing, addressing limitations of current single-sentence methods. It presents DiscoSG-DS, a dataset, and DiscoSG-Refiner, a method using two small PLMs for efficient and accurate parsing.


<details>
  <summary>Details</summary>
Motivation: Current scene graph parsers fail to handle multi-sentence descriptions, missing cross-sentence coreference and degrading performance in downstream tasks.

Method: Proposes DiscoSG-Refiner: a base graph is drafted by one small PLM, then refined by another PLM iteratively, reducing overhead.

Result: DiscoSG-Refiner improves SPICE by 30% over baselines, is 86x faster than GPT-4, and enhances downstream tasks like caption evaluation.

Conclusion: DiscoSG-Refiner offers an efficient, accurate solution for discourse-level parsing, outperforming large PLMs while being practical for open-source use.
...
### [196] [WikiMixQA: A Multimodal Benchmark for Question Answering over Tables and Charts](https://arxiv.org/abs/2506.15594)
*Negar Foroutan,Angelika Romanou,Matin Ansaripour,Julian Martin Eisenschlos,Karl Aberer,Rémi Lebret*

Main category: cs.CL

TL;DR: WikiMixQA is a new benchmark with 1,000 MCQs for evaluating cross-modal reasoning over tables and charts from Wikipedia, highlighting challenges in long-context, multi-modal document understanding.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks lack emphasis on complex reasoning across multiple modalities in long documents, necessitating a new evaluation framework.

Method: The paper introduces WikiMixQA, a dataset of 1,000 MCQs derived from 4,000 Wikipedia pages, and evaluates 12 vision-language models, including proprietary and open-source ones.

Result: Proprietary models like GPT-4-o achieve ~70% accuracy with direct context but drop below 50% in retrieval tasks; open-source models max at 27%.

Conclusion: WikiMixQA addresses gaps in evaluating multi-modal reasoning and underscores the need for improved models in long-context document understanding.
...
### [197] [From Model to Classroom: Evaluating Generated MCQs for Portuguese with Narrative and Difficulty Concerns](https://arxiv.org/abs/2506.15598)
*Bernardo Leite,Henrique Lopes Cardoso,Pedro Pinto,Abel Ferreira,Luís Abreu,Isabel Rangel,Sandra Monteiro*

Main category: cs.CL

TL;DR: The paper explores using generative AI to automate MCQ creation in Portuguese, focusing on reading comprehension. It evaluates quality through expert reviews and student responses, finding comparable quality to human-authored MCQs but noting issues like semantic clarity and distractor design.


<details>
  <summary>Details</summary>
Motivation: Manual MCQ creation is time-consuming and costly, especially for non-English languages like Portuguese. Generative AI offers automation potential, but quality assessment is understudied, particularly for real-world applications.

Method: The study uses generative models to produce Portuguese MCQs aligned with curriculum-relevant narratives and varying difficulty levels. Quality is assessed via expert reviews and psychometric analysis of student responses.

Result: Current models generate MCQs comparable to human-authored ones but face challenges in semantic clarity, answerability, and designing effective distractors.

Conclusion: Generative AI shows promise for MCQ automation in Portuguese, but improvements are needed in semantic clarity and distractor design for real-world educational use.
...
### [198] [The Compositional Architecture of Regret in Large Language Models](https://arxiv.org/abs/2506.15617)
...
<details>
  <summary>Details</summary>
Motivation: Understanding regret mechanisms in language models enhances reliability and reveals neural network cognition.
...
Result: Identified optimal regret representation layer and M-shaped decoupling pattern; categorized neurons into three functional groups.

Conclusion: The proposed metrics and workflow effectively analyze regret in language models, improving understanding of neural cognition.
...
### [199] [Minding the Politeness Gap in Cross-cultural Communication](https://arxiv.org/abs/2506.15623)
*Yuka Machino,Matthias Hofer,Max Siegel,Joshua B. Tenenbaum,Robert D. Hawkins*

Main category: cs.CL

TL;DR: The paper explores cross-cultural differences in interpreting intensifiers like 'quite' and 'very' between British and American English, attributing them to a mix of literal meaning differences and varying weights on utterance cost.
...
Result: Cross-cultural differences in intensifier interpretation arise from both literal meaning variations and differing emphasis on utterance cost, not just semantics or politeness norms.
...
### [200] [Revisiting Compositional Generalization Capability of Large Language Models Considering Instruction Following Ability](https://arxiv.org/abs/2506.15629)
*Yusuke Sakai,Hidetaka Kamigaito,Taro Watanabe*

Main category: cs.CL

TL;DR: The paper introduces Ordered CommonGen, a benchmark to evaluate LLMs' ability to follow concept order instructions and generalize compositionally, revealing biases and limitations in current models.


<details>
  <summary>Details</summary>
Motivation: To assess and improve LLMs' instruction-following and compositional generalization in generative commonsense reasoning tasks, particularly when concept order is specified.
...
Result: LLMs show biases toward certain concept orders, leading to low-diversity outputs. The best model achieved only ~75% ordered coverage.
...
### [201] [Oldies but Goldies: The Potential of Character N-grams for Romanian Texts](https://arxiv.org/abs/2506.15650)
...
### [202] [CC-LEARN: Cohort-based Consistency Learning](https://arxiv.org/abs/2506.15662)
...
### [203] [Leaky Thoughts: Large Reasoning Models Are Not Private Thinkers](https://arxiv.org/abs/2506.15674)
*Tommaso Green,Martin Gubri,Haritz Puerto,Sangdoo Yun,Seong Joon Oh*

Main category: cs.CL

TL;DR: Reasoning traces in large models leak sensitive data, worsened by test-time compute methods. Safety must address internal reasoning, not just outputs.
...
Conclusion: Safety measures must extend to internal reasoning to balance utility and privacy.
...
### [204] [Gender-Neutral Machine Translation Strategies in Practice](https://arxiv.org/abs/2506.15676)
*Hillary Dawkins,Isar Nejadgholi,Chi-kiu Lo*

Main category: cs.CL

TL;DR: The paper evaluates 21 MT systems' ability to maintain gender neutrality when translating ambiguous gender references, finding most systems fail but noting a few successful strategies.
...
Result: Most MT systems lacked gender-neutral translations for ambiguous gender references, though a few employed specific strategies depending on the target language.

Conclusion: The study highlights the need for improved gender-inclusive MT systems, with some promising strategies identified for further development.
...
### [205] [GenRecal: Generation after Recalibration from Large to Small Vision-Language Models](https://arxiv.org/abs/2506.15681)
*Byung-Kwan Lee,Ryo Hachiuma,Yong Man Ro,Yu-Chiang Frank Wang,Yueh-Hua Wu*

Main category: cs.CL

TL;DR: GenRecal is a distillation framework for vision-language models (VLMs) that addresses architectural diversity, enabling efficient knowledge transfer to smaller models.


<details>
  <summary>Details</summary>
Motivation: Deploying large VLMs on resource-constrained devices is challenging due to computational demands, prompting the need for efficient distillation methods.
...
Conclusion: GenRecal provides a scalable solution for efficient VLM deployment without compromising performance.
...
### [206] [PhantomHunter: Detecting Unseen Privately-Tuned LLM-Generated Text via Family-Aware Learning](https://arxiv.org/abs/2506.15683)
*Yuhui Shi,Yehan Yang,Qiang Sheng,Hao Mi,Beizhe Hu,Chaoxi Xu,Juan Cao*

Main category: cs.CL

TL;DR: PhantomHunter is a detector for LLM-generated text from privately-tuned models, outperforming existing methods with over 96% F1 scores.


<details>
  <summary>Details</summary>
Motivation: The rise of privately-tuned LLMs exacerbates misinformation and misconduct, challenging current detection methods.
...
Result: Outperforms 7 baselines and 3 industrial services with F1 scores over 96%.
