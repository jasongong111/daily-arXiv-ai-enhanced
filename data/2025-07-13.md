...
Result: Achieves 100% valid-path success in fault recovery and comparable performance to PID control in continuous process control.

Conclusion: LLMs, with structured feedback and modular agents, can unify symbolic planning and continuous control for resilient automation.
...
<details>
  <summary>Details</summary>
Motivation: Bias in AI for painting classification, especially from imbalanced datasets, compromises fairness and accuracy, particularly for rare styles. Prior work overlooked this issue.
...
Result: Evaluated on KaoKore and PACS datasets, BOOST reduces class-wise bias and balances performance with fairness. Introduces SODC for bias assessment.

Conclusion: BOOST effectively mitigates bias in AI art classification, offering a robust solution for fairness and accuracy.
...
Method: SIBP uses autonomous dialogue state inference and context-specific rules, decomposing trading into six states with item referencing and placeholder-based calculations.
...
<details>
  <summary>Details</summary>
Motivation: Illicit activities in supply chains are hard to detect due to sparse, corrupted data, and traditional ML methods require large datasets.

Method: Uses neurosymbolic methods and a question tree approach with LLMs to classify news articles on forced labor.

Result: Compares human and machine classification of articles, enabling systematic evaluation of relevance.

Conclusion: Proposes a scalable method for detecting illicit activities without large training datasets.
...
<details>
  <summary>Details</summary>
Motivation: To automate complex scientific research tasks without human involvement, leveraging specialized LLM agents for efficiency and accuracy.
...
Result: Successfully applied to a PhD-level cosmology task, outperforming state-of-the-art LLMs in benchmarks.

Conclusion: cmbagent demonstrates effective automation of scientific research, with potential for broader applications, and is publicly accessible.
...
Result: ViDove achieves 28% higher BLEU scores and 15% better SubER than state-of-the-art baselines.

Conclusion: ViDove advances multimodal translation and introduces DoveBench, a new benchmark for video subtitling.
...
<details>
  <summary>Details</summary>
Motivation: The misuse of LLMs for generating harmful content raises concerns, prompting a study of alignment challenges, particularly the effectiveness of input and output filters.

Method: The study examines the computational feasibility of prompt and output filtering, using adversarial prompts and cryptographic assumptions to demonstrate limitations.

Result: Efficient prompt filters are impossible for some LLMs, and output filtering is computationally intractable in certain settings. External filters are insufficient for safety.

Conclusion: Safety requires integrating alignment into LLM internals, as external filters fail; intelligence and judgment in AI systems cannot be separated.
...
<details>
  <summary>Details</summary>
Motivation: To enhance responsiveness and economic efficiency in supply chain transportation by addressing strategic shipping mode decisions.

Method: Uses a generative simulation module with autoregressive modeling and a dual-aware decision model, optimized iteratively with simulator feedback.

Result: Significant improvements in timely delivery rates and profit across three real-world datasets.

Conclusion: Sim-to-Dec effectively meets the requirements for a robust and generalizable simulation-decision framework in transportation strategy design.
...
<details>
  <summary>Details</summary>
Motivation: Overcoming limitations of conventional LLM approaches in scientific reasoning, particularly in drug discovery.

Method: Combines RAG, multi-agent collaboration, and Monte Carlo Tree Search with five specialized agents for structured reasoning.
...
<details>
  <summary>Details</summary>
Motivation: Existing benchmarks lack simultaneous evaluation of production and social skills in AI agents, necessitating a comprehensive tool like StarDojo.

Method: StarDojo features 1,000 tasks across farming, crafting, exploration, combat, and social interactions, with a subset of 100 tasks for efficient evaluation. It supports multimodal large language models (MLLMs) and parallel execution.

Result: State-of-the-art MLLMs, including GPT-4.1, perform poorly (12.7% success rate), struggling with visual understanding and multimodal reasoning.

Conclusion: StarDojo is a user-friendly benchmark to advance research on robust, open-ended AI agents in complex environments.
...
<details>
  <summary>Details</summary>
Motivation: To bridge the gap in understanding the algorithms LLMs learn, as current research prioritizes performance scaling over theoretical insights.

Method: Proposes AlgEval, a framework combining top-down hypothesis formation and bottom-up circuit-level analysis of attention and hidden states.

Result: Illustrated through a case study on emergent search algorithms, showing how LLMs solve tasks algorithmically.

Conclusion: AlgEval offers a principled approach to interpretability, enabling efficient training and novel architectures.
...
<details>
  <summary>Details</summary>
Motivation: The motivation is to improve the rigor of explanations in high-risk ML applications by addressing flaws in rule-based models, which are widely used despite their interpretability challenges.

Method: The paper develops algorithms to analyze negative overlap and redundancy in rule-based ML models, focusing on decision trees, diagrams, sets, and lists.

Result: The findings show that widely used tools for learning rule-based models often produce rule sets with negative facets like overlap and redundancy.

Conclusion: The paper concludes that current tools for rule-based ML models need improvement to avoid generating flawed rule sets, especially in high-risk domains.
...
<details>
  <summary>Details</summary>
Motivation: Vanilla aggregation in GNNs for KG link prediction lacks impact; the paper aims to improve efficacy by introducing graph pooling in KGs and enabling query-specific graphs for inductive settings.

Method: Proposes Context Pooling, using neighborhood precision and recall metrics to identify logically relevant neighbors for link prediction.

Result: Applied to two SOTA models on three datasets, achieving top performance in 42 out of 48 settings.
...
Method: Used prompt engineering to create a labeled dataset, compared prompt-engineered models, fine-tuned models, and a rule-based approach.

Result: The fine-tuned Llama 3 billion parameter model achieved the highest accuracy in extracting vaccine names. Model quantization allowed efficient deployment.
...
<details>
  <summary>Details</summary>
Motivation: To address uncertainty propagation in credal networks, specifically chains, by leveraging Dempster-Shafer theory for robust and computationally efficient belief inference.

Method: Proposes a framework using belief and plausibility functions to propagate uncertainty in chains, comparing it with classical sensitivity analysis.

Result: Efficiently yields conservative intervals, with numerical results showing advantages and limitations of belief inference in this context.

Conclusion: The framework provides practical utility for chains and insights for broader credal networks, balancing computational speed and uncertainty representation.
...
Method: A bilevel optimization framework integrating supervised fine-tuning with an enhanced DPO objective, including a regularization scheme for stable optimization and absolute probability improvement.

Result: The proposed method outperforms standard DPO, improving reasoning accuracy and better aligning output distributions with intended preferences.
...
<details>
  <summary>Details</summary>
Motivation: The study aims to quantitatively analyze the impact of size reduction on violins, a phenomenon observed by experts but not previously studied in detail.

Method: The method involves photogrammetry to acquire 3D meshes of 25 violins, extracting contour lines, fitting them with parabolic curves, and computing features for classification.

Result: Classification based on geometry is feasible to some extent, with the opening parameter (beta) being the most predictive.

Conclusion: The study demonstrates that geometric analysis can distinguish reduced from non-reduced violins, though challenges remain for instruments with intermediate transformations.
...
Conclusion: The FAI Benchmark provides a framework for developing AI systems that actively support human flourishing, impacting AI ethics and evaluation.
...
<details>
  <summary>Details</summary>
Motivation: To address the inefficiency and data demands of general MoE models in autonomous driving by emulating human drivers' skill-by-skill and step-by-step learning.

Method: Proposes a skill-oriented routing mechanism, hierarchical skill dataset, and pretrained router to integrate auxiliary tasks in a single forward process.

Result: Outperforms larger models (8B+ parameters) on CODA AD corner case reasoning with <3B sparsely activated parameters and reduces activated model size by 62.5%.

Conclusion: MoSE offers a computationally efficient and high-performing alternative for autonomous driving by aligning with human reasoning and learning processes.
...
Method: Proposes adaptive sensing to modulate sensor parameters, mitigating covariate shifts and improving efficiency.

Result: Empirical evidence shows small adaptive models outperform larger traditional models.

Conclusion: Adaptive sensing can transition AI toward sustainability, robustness, and equity, with proposed research directions for implementation.
...
<details>
  <summary>Details</summary>
Motivation: Classical XAI and causality literature fail to meet non-expert users' expectations for explanations, focusing on factors rather than actual causes. Formalizing and identifying actual causes is challenging and computationally intensive.

Method: The authors introduce algorithms with polynomial complexity to identify actual causes, adjustable for precision and exhaustiveness. These algorithms handle non-boolean, black-box, and stochastic systems.

Result: Experiments show the algorithms successfully identify causes in systems not addressed by existing methods and allow trade-offs between precision, exhaustiveness, and computation time.

Conclusion: The proposed algorithms offer a practical solution to the NP-complete problem of identifying actual causes, bridging the gap between expert and non-expert needs in XAI.
...
Method: A three-stage hierarchical prompt structure and three-layer knowledge graph architecture are introduced, with four complementary retrieval methods.

Result: The framework significantly improves legal dispute analysis, enabling accurate application of law to complex cases.
...
<details>
  <summary>Details</summary>
Motivation: Address the inequality in AI model performance caused by compute scaling and challenge the intuition that scaling always leads to dominance.

Method: Develop a model showing shrinking marginal returns to compute under fixed-distribution objectives, supported by empirical data and theoretical analysis.

Result: Meek models (limited compute) will approach the performance of top models, reducing advantages of exponential scaling.
...
Method: Analysis of 200k anonymized conversations with Microsoft Bing Copilot, classifying activities, measuring success, and calculating AI applicability scores for occupations.

Result: Highest AI applicability scores for knowledge work (e.g., computer, office support) and sales roles; successful tasks include information provision and writing.

Conclusion: Generative AI significantly impacts knowledge and communication-heavy occupations, with implications for wage, education, and real-world AI adoption.
...
Method: Uses non-trainable, deterministic embeddings for modular composition (merging models via logit averaging) and progressive layer-wise growth (stacking layers incrementally).

Result: Demonstrates improved performance on benchmarks (e.g., MMLU, SQuAD) without catastrophic forgetting, showing stable convergence and depth-correlated reasoning abilities.

Conclusion: Advocates a paradigm shift towards biological-like, incremental AI development, enabling resource-efficient scaling and democratized AI ecosystems.
...
Result: FashionBLIP-2 with FACap pretraining significantly improves performance on fashion CIR, especially for fine-grained texts.
...
<details>
  <summary>Details</summary>
Motivation: To address the challenges of proving complete information removal and assessing performance impact in machine unlearning for diffusion models.

Method: Introduces autoeval-dmun, leveraging vision-language models to extract structured knowledge, identify nearby damaged concepts, and test adversarial prompts.
...
Conclusion: Autoeval-dmun is an effective tool for evaluating MU in diffusion models, revealing insights into unlearning damage and adversarial robustness.
...
Method: SP4LP uses GNN for node representations, extracts shortest paths between nodes, and processes them with a sequence model.

Result: SP4LP achieves state-of-the-art performance in link prediction benchmarks.

Conclusion: SP4LP is more expressive than standard GNNs and structural feature methods, offering a principled approach for link prediction.
...
<details>
  <summary>Details</summary>
Motivation: To investigate sparse adapters as a simpler and more effective alternative to LoRA for building modular architectures that adapt quickly to tasks without fine-tuning.

Method: Proposes a simple method for training sparse adapters, which train only a subset of weights, and evaluates their merging properties across 20 NLP tasks.

Result: Sparse adapters outperform LoRA and full fine-tuning in in-distribution performance post-merging, though held-out performance remains a challenge.

Conclusion: Sparse adapters are a promising alternative to LoRA for modular architectures, offering simplicity and effectiveness in merging tasks, but further work is needed for robust held-out performance.
...
Method: Str-GCL uses first-order logic rules to represent structural commonsense, integrating them via topological and attribute-based rules and a representation alignment mechanism.
...
Conclusion: Str-GCL successfully incorporates structural commonsense into GCL, offering a new approach for graph representation learning.
...
<details>
  <summary>Details</summary>
Motivation: Accurate malware propagation modeling is crucial for cybersecurity, especially against adaptive threats, but existing methods often miss nonlinear feedback mechanisms.

Method: Evaluates three approaches: classical ODEs, Universal Differential Equations (UDEs), and Neural ODEs, using data from the Code Red worm outbreak. Introduces a symbolic recovery method to transform neural feedback into explicit mathematical expressions.
...
Conclusion: Hybrid physics-informed models (UDEs) offer superior predictive accuracy and deeper insights, aiding early warning systems and targeted cyber defenses.
...
Method: CCQ combines hardware-aware bit-shift encoding, Convolutional Code, Hybrid Encoding, and Code Cluster to optimize inference performance and minimize accuracy loss.

Result: CCQ successfully compresses large models (e.g., DeepSeek-V3 to 184GB, ERNIE-4.5 to 89GB) for single-GPU deployment, with open-sourced 2-bit models.

Conclusion: CCQ addresses the accuracy-speed trade-off in low-bit quantization, enabling efficient deployment of large LLMs with minimal performance degradation.
...
Result: G-Guard outperforms all baselines in datasets and metrics.
...
Method: DeMul eliminates description extraction, distilling LLM knowledge directly into continuous vector prompts, avoiding discrete templates.

Result: Superior performance on 11 recognition datasets, demonstrating the effectiveness of prompt weighting.

Conclusion: DeMul offers a more reliable and efficient approach to prompt learning in VLMs by leveraging LLM knowledge without descriptions.
...
<details>
  <summary>Details</summary>
Motivation: Diffusion models in forecasting have limitations like rigid distributions and limited sampling paths. Flow matching offers better flexibility and performance but lacks error utilization.

Method: CGFM extends flow matching by integrating auxiliary model outputs, historical data, and constructing conditional probability paths.

Result: CGFM outperforms state-of-the-art models in forecasting tasks.

Conclusion: CGFM effectively advances forecasting methods by leveraging untapped potential in flow matching.
...
<details>
  <summary>Details</summary>
Motivation: Pre-trained models offer rich latent embeddings, but RL lacks methods to effectively leverage multiple such models simultaneously. The paper addresses this gap by introducing WSA.

Method: The authors introduce Weight Sharing Attention (WSA), an architecture to combine embeddings from multiple pre-trained models, creating an enriched state representation for RL agents.

Result: WSA achieves performance comparable to end-to-end models on Atari games. The study also examines generalization and the impact of scaling the number of models.

Conclusion: WSA effectively combines pre-trained models for RL, offering a balance between efficiency and performance, with promising generalization and scalability properties.
...
Result: Scaling leads to compositional generalization; task constituents can be linearly decoded from activations.
...
<details>
  <summary>Details</summary>
Motivation: Label bias causes systematic errors in labels, impacting data integrity, especially in critical domains like hate speech detection. Existing solutions are limited.
...
Method: Proposes a low-rank approximation approach to learn the top-k singular functions without unstable linear algebraic operations, integrating seamlessly with deep learning pipelines.
...
<details>
  <summary>Details</summary>
Motivation: LLMs show inconsistent behavior, necessitating better uncertainty quantification, especially in high-stakes scenarios. Model diversity is often overlooked.
...
Conclusion: MUSE leverages model diversity for more reliable uncertainty estimates, outperforming baselines.
...
<details>
  <summary>Details</summary>
Motivation: To address the gap in ML benchmarks for complex fracture processes, leveraging phase field modeling (PFM) for realistic simulations.

Method: Created a dataset with 6,000 PFM simulations, including varied energy decompositions, boundary conditions, and crack configurations. Evaluated PINN, FNO, and UNet models, and explored ensembling.

Result: The dataset and baseline models provide a standardized benchmark, revealing the promise and limitations of current ML approaches in fracture mechanics.

Conclusion: The work establishes a foundation for advancing ML in fracture modeling, highlighting the need for more robust methods.
...
<details>
  <summary>Details</summary>
Motivation: To address the lack of rigorous evaluation of energy usage and hardware demands in efficient attention variants for large language models.

Method: Benchmarking eight attention mechanisms in GPT-2 training, measuring training time, GPU memory, FLOPS, CPU usage, and power consumption.

Result: Flash Attention, LSH Attention, and MLA are the most energy-efficient. Lower GPU power alone doesn't guarantee reduced energy use; training time is equally critical.

Conclusion: Energy-aware benchmarking is crucial for attention design, and the study provides insights for selecting resource-efficient mechanisms.
...
<details>
  <summary>Details</summary>
Motivation: The distributed nature of partitioned deep learning models exposes a broader attack surface, with intermediate feature interception posing a previously overlooked vulnerability.
...
Result: Experiments show surrogate models trained with intercepted features significantly improve adversarial attack transferability.
...
<details>
  <summary>Details</summary>
Motivation: To enhance dietary monitoring by improving detection performance and addressing robustness issues in multimodal learning when a modality is missing.

Method: Developed a multimodal temporal convolutional network with cross-modal attention (MM-TCN-CMA) to integrate IMU and radar data. A new dataset of 52 meal sessions was created.

Result: The framework improved F1-scores by 4.3% (Radar) and 5.2% (IMU) over unimodal models. It maintained performance gains (1.3%-2.4%) under missing modality conditions.
...
<details>
  <summary>Details</summary>
Motivation: The static ATE metric often fails to capture nuanced treatment effects varying with dose and time, especially in healthcare, necessitating a dynamic and interpretable approach.

Method: Adapts SemanticODE for causal inference, modeling treatment effects as smooth surfaces, decoupling trajectory shape estimation from clinically relevant properties.

Result: Produces accurate, interpretable, and editable models of treatment dynamics, supporting actionable clinical insights.

Conclusion: The method enhances causal analysis and practical decision-making by addressing the limitations of static ATE with dynamic, interpretable models.
...
Conclusion: TRIP provides a reliable way to assess the trustworthiness of permutation feature importance scores, addressing limitations with dependent features.
...
<details>
  <summary>Details</summary>
Motivation: NES algorithms are effective but suffer from limited sample efficiency due to reliance on random sampling and Monte Carlo estimates.

Method: Introduces Probabilistic Natural Evolutionary Strategy Algorithms (ProbNES), enhancing NES with Bayesian quadrature.

Result: ProbNES consistently outperforms non-probabilistic NES and global methods like BO in tasks such as benchmark functions, hyperparameter tuning, and locomotion.

Conclusion: ProbNES improves sample efficiency and performance, making it a superior choice for black-box optimization problems.
...
<details>
  <summary>Details</summary>
Motivation: High-dimensional datasets often lie on low-dimensional manifolds, but leveraging this requires solving intrinsic dimension estimation, local coordinate construction, and mapping tasks.

Method: Uses Mixture of VAEs and Riemannian geometry to estimate intrinsic dimension via VAE decoder pullback metric, constructs local charts with invertible VAEs, and enforces manifold constraints for reconstructions.

Result: Enhances solutions to ill-posed inverse problems, particularly in biomedical imaging, and shows intrinsic dimension as a proxy for model capacity during pruning.

Conclusion: The proposed framework effectively leverages manifold structure for improved inference and reconstruction, with intrinsic dimension guiding model capacity.
...
Method: Develops a general encode-approximate-reconstruct model using neural representations, ensuring discretization independence and multifidelity capabilities. Theoretical guarantees are provided.

Result: Multifidelity training improves accuracy and computational efficiency, enhancing empirical discretization independence. Validated on PDEs.

Conclusion: The model advances operator learning by integrating discretization independence and multifidelity training, supported by theory and experiments.
...
<details>
  <summary>Details</summary>
Motivation: FL struggles with balancing model performance, privacy, and efficiency in non-IID settings. Existing methods often compromise privacy, incur high costs, or ignore quantum advantages.

Method: AdeptHEQ-FL integrates hybrid CNN-PQC, adaptive accuracy-weighted aggregation, selective HE for security, and dynamic layer freezing to optimize communication.

Result: Achieves ≈25.43% and ≈14.17% accuracy gains over Standard-FedQNN and FHE-FedQNN on CIFAR-10, with reduced communication overhead.

Conclusion: AdeptHEQ-FL offers a practical, privacy-preserving, and efficient solution for FL, leveraging quantum-classical synergy.
...
Method: Formulates an optimization problem for RB allocation, user scheduling, and DP noise. Introduces DPVD-MARL, a dynamic penalty-based multi-agent reinforcement learning algorithm.

Result: DPVD-MARL improves convergence rate by 20% and accumulated rewards by 15% compared to independent Q-learning.

Conclusion: The proposed CFL design and DPVD-MARL algorithm effectively optimize performance and privacy in federated learning with heterogeneous resources.
...
Method: A soft actor-critic deep reinforcement learning framework with intrinsic curiosity module and cross-attention (ICM-CA) is used to optimize device subsets for deceptive signals and model training, transmit power, and sub-models.

Result: The method improves convergence by 3x and reduces information leakage by 13% compared to traditional SAC.

Conclusion: The ICM-CA framework effectively balances privacy protection and training efficiency in split learning.
...
Result: Improved format adherence, chemical validity, and synthesis feasibility, though limitations like stereochemistry errors remain.

Conclusion: The framework adapts generalist LLMs for chemistry but highlights areas for future improvement.
...
Result: Accuracy improves by up to 3% on four node-classification benchmarks, and representations become more interpretable.
...
TL;DR: The paper analyzes PU learning's statistical complexity without assuming a known class prior, proving sample size bounds.


<details>
  <summary>Details</summary>
Motivation: PU learning is common in real-world applications, but existing work relies on unrealistic assumptions like known class priors or specific data distributions.
...
Conclusion: The study advances PU learning by addressing practical challenges like unknown class priors, providing foundational bounds.
...
TL;DR: GO-CBED is a goal-oriented Bayesian framework for efficient causal experimental design, focusing on user-specified causal queries and outperforming traditional methods.


<details>
  <summary>Details</summary>
Motivation: Traditional methods aim to infer full causal models, which can be inefficient. GO-CBED targets specific causal quantities of interest for more focused experimentation.

Method: GO-CBED uses a variational lower bound estimator with a transformer-based policy network and normalizing flow-based variational posteriors for real-time decision-making.
...
TL;DR: The paper introduces ATHENA, a hierarchical graph neural network framework for personalized classification of subclinical atherosclerosis, integrating clinical and molecular data to improve classification performance and enable explainable patient subtype discovery.


<details>
  <summary>Details</summary>
Motivation: Current methods lack consistency in leveraging cohort-wide clinical features and integrating shared pathogenic interdependencies, limiting understanding of atherosclerotic trajectories.
...
<details>
  <summary>Details</summary>
Motivation: RLHF's vulnerability to reward hacking and poor performance in OOD scenarios despite existing mitigation efforts.
...
Result: Enhanced robustness and scoring performance, with a 7B model outperforming a 70B baseline.

Conclusion: The proposed framework effectively mitigates reward hacking and improves reward model performance, especially in challenging OOD settings.
...
Result: GRIT shows consistently lower prediction errors than baseline graph neural networks, demonstrating the effectiveness of its attention mechanism and spatiotemporal modeling.

Conclusion: GRIT's combination of transformers and graph neural networks effectively models complex spatiotemporal dynamics in ice layer thickness.
...
<details>
  <summary>Details</summary>
Motivation: Accurate monitoring of ice layer thickness is vital for climate modeling and ice dynamics, but current methods lack robustness in handling noise and long-range dependencies.

Method: ST-GRIT uses inductive geometric graph learning and separate spatial/temporal attention blocks to model ice layer relationships in radargrams.
...
TL;DR: TLC is a framework for learning collective variables (CVs) from time-lagged conditions of a generative model, improving rare event sampling in molecular dynamics simulations.


<details>
  <summary>Details</summary>
Motivation: Rare events in molecular dynamics are hard to observe due to long timescales. Existing machine learning CV methods often miss detailed dynamics.

Method: TLC learns CVs by modeling a time-lagged conditional distribution, capturing slow dynamics. It's tested on Alanine Dipeptide using steered molecular dynamics and OPES.

Result: TLC matches or outperforms existing MLCV methods in transition path sampling and state discrimination.

Conclusion: TLC effectively encodes dynamic behavior for enhanced sampling, offering a robust alternative to traditional CV methods.
...
TL;DR: GTED is a new evaluation framework for autoformalization, outperforming existing metrics in accuracy and reliability.


<details>
  <summary>Details</summary>
Motivation: Current evaluation methods for autoformalization lack semantic understanding, have high computational costs, and are limited by theorem proving progress.
...
TL;DR: The paper introduces HGMP, a multi-task prompt framework for heterogeneous graphs, addressing the mismatch between pre-trained models and downstream tasks. It unifies task formats, improves contrastive pre-training, and introduces feature prompts, outperforming baselines.


<details>
  <summary>Details</summary>
Motivation: Pre-training and fine-tuning methods in heterogeneous graph neural networks often suffer from mismatches with downstream tasks, leading to suboptimal performance. Prompt learning offers a flexible solution to adapt task representations.
...
Result: Experiments on public datasets show HGMP adapts well to various tasks and outperforms baseline methods.

Conclusion: HGMP effectively bridges the gap between pre-trained models and downstream tasks, enhancing performance in heterogeneous graph scenarios.
...
TL;DR: Deep neural networks pretrained on next-token prediction inherently represent beliefs over low-dimensional generative models of their data, akin to Bayesian updates, with geometric relationships in activations being architecture-independent.
...
Method: Pretraining deep neural networks (transformers, RNNs) on next-token prediction and analyzing their activations and geometric relationships.

Result: Neural networks intrinsically represent beliefs over 'quantum' and 'post-quantum' generative models, with geometry reflecting how past inputs affect future predictions.

Conclusion: Neural networks inherently perform Bayesian-like updates over latent states, revealing architecture-independent geometric relationships in their representations.
...
TL;DR: The paper reviews general-purpose models (GPMs) like large language models for their potential in chemical sciences, addressing challenges of small, diverse datasets.


<details>
  <summary>Details</summary>
Motivation: Chemical sciences face challenges with small, diverse datasets, making conventional machine learning less effective. GPMs offer flexibility and adaptability.

Method: The review discusses the principles of GPMs and examines their applications in chemical sciences.

Result: GPMs show promise in handling chemical data, though many applications are still in early stages.
...
TL;DR: DTME-MTL improves multi-task learning in transformers by dynamically adapting token space to mitigate negative transfer, without excessive parameter growth.
...
Conclusion: DTME-MTL offers a scalable and effective solution for improving transformer-based MTL models.
...
TL;DR: The paper compares uncertainty quantification in BCI classifiers, finding CSP-LDA and MDRM-T outperform Deep Learning methods in confidence estimation, while Deep Ensembles and CNNs yield better classifications.
...
Result: CSP-LDA and MDRM-T provide the best uncertainty estimates; Deep Ensembles and CNNs achieve superior classifications. All models distinguish easy/difficult samples, enabling accuracy improvement by rejecting ambiguous data.

Conclusion: Traditional BCI methods (CSP-LDA, MDRM-T) excel in uncertainty quantification, while Deep Learning methods (Deep Ensembles, CNNs) lead in classification performance, suggesting a trade-off between confidence estimation and accuracy.
...
Method: DAD dynamically learns and monitors data correlation structures sample by sample in a single pass, avoiding storage of historical data.

Result: DAD outperforms state-of-the-art methods in diverse anomaly types and is robust to high-dimensional data.

Conclusion: DAD sets a new standard for real-time, memory-constrained anomaly detection by balancing efficacy and efficiency.
...
TL;DR: A novel inversion-free regularized framework is proposed to address numerical instabilities in context-aware low-rank approximation for neural networks, improving stability and performance.


<details>
  <summary>Details</summary>
Motivation: Existing methods for context-aware low-rank approximation suffer from numerical instabilities due to reliance on classical formulas involving explicit Gram matrix computation and inversion, degrading approximation quality.

Method: The proposed method uses stable decompositions and avoids explicit inversion, handling scenarios like large calibration matrices, nearly singular input activations, and insufficient data.
...
Conclusion: The inversion-free regularized framework significantly improves the stability and quality of context-aware low-rank approximations in neural networks.
...
TL;DR: A novel meta-learning framework optimizes conditional handovers (CHOs) in cellular networks, outperforming 3GPP benchmarks by 180% in volatile signal conditions.
...
Conclusion: The framework effectively addresses CHO challenges, enhancing handover reliability and efficiency.
...
<details>
  <summary>Details</summary>
Motivation: Variations in occupational definitions across firms/countries necessitate a mapping mechanism for expanding O*NET data.

Method: Uses BERT-based techniques with clustering approaches and examines dimensionality reduction effects.

Result: Improved clustering performance with specialized silhouette approach, enabling automated occupation distinction.

Conclusion: The approach aids career transitions by automating occupation mapping.
...
TL;DR: The study introduces a multimodal dataset and advanced ML models to improve stress monitoring for healthcare workers, addressing gaps in existing research.


<details>
  <summary>Details</summary>
Motivation: Elevated occupational stress among healthcare workers, especially during COVID-19, and limitations in current stress-detection methods.
...
Result: Developed a reproducible pipeline for stress monitoring, enhancing model generalizability and practical deployment.

Conclusion: Advances stress-monitoring systems for healthcare workers, with future work focusing on demographic diversity and edge-computing.
...
TL;DR: The paper proposes using synthetic molecular communication (SMC) to modulate the gut-brain axis (GBA) for personalized healthcare, leveraging machine learning to improve treatment design.


<details>
  <summary>Details</summary>
Motivation: Existing GBA modulation treatments for neurological diseases like drug refractory epilepsy (DRE) are standardized but often ineffective for many patients due to unknown molecular pathways. Personalized approaches are needed.

Method: The paper defines theoretical requirements for GBA modulation and introduces a machine learning model to verify these requirements using limited data. The model is evaluated on datasets to identify effective modulatory pathways.
...
Conclusion: The approach shows promise for designing personalized GBA modulation treatments, improving efficacy by leveraging in-body IoBNT data and machine learning.
...
TL;DR: SParSeFuL introduces a resource-efficient federated learning method for IoT ecosystems, balancing sustainability with privacy.


<details>
  <summary>Details</summary>
Motivation: Traditional federated learning is unsustainable for IoT in Society 5.0 due to high resource demands.

Method: Combines aggregate computing for self-organization and neural network sparsification to reduce energy/bandwidth.

Result: Reduces energy and bandwidth consumption in federated learning.

Conclusion: SParSeFuL addresses sustainability in federated learning for IoT, aligning with green AI principles.
...
TL;DR: SLOGAN improves graph domain adaptation by disentangling causal features and using generative interventions, outperforming existing methods.
...
Method: SLOGAN uses sparse causal modeling, mutual information bottleneck constraints, and generative interventions to disentangle features and align domains.
...
TL;DR: TransformEEG, a hybrid Convolutional-Transformer model, improves EEG-based Parkinson's Disease detection with higher accuracy and lower variability compared to existing models.
...
Method: TransformEEG combines depthwise convolutional tokenizer with transformer encoder for effective feature mixing. Evaluated on 290 subjects using N-LNSO cross-validation.

Result: Achieved 78.45% median balanced accuracy (80.10% with augmentation), lowest variability (IQR 5.74-6.37%).

Conclusion: TransformEEG offers more consistent, reliable PD detection with reduced variability.
...
TL;DR: A decentralized architecture combining Federated Split Learning (FSL) and Hyperledger Fabric (HLF) is proposed to address scalability and privacy issues in collaborative machine learning, achieving comparable accuracy to centralized FSL with reduced training time.


<details>
  <summary>Details</summary>
Motivation: To overcome the limitations of conventional Federated Learning (centralized server risks) and Split Learning (poor scalability), the paper aims to provide a scalable, privacy-preserving solution for enterprise deployment.

Method: The method integrates FSL with HLF, using chaincode for decentralized orchestration of split model execution and peer-to-peer aggregation, leveraging HLF's transient fields and Private Data Collections for privacy.

Result: On CIFAR-10 and MNIST benchmarks, HLF-FSL matches centralized FSL accuracy while reducing per-epoch training time, with minimal blockchain overhead and preserved accuracy.

Conclusion: The proposed HLF-FSL architecture demonstrates enterprise-grade viability, offering a scalable and privacy-preserving solution for collaborative machine learning in sensitive domains.
...
TL;DR: The paper analyzes the effective dimension (rank) of hidden activation matrices in finite-width ReLU networks, showing geometric decay of rank deficit and identifying revival depths where rank peaks.


<details>
  <summary>Details</summary>
Motivation: To understand how random ReLU layers affect the subspace of input variations in deep networks, adding nuance to prior work on expressivity.

Method: Derived closed-form expressions for expected rank of hidden activation matrices under random Gaussian weights, including sub-Gaussian concentration bounds and identifying revival depths.

Result: The rank deficit decays geometrically with ratio ≈0.3634, and peaks occur at specific depths with height ≈0.79m. Oscillatory rank behavior is a finite-width phenomenon.

Conclusion: Random ReLU layers alternately collapse and revive input subspaces, with precise characterization of rank behavior in finite-width networks.
...
TL;DR: FedCBDR improves FCIL by addressing class imbalance in data replay through global coordination and task-aware temperature scaling, achieving better accuracy.
...
Result: FedCBDR improves Top-1 accuracy by 2%-15% over six state-of-the-art methods.

Conclusion: FedCBDR effectively balances class-wise sampling and enhances generalization in FCIL.
...
Method: Proposes GuardVal, a protocol that dynamically generates and refines jailbreak prompts, and an optimization method to prevent stagnation.

Result: Applied to models like Mistral-7b and GPT-4, revealing distinct behavioral patterns and robustness across safety domains.

Conclusion: GuardVal provides a comprehensive evaluation of LLM vulnerabilities, informing future research for more secure models.
...
TL;DR: A multi-task neural network method for estimating distributional treatment effects (DTE) outperforms traditional ATE-focused approaches by addressing data imbalance and computational inefficiencies.


<details>
  <summary>Details</summary>
Motivation: DTE offers granular insights into experiment outcomes, but current regression methods struggle with tail precision and computational demands, especially in large datasets.
...
Result: Demonstrated superior performance on simulated and real-world datasets, including water conservation and streaming platform experiments.

Conclusion: The method is a robust, practical solution for detailed causal inference, particularly in large-scale or heterogeneous settings.
...
<details>
  <summary>Details</summary>
Motivation: To meet privacy, legal, or ethical requirements, machine unlearning must ensure deep removal of data influence, not just superficial adjustments.
...
<details>
  <summary>Details</summary>
Motivation: Existing adversarial training methods treat all classes uniformly, leading to unfair robustness where strong classes become more robust while weak classes remain vulnerable. TRIX addresses this disparity.
...
TL;DR: The paper addresses the scalability and generalization challenges of RL in building energy management, proposing a contextual RL framework and benchmark for multi-objective control.
...
Result: Existing multi-objective RL methods achieve trade-offs but degrade under certain environmental variations, highlighting the need for dynamics-dependent context.
...
<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of unsynchronized task behavior in multi-task scenarios under domain shifts.

Method: Proposes S4T, which predicts task relations across domains to synchronize tasks during test-time training.

Result: Empirical results show S4T outperforms state-of-the-art TTT methods on various benchmarks.

Conclusion: S4T effectively handles multi-task scenarios under domain shifts, improving generalization.
...
TL;DR: A new space-filling regularization method is proposed to improve state space data distribution, enhancing training, interpretability, and robustness in nonlinear system identification.
...
Method: Introduces data-distribution-based penalty for space-filling regularization, applied to local affine state space models.

Result: Demonstrated effectiveness on a benchmark system, improving data distribution and model performance.

Conclusion: The proposed regularization technique addresses state space deformation issues, benefiting training and interpretability.
...
TL;DR: SAMVAE, a multimodal deep learning framework, integrates six data modalities for survival prediction in oncology, outperforming traditional single-modality methods.


<details>
  <summary>Details</summary>
Motivation: Traditional survival prediction methods often use single data modalities, limiting their ability to capture tumor complexity. SAMVAE addresses this by integrating diverse data sources.

Method: SAMVAE uses modality-specific encoders to project inputs into a shared latent space, combining clinical variables, molecular profiles, and histopathological images. It supports both standard and competing risks survival analysis.

Result: SAMVAE achieves competitive performance in breast cancer and lower grade glioma cohorts, demonstrating robust integration of multimodal data.
...
Result: The new Lipschitz bound is more accurate and reveals dependencies on attention score maps. JaSMin improves robustness and reduces Lipschitz constants.

Conclusion: The findings enhance transformer robustness and provide insights into attention map effects, with JaSMin offering a practical improvement tool.
...
Method: Introduces data-dependent Bernstein inequalities for vector-valued processes in Hilbert space, applicable to stationary and non-stationary processes, and leverages correlation decay.
...
Conclusion: The proposed inequalities improve estimation in non-i.i.d. settings, with practical implications demonstrated in numerical experiments.
...
TL;DR: A novel algorithm is proposed to extract interpretable policies (e.g., linear policies) from expert behavior in Deep Reinforcement Learning (DRL), addressing the interpretability challenge without sacrificing performance.


<details>
  <summary>Details</summary>
Motivation: The lack of interpretability in DRL policies hinders their deployment in mission-critical and real-world applications, where simpler, interpretable algorithms are often preferred despite lower performance.

Method: The algorithm leverages the advantage function to extract interpretable policies from expert behavior, enabling training with previously collected experience.

Result: Empirical evaluation on classic control environments and a financial trading scenario shows the algorithm's effectiveness in extracting meaningful information from complex expert policies.

Conclusion: The proposed method bridges the gap between interpretability and performance in DRL, making it suitable for real-world applications.
...
TL;DR: The paper explores how using a pre-trained AI model to impute missing covariates affects decision-making regret, introducing 'model elasticity' to quantify this impact. It shows calibration under MAR improves imputation quality and regret guarantees.


<details>
  <summary>Details</summary>
Motivation: To understand the influence of pre-trained AI models on decision-making regret when covariates are missing and how to mitigate this impact.
...
Result: Calibration improves imputation quality and regret guarantees, especially under MAR. Model elasticity is a key metric for integrating pre-trained models.

Conclusion: Accurate pre-trained models are valuable in sequential decision-making, and model elasticity is a fundamental metric for improving their integration.
...
TL;DR: The paper addresses the lack of theoretical convergence guarantees for natural-gradient descent in variational inference, focusing on Gaussian approximations with concave log-likelihoods. It introduces a square-root parameterization for covariance to establish convergence guarantees.


<details>
  <summary>Details</summary>
Motivation: Despite practical success, natural-gradient descent lacks theoretical convergence proofs, even for simple Gaussian cases. The paper aims to bridge this gap.

Method: A square-root parameterization for Gaussian covariance is proposed to analyze natural-gradient variational-Gaussian inference and its gradient flow.

Result: Novel convergence guarantees are established for natural-gradient methods, which outperform Euclidean or Wasserstein-based algorithms in experiments.

Conclusion: The square-root parameterization enables theoretical convergence proofs, validating the empirical success of natural-gradient methods in variational inference.
...
<details>
  <summary>Details</summary>
Motivation: SMEs are crucial but face credit risk challenges due to limited data, especially for online lenders.

Method: Uses Graph Neural Networks (GNNs) to analyze SME interactions from transaction and social data for spatial dependencies and default risk prediction.

Result: Achieves AUCs of 0.995 (supply chain mining) and 0.701 (default prediction), outperforming baselines. Also aids regulators in modeling supply chain impacts.

Conclusion: The GNN framework is scalable and effective for SME credit risk assessment, benefiting lenders and regulators.
...
<details>
  <summary>Details</summary>
Motivation: To provide a principled understanding of DPO's operation, given its diverse applications and current momentum, while addressing pitfalls and variations.
...
Result: DPO's framework accommodates notable extensions and highlights the risks of deviating from this generalized map.

Conclusion: Understanding DPO's general principles is crucial for its diverse applications and avoiding pitfalls, while enabling further extensions.
...
<details>
  <summary>Details</summary>
Motivation: The rise of antimicrobial resistance (AMR) necessitates faster discovery of effective antibiotics against emerging pathogens, which current methods cannot address.
...
Result: It outperforms state-of-the-art methods in activity prediction and reliably transfers to novel pathogens, even with limited data, while generating effective new molecules.

Conclusion: ApexOracle provides a scalable solution to AMR by combining rapid prediction and targeted molecule generation.
...
Conclusion: Study provides insights for future data augmentation strategies using co-folding models.
...
<details>
  <summary>Details</summary>
Motivation: Task conflicts in MTL limit performance; SAM shows promise in addressing this but faces challenges in combining global and local gradient information and computational overhead.
...
Result: SAMO effectively mitigates task conflicts and improves efficiency, as shown in multi-task benchmarks.

Conclusion: SAMO offers a practical and efficient solution for MTL optimization, balancing performance and computational cost.
...
TL;DR: UnIT introduces unstructured inference-time pruning for MCUs, replacing MAC operations with lightweight comparisons, achieving significant efficiency gains without retraining.


<details>
  <summary>Details</summary>
Motivation: Existing pruning methods underutilize fine-grained efficiency on devices without SIMD or parallel compute, prompting the need for a dynamic, unstructured approach.

Method: UnIT dynamically skips unnecessary MAC operations using input-specific activation patterns, lightweight comparisons, and hardware-friendly division approximations.

Result: UnIT reduces MAC operations by 11.02-82.03%, speeds up inference by 27.30-84.19%, and lowers energy use by 27.33-84.38% while maintaining accuracy.
...
Method: Constraint-based algorithm designed for nonlinear autoregressive time series, evaluated on synthetic datasets.

Result: Outperforms current techniques, especially in limited data scenarios, with reduced computational complexity.

Conclusion: The algorithm is efficient, scalable, and suitable for practical applications in causal inference.
...
Result: Demonstrates the method's ability to infer company insights and trends, evaluated by ontology coherence and topic evolution accuracy.

Conclusion: The approach effectively surfaces emerging financial trends, outperforming traditional techniques.
...
<details>
  <summary>Details</summary>
Motivation: Explanations are crucial in recommender systems for legality, user experience, and persuasiveness. CEs are a natural and useful form of explanation.
...
<details>
  <summary>Details</summary>
Motivation: To address concerns about privacy and copyright in generative models by developing a low-resource attack that reveals vulnerabilities without extensive access to training data.

Method: Leverages domain knowledge and templated prompts from scraped e-commerce data to identify benign prompts that reconstruct images.

Result: Demonstrates that seemingly harmless prompts (e.g., "blue Unisex T-Shirt") can reconstruct real-life human faces, revealing unintentional risks.

Conclusion: The study underscores the ease with which training data can be unintentionally reconstructed, calling for better safeguards in generative models.
...
TL;DR: H-Net introduces a dynamic chunking mechanism for end-to-end language models, outperforming token-based Transformers and improving robustness and efficiency.


<details>
  <summary>Details</summary>
Motivation: Tokenization remains a barrier to true end-to-end models. The goal is to replace the tokenization pipeline with a single, fully learnable model.

Method: Dynamic chunking mechanism integrated into a hierarchical network (H-Net), learning segmentation strategies jointly with the model.

Result: H-Net outperforms token-based Transformers, scales better with data, and shows robustness, especially in languages with weak tokenization heuristics.

Conclusion: H-Net demonstrates the potential of true end-to-end models, improving performance and efficiency across languages and modalities.
...
<details>
  <summary>Details</summary>
Motivation: Traditional PAC learning fails with dynamic data and changing objectives, prompting the need for a more adaptable framework like prospective learning.

Method: The authors enhance the prospective learning framework, providing algorithmic and numerical improvements, and apply it to sequential decision-making tasks.

Result: Preliminary results show improved performance in handling dynamic distributions and sequential scenarios.

Conclusion: Prospective learning, with these enhancements, offers a promising approach for dynamic and evolving learning tasks.
...
<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of exploration and sample efficiency in offline-to-online RL, especially for sparse-reward tasks.
...
TL;DR: EXPO improves online RL sample efficiency by using an expressive base policy and a lightweight Gaussian edit policy to maximize Q-value, avoiding direct optimization challenges.


<details>
  <summary>Details</summary>
Motivation: Training expressive policies with online RL is challenging due to unstable gradient propagation. The goal is to achieve stable value maximization.

Method: Proposes EXPO, which uses a base policy trained with imitation learning and an edit policy to adjust actions for higher value. Actions are optimized on-the-fly.
...
TL;DR: The paper introduces Chain-of-Layers (CoLa), a method to dynamically adapt pretrained LLM architectures per input sample, improving efficiency and performance.


<details>
  <summary>Details</summary>
Motivation: To explore whether pretrained models can adapt their architecture dynamically without finetuning, optimizing inference for different tasks.
...
Result: CoLa improves efficiency (shorter paths for 75% correct predictions) and performance (corrects 60% of originally wrong predictions).

Conclusion: Fixed architectures limit LLMs; dynamic depth adaptation (CoLa) unlocks better generalization and efficiency.
...
Result: MMoE achieves outstanding performance in experiments, surpassing current state-of-the-art methods.

Conclusion: MMoE effectively addresses key MEL challenges and demonstrates superior performance, with its code publicly available.
...
TL;DR: A novel Covariance-based Pixel-Text loss (CoPT) leverages domain-agnostic text embeddings to improve unsupervised domain adaptation (UDA) for semantic segmentation, achieving state-of-the-art results.


<details>
  <summary>Details</summary>
Motivation: UDA for semantic segmentation lacks utilization of domain-agnostic text properties, despite advancements in vision-language representation learning.
...
Conclusion: The method effectively bridges the gap between vision-language models and UDA for segmentation, demonstrating significant improvements.
...
TL;DR: This survey provides a comprehensive review of XAI methods in biomedical image analysis, addressing gaps in modality-aware perspectives, multimodal learning, and practical guidance.
...
Method: Systematically categorizes XAI methods, proposes a modality-centered taxonomy, and examines multimodal and vision-language models in biomedical AI.
...
<details>
  <summary>Details</summary>
Motivation: To address hallucinations in MLLMs caused by inherent conflicts in multimodal inputs, a problem overlooked by prior work.
...
Conclusion: Highlights modality conflict as a key cause of hallucinations and offers insights into improving MLLM robustness.
...
TL;DR: The paper presents a method for autonomous maritime surveillance and target vessel identification in GNSS-denied environments using UAVs, combining YOLOv8 for detection, feature matching, and hue histogram analysis for identification, validated in real-world experiments.


<details>
  <summary>Details</summary>
Motivation: Autonomous maritime surveillance is crucial for applications like search and rescue and threat detection, especially when GNSS is unavailable and visual cues are the only means to identify targets.

Method: The approach uses YOLOv8 for vessel detection, followed by feature matching and hue histogram distance analysis to identify the target vessel, and geometric principles for localization.

Result: The method was tested in real-world scenarios during MBZIRC2023, showing effectiveness in GNSS-denied navigation. The impact of perspective on accuracy and precision was also evaluated.

Conclusion: The proposed method successfully addresses the challenge of target vessel identification and localization in GNSS-denied environments, demonstrating practical applicability.
...
<details>
  <summary>Details</summary>
Motivation: Existing deep learning methods for polyp segmentation rely on additional labeled data or task similarity, limiting generalizability.

Method: Uses contrastive learning for better feature extraction, introduces MASPP for multi-scale fusion, and CA for boundary reconstruction.

Result: Outperforms state-of-the-art methods, improving IoU by 0.011 and 0.020 on Kvasir-SEG and CVC-ClinicDB datasets.
...
TL;DR: A model aligns EEG signals with multilevel semantic captions for image reconstruction, bypassing direct EEG-to-image generation, achieving state-of-the-art results.


<details>
  <summary>Details</summary>
Motivation: To overcome EEG's spatial limitations for image reconstruction by leveraging semantic captions for interpretable visual decoding.
...
TL;DR: The paper reviews 32 video generation methods, identifying key components for producing long-form, multi-character videos with narrative coherence and high fidelity.


<details>
  <summary>Details</summary>
Motivation: Existing methods struggle with generating long videos (beyond 16 seconds) that maintain character consistency, scene layouts, and motion coherence, especially for multi-subject narratives.

Method: The authors analyzed 32 papers to identify architectural components and training strategies, constructing a taxonomy and comparative tables for categorization.

Result: The study highlights successful approaches for long-form video generation, emphasizing narrative coherence and high fidelity.

Conclusion: The taxonomy and comparative analysis provide insights into improving long-form video generation, addressing current limitations.
...
TL;DR: CSCI is an RGB-only method for Clothes-Changing Re-Identification (CC-ReID) that uses color to mitigate appearance bias without extra models or annotations.


<details>
  <summary>Details</summary>
Motivation: Existing CC-ReID methods are resource-intensive due to reliance on additional models or annotations. CSCI explores color as a lightweight, annotation-free solution.

Method: Proposes CSCI with S2A self-attention to separate color-related bias ('Color See') from identity features ('Color Ignore'). Uses raw RGB data.

Result: Improves Top-1 accuracy by 2.9% on LTCC, 5.0% on PRCC (image), and 1.0% on CCVID, 2.5% on MeVID (video) without extra supervision.
...
TL;DR: An automated video segmentation pipeline for VFX reduces manual effort by using ML for object detection, segmentation, and tracking, improving production efficiency.


<details>
  <summary>Details</summary>
Motivation: Slow, resource-intensive mask generation in VFX production.

Method: Machine learning for text-prompted object detection, refined segmentation, and video tracking, deployed via containerization.

Result: Reduced manual effort, faster preliminary composites, and comprehensive segmentation data.

Conclusion: The pipeline enhances VFX production efficiency and was quickly adopted by artists.
...
<details>
  <summary>Details</summary>
Motivation: Traditional person identification struggles with entangled identity cues due to motion dynamics and appearance variations, requiring a robust solution.

Method: Introduces DisenQ, a unified querying transformer leveraging structured language guidance to disentangle features.

Result: Achieves state-of-the-art performance on three activity-based video benchmarks and generalizes well to traditional video-based identification.

Conclusion: The framework effectively decouples identity cues from motion and appearance, improving biometrics feature learning.
...
TL;DR: LinguaMark is a benchmark for evaluating multilingual capabilities of Large Multimodal Models (LMMs) in Visual Question Answering (VQA), revealing biases and performance gaps across languages and social attributes.
...
Method: LinguaMark evaluates LMMs on a multilingual VQA task using 6,875 image-text pairs in 11 languages and five social attributes, measuring Bias, Answer Relevancy, and Faithfulness.

Result: Closed-source models (GPT-4o, Gemini2.5) perform best overall, while open-source models (Gemma3, Qwen2.5) compete well. Qwen2.5 excels in multilingual generalization.

Conclusion: LinguaMark highlights multilingual performance gaps in LMMs and provides a benchmark for future research, promoting fairness and reproducibility.
...
TL;DR: MagiC is a benchmark evaluating grounded multimodal cognition in vision-language models, assessing reasoning quality, visual evidence alignment, and robustness.
...
Result: Analysis reveals limitations in current models' reasoning and grounding, with new metrics (MagiScore, StepSense) introduced for deeper insights.

Conclusion: MagiC highlights gaps in grounded visual reasoning and offers opportunities for improving model robustness and introspection.
...
TL;DR: ADIEE introduces an automated dataset creation approach to train a scoring model for instruction-guided image editing evaluation, outperforming existing models in benchmarks.


<details>
  <summary>Details</summary>
Motivation: The lack of effective automated evaluation methods for instruction-guided image editing, coupled with issues in open-source and proprietary VLMs, drives the need for ADIEE.

Method: ADIEE generates a large-scale dataset (100K+ samples) to fine-tune a modified LLaVA-NeXT-8B model, decoding numeric scores for evaluation.

Result: The scorer outperforms open-source VLMs and Gemini-Pro 1.5, improving score correlation and pair-wise comparison accuracy in benchmarks.

Conclusion: ADIEE's scorer enhances evaluation accuracy and can serve as a reward model, significantly boosting performance in tasks like best edit selection and model fine-tuning.
...
TL;DR: A novel method for virtual try-on (VTO) in beauty AR uses Kubelka-Munk theory for realistic foundation-skin blending, scalable across diverse products.
...
TL;DR: The paper introduces a contrastive reinforcement learning method to improve entity identity consistency in visual storytelling, showing significant performance gains.


<details>
  <summary>Details</summary>
Motivation: Current visual storytelling models struggle with maintaining consistent character and object identities across frames, leading to referential inconsistencies.

Method: A contrastive reinforcement learning approach is proposed, using synthetic negative examples and a dual-component reward function to train models for better entity connections.
...
Conclusion: The proposed method effectively enhances entity identity consistency and storytelling quality in vision-language models.
...
<details>
  <summary>Details</summary>
Motivation: Training depth completion models requires large-scale labeled datasets, which are costly to collect. PacGDC aims to minimize annotation effort while maximizing data diversity.

Method: PacGDC synthesizes pseudo geometries by manipulating scene scales using depth foundation models, interpolation, relocation, and unlabeled images.

Result: PacGDC achieves strong generalizability across diverse benchmarks, excelling in zero-shot and few-shot settings.

Conclusion: PacGDC offers a scalable and efficient solution for depth completion, reducing reliance on annotated data while improving performance.
...
TL;DR: PSM improves shape modeling by using self-adaptive particle configurations with novel loss and regularization methods.


<details>
  <summary>Details</summary>
Motivation: Existing PSM methods lack self-adaptivity to local geometric features, limiting accuracy in representing complex anatomical variability.

Method: Introduces a neighborhood correspondence loss and geodesic correspondence algorithm for adaptive particle configurations.

Result: Enhanced adaptivity and consistency in particle configurations, validated on challenging datasets.

Conclusion: The proposed methods improve PSM by balancing adaptivity and correspondence, outperforming existing techniques.
...
TL;DR: The paper introduces MSAGSM, a lightweight module enhancing GSM with multi-scale temporal dilations and spatial attention for precise event spotting in sports videos, and presents the TTA dataset for benchmarking.


<details>
  <summary>Details</summary>
Motivation: Existing PES models lack sufficient temporal receptive field and spatial adaptability, limiting their performance in fine-grained action recognition from sports videos.

Method: Proposes MSAGSM, integrating multi-scale temporal dilations and multi-head spatial attention into GSM, and introduces the TTA dataset for evaluation.

Result: MSAGSM improves performance across five PES benchmarks with minimal overhead, achieving state-of-the-art results.

Conclusion: MSAGSM effectively addresses limitations of existing modules and advances PES in sports videos, supported by the new TTA dataset.
...
<details>
  <summary>Details</summary>
Motivation: To improve spatiotemporal representation learning in person re-identification by leveraging human keypoints for both global and local feature extraction.
...
Conclusion: KeyRe-ID sets a new state-of-the-art in video-based person re-identification, with code to be publicly released.
...
TL;DR: A novel framework for cross-category animal motion transfer preserves habitual behaviors, leveraging a generative model with a habit-preservation module and LLM for unseen species.


<details>
  <summary>Details</summary>
Motivation: Existing methods focus on human motion, neglecting animal habitual behaviors, necessitating a specialized approach for animal motion transfer.
...
Conclusion: The framework successfully bridges the gap in animal motion transfer, preserving species-specific habits and enabling transfer to new species.
...
TL;DR: Seg-Wild is an interactive segmentation method for unconstrained photo collections, using 3D Gaussian Splatting and feature embeddings to handle transient occlusions and lighting inconsistencies.
...
Method: Proposes Seg-Wild, integrating multi-dimensional feature embeddings for 3D Gaussians and introducing Spiky 3D Gaussian Cutter (SGC) for smoothing. Projects 3D Gaussians to 2D and uses SAM mask for cutting.
...
Conclusion: EscherNet++ is scalable, efficient, and superior in performance, enabling fast 3D reconstruction with minimal training data.
...
TL;DR: EPIC introduces an efficient prompt-based strategy for multimodal interaction, reducing computational costs and trainable parameters while maintaining performance.


<details>
  <summary>Details</summary>
Motivation: The high computational cost of fine-tuning large-scale pre-trained multimodal models (LMMs) motivates the need for efficient interaction strategies.
...
Result: EPIC reduces computational resources and trainable parameters (1% of the foundation model) and performs well on UPMC-Food101 and SNLI-VE datasets.

Conclusion: EPIC offers a computationally efficient and effective solution for multimodal tasks, balancing performance and resource use.
...
TL;DR: Corvid is an MLLM with enhanced chain-of-thought reasoning, using a hybrid vision encoder and GateMixer for cross-modal alignment, trained on MCoT-Instruct-287K, and outperforms existing models.


<details>
  <summary>Details</summary>
Motivation: Address limitations of open-source MLLMs in complex reasoning tasks like decision-making and problem-solving.

Method: Hybrid vision encoder, GateMixer connector, two-stage CoT training, and inference-time scaling with self-verification.

Result: Corvid outperforms similar-scale MLLMs, excelling in math and science problem-solving.
...
<details>
  <summary>Details</summary>
Motivation: Existing benchmarks focus on low-resolution inputs, which are inadequate for detecting subtle anomalies in industrial point clouds.
...
### [141] [A Comprehensive Survey on Deep Learning Solutions for 3D Flood Mapping](https://arxiv.org/abs/2506.13201)
*Wenfeng Jia,Bin Liang,Yuxi Liu,Muhammad Arif Khan,Lihong Zheng*

Main category: cs.CV

TL;DR: A survey on deep learning-based 3D flood mapping, comparing DL techniques and data sources, highlighting advancements over 2D methods, and addressing challenges like data scarcity and model interpretability.


<details>
  <summary>Details</summary>
Motivation: Flooding, exacerbated by climate change and urbanization, requires advanced solutions like 3D flood mapping for better disaster management and urban planning.
...
Result: DL-based 3D flood mapping improves prediction accuracy and computational efficiency, with applications in real-time prediction and urban planning.

Conclusion: Challenges like data scarcity persist; future directions include better datasets, improved models, and policy integration for enhanced flood management.
...
TL;DR: DSANet improves ultrasound video segmentation by combining local and global features to reduce noise impact, outperforming state-of-the-art methods in accuracy and speed.


<details>
  <summary>Details</summary>
Motivation: Ultrasound imaging's noise challenges automated segmentation, requiring robust solutions.

Method: Proposes DSANet with AFSA and LGSA modules for semantic-aware feature fusion to mitigate noise.

Result: Outperforms benchmarks in accuracy and achieves higher inference FPS than video-based methods.

Conclusion: DSANet effectively enhances noise robustness in ultrasound segmentation, offering superior performance and efficiency.
...
TL;DR: A Deep Convolutional Neural Network (DCNN) is developed to detect blue-white veil (BWV) in skin lesions, achieving high accuracy across datasets and using explainable AI for interpretability.


<details>
  <summary>Details</summary>
Motivation: Melanoma is deadly, and BWV is a key diagnostic feature, but research on BWV detection is limited. This study aims to improve BWV detection for early melanoma diagnosis.

Method: A non-annotated dataset is converted into an annotated one using color threshold techniques. A custom DCNN is trained on three datasets, and XAI is applied for interpretability.

Result: The DCNN achieves high accuracy (85.71%-95.05%) across datasets and outperforms existing models in BWV detection.

Conclusion: The proposed DCNN with XAI significantly improves BWV detection, offering a robust tool for early melanoma diagnosis.
...
TL;DR: Objectomaly is a framework for Out-of-Distribution (OoD) segmentation that refines anomaly detection using object-level priors, improving boundary precision and reducing false positives.


<details>
  <summary>Details</summary>
Motivation: Existing mask-based OoD segmentation methods struggle with boundary imprecision, inconsistent anomaly scores, and background noise, necessitating a more robust solution.

Method: Objectomaly uses a three-stage process: Coarse Anomaly Scoring (CAS), Objectness-Aware Score Calibration (OASC) with SAM-generated masks, and Meticulous Boundary Precision (MBP) for contour refinement.

Result: The method achieves state-of-the-art performance on benchmarks like SMIYC and RoadAnomaly, with significant improvements in pixel-level and component-level metrics.

Conclusion: Objectomaly is robust and generalizable, validated by ablation studies and real-world driving videos, with code to be released upon publication.
...
TL;DR: A novel GAN-based blind face image restoration framework (SFFT-DAFE) is proposed to address weather-induced degradations, outperforming existing methods in preserving facial textures and structures.


<details>
  <summary>Details</summary>
Motivation: Adverse weather conditions degrade image quality, reducing face recognition accuracy. Current FIR models lack modules to explicitly handle weather-induced distortions.

Method: The framework integrates local Statistical Facial Feature Transformation (SFFT) for structure/color fidelity and Degradation-Agnostic Feature Embedding (DAFE) for robust feature extraction.

Result: The model outperforms GAN and diffusion-based FIR methods, especially in suppressing distortions and reconstructing facial structures.

Conclusion: The SFFT and DAFE modules effectively enhance structural fidelity and perceptual quality in face restoration under adverse weather.
...
TL;DR: The paper introduces a generative framework for Temporal Unlearnable Examples (TUEs) to protect video data privacy in Visual Object Tracking (VOT), addressing inefficiencies of existing image-based methods.


<details>
  <summary>Details</summary>
Motivation: To prevent unauthorized use of personal video data in VOT training, as current methods overlook privacy issues and existing solutions are inadequate for videos.
...
Conclusion: The framework effectively safeguards video data privacy in VOT, outperforming existing methods and generalizing well.
...
TL;DR: The paper introduces OMA, a benchmark for associating global SD maps with online HD maps to improve autonomous vehicle navigation, and proposes a baseline method called Map Association Transformer.
...
Method: The authors propose the OMA benchmark and a novel framework, Map Association Transformer, using path-aware and spatial attention mechanisms.

Result: OMA includes 480k roads and 260k lane paths, with metrics for model evaluation. The proposed framework enhances geometric and topological understanding.

Conclusion: The work advances autonomous vehicle navigation by addressing the gap in hybrid map association and providing a practical benchmark and baseline method.
...
TL;DR: DMPO improves diffusion model alignment by minimizing reverse KL divergence, outperforming existing methods by 64.6% in PickScore.


<details>
  <summary>Details</summary>
Motivation: Aligning diffusion models with human preferences is challenging due to suboptimal mean-seeking optimization in existing methods.

Method: Introduces Divergence Minimization Preference Optimization (DMPO), minimizing reverse KL divergence for alignment.

Result: DMPO outperforms existing techniques, achieving at least 64.6% better performance in PickScore.
...
TL;DR: GGMotion introduces a group graph dynamics-kinematics network to model human motion more realistically by leveraging physical dependencies between joints, outperforming existing methods on standard benchmarks.


<details>
  <summary>Details</summary>
Motivation: Existing methods represent human pose as abstract graphs, ignoring physical dependencies, leading to unrealistic motions and increased learning difficulty.

Method: GGMotion uses a group graph network with radial fields for spatio-temporal dependencies, inter/intra-group interaction modules, and equivariant MLPs for joint updates. An auxiliary loss supervises motion priors.
...
Conclusion: GGMotion effectively models human motion by incorporating physical dependencies, improving realism and performance.
...
<details>
  <summary>Details</summary>
Motivation: The absence of extensive labeled multi-view video datasets limits progress in 4D object segmentation for dynamic scenes.

Method: The authors present MUVOD, a dataset with 17 scenes, 7830 RGB images, and segmentation masks for 4D motion tracking.

Result: The dataset includes 459 instances of 73 categories and provides a benchmark for multi-view video segmentation methods.

Conclusion: MUVOD serves as a foundational benchmark and encourages further research in 4D object segmentation, with a subset for 3D segmentation analysis.
...
TL;DR: A spline-based trajectory representation is proposed to address challenges in dense point trajectory modeling, improving spatial coherence and temporal interpolation.


<details>
  <summary>Details</summary>
Motivation: Current methods for trajectory modeling either lack spatial coherence due to neural network biases or rely on heuristic-based techniques, leaving implicit representations for sparse signals underexplored.

Method: The approach uses a spline-based trajectory with explicit knot degrees of freedom and a low-rank time-variant spatial encoding for knot characteristics.
...
Conclusion: The spline-based representation offers a robust solution for trajectory modeling, balancing efficiency and coherence without relying on traditional constraints.
...
<details>
  <summary>Details</summary>
Motivation: Existing remote sensing foundation models focus on specific modalities, causing mismatches with application needs and making fine-tuning difficult due to their size.
...
Conclusion: MAPEX effectively addresses modality mismatch and fine-tuning challenges, offering a scalable solution for remote sensing tasks.
...
TL;DR: The paper investigates the 'linear reasoning bottleneck' in VLMs, introducing the Linear Separability Ceiling (LSC) to measure performance. It reveals the bottleneck stems from reasoning pathway failures, not perception, and shows task-dependent solutions.


<details>
  <summary>Details</summary>
Motivation: To understand and address the linear separability limitation in VLMs' abstract reasoning tasks, identifying its root cause and proposing solutions.

Method: Introduces LSC to evaluate linear classifier performance on VLM embeddings, uses postfix tuning to analyze dormant reasoning pathways, and tests task-dependent interventions.

Result: Finds the bottleneck is widespread but solvable: semantic tasks need pathway activation, while complex tasks require weight adaptation. Improved representation can fail on new prompts.

Conclusion: Robust VLM reasoning requires targeted alignment, not just better representation learning, offering a new analytical lens for VLM performance.
...
<details>
  <summary>Details</summary>
Motivation: Existing methods perform poorly in low-light due to degraded image quality and weak supervision constraints, leading to unreliable class activation maps and ambiguous pseudo-labels.

Method: DGKD-WLSS integrates Diffusion-Guided Knowledge Distillation (DGKD) for feature alignment and Depth-Guided Feature Fusion (DGF2) for structural enhancement.
...
Conclusion: The proposed framework effectively addresses low-light challenges and enhances feature learning, with released source codes for reproducibility.
...
<details>
  <summary>Details</summary>
Motivation: Address domain-shift challenges in industrial anomaly detection by leveraging shared subspace projection and multi-task learning.

Method: Combines hierarchical adapter modules, shared subspace projection, MTL Decoder, and Sinkhorn-K-means clustering for anomaly scoring.

Result: Achieves 97.5% AUC, 70.4% AP, and 95.2% PRO on MVTec AD, outperforming recent models.

Conclusion: NexViTAD marks a transformative advance in cross-domain defect detection with robust generalization.
...
<details>
  <summary>Details</summary>
Motivation: Existing flood mapping products lack spatial detail or ignore flood depth, limiting disaster response.

Method: HOTA uses overlapping tiles on Sentinel-2 images with SegFormer for 2D mapping and DEM differencing for depth estimation.

Result: HOTA improves IoU from 73% to 84% and achieves <0.5m boundary error in a case study.
...
TL;DR: Stable-Hair v2 is a diffusion-based multi-view hair transfer framework, the first to use multi-view diffusion models for high-fidelity, view-consistent hair transfer.
...
Result: The method achieves detailed, realistic, and view-consistent hair transfer, outperforming existing approaches.

Conclusion: Stable-Hair v2 sets a new benchmark in multi-view hair transfer, with publicly available code.
...
TL;DR: LOSC method improves zero-shot open-vocabulary segmentation in lidar scans by consolidating noisy image-based labels and training a 3D network.


<details>
  <summary>Details</summary>
Motivation: Address the noise and sparsity in point labels from image-based VLMs for lidar scans in driving scenarios.
...
Method: SpatialViz-Bench includes 12 tasks across 4 sub-abilities with 1,180 auto-generated problems, evaluated on 33 MLLMs.

Result: MLLMs show wide performance variations, unexpected behaviors (e.g., 2D-to-3D cliffs, misaligned difficulty perception), and deficiencies in spatial tasks.

Conclusion: SpatialViz-Bench highlights MLLMs' limitations in spatial visualization, addressing a gap in the field, and is publicly available.
...
TL;DR: ViLU is a Vision-Language Uncertainty framework that improves uncertainty quantification and failure prediction in VLMs by integrating visual and textual embeddings via cross-attention, outperforming traditional methods.
...
Method: ViLU integrates visual and predicted textual embeddings with image-conditioned textual representations via cross-attention, training an uncertainty predictor as a binary classifier using weighted binary cross-entropy loss.

Result: ViLU achieves significant gains over state-of-the-art methods on datasets like ImageNet-1k, CC12M, and LAION-400M.

Conclusion: ViLU's architecture and training are critical for effective uncertainty quantification, making it a robust post-hoc solution for VLMs.
...
TL;DR: T-GVC is a novel generative video coding framework that uses trajectory-guided motion sampling and diffusion processes to improve semantic accuracy and motion detail in ultra-low bitrate scenarios.


<details>
  <summary>Details</summary>
Motivation: Existing methods are limited by domain specificity or reliance on high-level text guidance, often failing to capture motion details and producing unrealistic reconstructions.
...
Conclusion: The framework introduces a new direction for generative video coding by leveraging geometric motion modeling, ensuring realistic reconstructions without sacrificing generative capabilities.
...
TL;DR: The paper studies age-related bias in deep learning-based Facial Expression Recognition (FER) systems, focusing on the elderly. It identifies disparities in recognition and attention patterns, proposes three mitigation strategies, and demonstrates improved accuracy for elderly individuals.


<details>
  <summary>Details</summary>
Motivation: Deep learning FER models often exhibit demographic biases, particularly with age, compromising fairness and reliability. This work aims to understand and mitigate these biases, especially for the elderly.

Method: The study investigates recognition performance across age groups, analyzes affected expressions, and uses Explainable AI (XAI) to identify disparities. Three bias mitigation strategies are proposed: Multi-task Learning, Multi-modal Input, and Age-weighted Loss. Models are trained on AffectNet with estimated age labels and validated on balanced datasets.

Result: Results show improved recognition accuracy for elderly individuals, especially for error-prone expressions like "neutral", "sadness", and "anger". Saliency heatmaps reveal more relevant facial region attention for each age group.
...
<details>
  <summary>Details</summary>
Motivation: Existing deep learning methods for MoA recognition focus on spatial cell characteristics, neglecting temporal dynamics and molecular interactions, which are crucial for accurate analysis.

Method: MolCLIP integrates microscopic cell videos and molecular data using a molecule-auxiliary CLIP framework and metric learning to optimize feature aggregation.
...
TL;DR: The paper introduces ARNet, a deep learning model for efficient keypoint annotation in cervical vertebral maturation analysis, aiding growth potential prediction in pediatric orthodontics.
...
Method: ARNet combines an Interaction-guided recalibration network and morphology-aware loss to streamline keypoint annotation on lateral cephalometric radiographs.
...
<details>
  <summary>Details</summary>
Motivation: To enhance dynamic facial expression recognition by incorporating quantified Action Units (AUs) knowledge into deep learning models, addressing data imbalance issues.

Method: Proposes AU-DFER, which quantifies AU contributions to expressions, designs a weight matrix for prior knowledge, and integrates AU loss with deep learning outcomes. Validated on mainstream DFER datasets.
...
Conclusion: Integrating AU knowledge and addressing data imbalance enhances DFER effectiveness, highlighting the importance of tackling imbalance in datasets.
...
<details>
  <summary>Details</summary>
Motivation: Existing LVLMs often ignore generated rationales in CoT reasoning, limiting grounding and accuracy.

Method: Re-formulate CoT as KL-constrained reward maximization and propose RED, a decoding strategy that combines image- and rationale-conditional token distributions.

Result: RED consistently outperforms standard CoT and other methods across benchmarks and LVLMs.

Conclusion: RED enhances faithfulness and accuracy in CoT reasoning, advancing reliable multi-modal systems.
...
TL;DR: Tree-Mamba improves underwater monocular depth estimation with adaptive tree-aware scanning and a reliable dataset, outperforming existing methods.
...
Method: Proposes Tree-Mamba with a tree-aware scanning strategy and constructs the BlueDepth dataset for reliable training.

Result: Tree-Mamba achieves superior performance in qualitative and quantitative evaluations with efficient computation.

Conclusion: Tree-Mamba and BlueDepth address UMDE challenges effectively, offering improved accuracy and reliable data.
...
TL;DR: A novel method for local motion blur deblurring using a trainable mask predictor and intra-frame motion analyzer, achieving superior performance and computational efficiency.
...
Result: Outperforms state-of-the-art methods, reducing FLOPs by 49% compared to models like LMD-ViT.

Conclusion: The method effectively addresses local motion blur with improved performance and efficiency, validated by extensive experiments.
...
Method: Introduces CrossVLAD, a dataset with GPT-4-assisted annotations, and CRAFT, a region-centric attack method for cross-task adversarial attacks.
...
<details>
  <summary>Details</summary>
Motivation: Addressing the challenges of long video reasoning in VLMs by integrating a large-scale dataset, advanced training methods, and optimized infrastructure.

Method: Uses a two-stage pipeline (CoT-SFT and RL) and MR-SP infrastructure for efficient long video RL training.

Result: Achieves strong performance on benchmarks, outperforms competitors, and shows 2.1x speedup in training.

Conclusion: LongVILA-R1 advances long video reasoning in VLMs and releases a versatile training system for public use.
...
<details>
  <summary>Details</summary>
Motivation: Existing models lack a holistic benchmark for evaluating visual grounded reasoning, especially for traceable evidence and complex reasoning tasks.
...
Conclusion: Traceable evidence is crucial for advancing vision-grounded reasoning, and TreeBench/TreeVGR provide effective tools for evaluation and improvement.
...
TL;DR: The paper revisits the 'Name that dataset' task for chest X-ray datasets to investigate bias, applying transformations to increase difficulty and testing various network architectures.


<details>
  <summary>Details</summary>
Motivation: To explore if dataset bias exists in popular open-source chest X-ray datasets, given the sensitivity of medical data and the importance of unbiased AI in medical imaging.

Method: Simple dataset transformations are applied, and multiple network architectures are tested on datasets like NIH, CheXpert, MIMIC-CXR, and PadChest.

Result: The study aims to identify whether modern AI methods rely on dataset shortcuts or focus on relevant pathology.

Conclusion: The work encourages explainable research and more open-source medical datasets, with code to be released upon acceptance.
...
<details>
  <summary>Details</summary>
Motivation: The Segment Anything Model (SAM) is effective for 2D images but struggles with 3D volumetric data like CT or MRI scans, requiring complex adaptations. This paper aims to simplify 3D segmentation for medical imaging.

Method: The proposed method is inspired by SegVol, focusing on reducing inference time and eliminating the complexities of sliding-window strategies used in existing 3D methods.

Result: The method achieves state-of-the-art performance while simplifying the process and reducing computational demands.

Conclusion: The presented 3D promptable segmentation method offers a more efficient and simpler alternative to existing approaches for medical imaging.
...
TL;DR: The paper addresses object hallucination in LVLMs, proposing an energy-based decoding method to balance yes-ratio bias and improve performance across VQA benchmarks.


<details>
  <summary>Details</summary>
Motivation: Existing methods for mitigating object hallucination in LVLMs are limited by decoding restrictions, complex visual input modifications, or reliance on external models. The paper identifies an imbalance in yes-ratios across VQA datasets.

Method: An energy-based decoding method dynamically selects hidden states from layers with minimal energy scores, reducing yes-ratio bias and enhancing performance.

Result: The method improves accuracy by 4.82% and reduces yes-ratio gap by 8.81% across three benchmarks (POPE, MME, MMVP) and three VLMs.

Conclusion: The proposed energy-based decoding is effective in mitigating bias and improving LVLM performance, offering a simple yet impactful solution.
...
<details>
  <summary>Details</summary>
Motivation: Early recognition of human activities is vital for safety and responsiveness in human-robot/machine interactions. Event-based sensors offer high temporal resolution but existing methods limit early prediction capabilities.

Method: A high-rate two-stream SNN processes events for early predictions, benchmarked in a novel framework with Top-1/Top-5 scores for growing observation times.

Result: The SNN outperforms prior work by 2% in final accuracy on the THU EACT-50 dataset.

Conclusion: The method demonstrates practical impact, exemplified by early action triggering in sports motion capture.
...
Method: Proposes SDST, an anchor-free side-tuning architecture with Reference-based Deformable Self-Attention, and integrates InternVideo2 backbone.

Result: Achieves competitive or SOTA results on QVHighlights, TACoS, and Charades-STA, reducing parameters by up to 73%.

Conclusion: SDST significantly enhances performance and efficiency in Video Temporal Grounding, with public code availability.
...
TL;DR: X-RAFT, a modified RAFT optical flow model, improves cross-modal image correspondence in hyperspectral imaging for fluorescence-guided neurosurgery, reducing errors by 36.6% over a baseline.


<details>
  <summary>Details</summary>
Motivation: Enhancing surgical decision-making by enabling real-time quantitative fluorescence measurements in neurosurgery.

Method: X-RAFT uses distinct encoders for blue and white light images, fine-tuned self-supervised with flow-cycle-consistency.

Result: Error reduction of 36.6% over baseline and 27.83% over CrossRAFT.

Conclusion: X-RAFT effectively addresses cross-modal correspondence challenges in hyperspectral imaging for neurosurgery.
...
TL;DR: A deep learning-based method improves geometric accuracy in additive manufacturing by comparing CAD and XCT volumes, achieving faster and more accurate results than traditional DVC methods.


<details>
  <summary>Details</summary>
Motivation: Quality control in additive manufacturing is crucial for industries like automotive and aerospace, but geometric inaccuracies from shrinkage and deformations pose challenges. Current methods lack accuracy and efficiency.

Method: Uses a deep learning approach with dynamic patch-based processing for high-resolution XCT volumes, introducing a Binary Difference Map (BDM) for evaluation.

Result: Shows 9.2% improvement in Dice Score and 9.9% in voxel match rate, reducing processing time from days to minutes.

Conclusion: Sets the foundation for deep learning-based DVC methods, enhancing reliability and efficiency in AM production.
...
TL;DR: SCOOTER is a framework for evaluating unrestricted adversarial attacks, providing guidelines, tools, and a benchmark dataset to assess imperceptibility and human-model perception gaps.


<details>
  <summary>Details</summary>
Motivation: Traditional defenses against adversarial attacks rely on norm-bounded constraints, but unrestricted attacks bypass these. Human evaluation is needed, but lacks statistical rigor.

Method: Introduces SCOOTER, a framework with guidelines for human studies, tools for annotation collection, and a benchmark dataset. Evaluates attacks via human and model comparisons.

Result: Human evaluations show color-space and diffusion-based attacks fail to produce imperceptible images. GPT-4o detects some but not all attacks.
...
<details>
  <summary>Details</summary>
Motivation: To understand and improve calibration robustness for image classification under real-world dataset shifts, providing practical guidelines for practitioners.

Method: Comparison of post-hoc and in-training calibration methods (e.g., label smoothing, entropy regularization) across eight classification tasks and natural shifts. Analysis includes ensembling effects and finetuning from foundation models.

Result: Best calibration under shift is achieved with entropy regularization and label smoothing. Post-hoc calibrators with OOD exposure are robust. Ensembling and finetuning foundation models yield superior calibration.

Conclusion: Combining ensembling with finetuning from foundation models is the most effective approach for robust calibration under dataset shift, despite trade-offs with in-distribution performance.
...
Method: The authors created S\textsc{urprise}3D, a dataset with 200k+ vision-language pairs and 89k+ human-annotated spatial queries, designed to avoid object-name shortcuts.

Result: Benchmarks show significant challenges for state-of-the-art 3D visual grounding methods and 3D-LLMs, highlighting the dataset's necessity.
...
Method: ViaPT generates instance-aware prompts per input, fuses them with dataset-level prompts using PCA, and reduces learnable parameters.

Result: ViaPT consistently outperforms state-of-the-art baselines across 34 datasets.

Conclusion: ViaPT establishes a new paradigm for optimizing visual prompts in vision transformers.
...
TL;DR: The paper proposes a Synergistic Prompting (SyP) framework to improve robustness in visual recognition with missing modalities, addressing limitations of static prompts and basic prompt-tuning.
...
Result: SyP outperforms existing methods on three visual recognition datasets, showing robustness under varying missing-modality conditions.

Conclusion: The SyP framework effectively addresses missing-modality challenges, offering superior adaptability and reliability in visual recognition tasks.
...
<details>
  <summary>Details</summary>
Motivation: Accurate lung tumor motion forecasting is crucial for proton therapy, but transformer-based architectures are unexplored in this domain despite their success in trajectory forecasting.

Method: Two models were trained: patient-specific (PS) and multi-patient (MP) using DRRs from 4DCT scans. Performance was evaluated using ADE and FDE on planning and treatment data.

Result: PS models outperformed MP models on planning data, but MP models showed better robustness to anatomical variability and comparable performance on treatment data without retraining.

Conclusion: ViT architectures are effective for markerless tumor motion forecasting, with PS models offering higher precision and MP models providing robust, ready-to-use performance for clinical settings.
...
TL;DR: The paper evaluates the robustness of state-of-the-art content-based puzzle solvers under realistic corruptions like missing pieces and eroded edges, finding deep learning models, especially Positional Diffusion, adapt well with fine-tuning.


<details>
  <summary>Details</summary>
Motivation: Existing puzzle solvers lack evaluation under realistic challenges (e.g., fragmented artefacts), prompting an investigation into their robustness under corruptions.

Method: Introduces three corruptions (missing pieces, eroded edges, eroded contents) and evaluates heuristic and deep learning-based solvers, including fine-tuning with augmented data.

Result: Standard solvers decline rapidly with corruption, but deep learning models, notably Positional Diffusion, improve robustness through fine-tuning.
...
TL;DR: SimCIS is a novel method for class-incremental image segmentation (CIS) that addresses plasticity loss and data order reliance by leveraging highly aggregated image features for query alignment and introducing cross-stage consistency and visual query replay.


<details>
  <summary>Details</summary>
Motivation: Current decoupled frameworks for CIS suffer from plasticity loss and heavy reliance on input data order, prompting the need for a more robust solution.

Method: SimCIS directly selects image features for query assignment to ensure perfect alignment, promotes plasticity by allowing queries to select new classes, and uses cross-stage consistency and visual query replay to combat forgetting.
...
Conclusion: SimCIS provides a simple yet powerful baseline for CIS, effectively addressing key challenges and achieving superior performance.
...
TL;DR: The paper introduces 3D-ADAM, a large-scale, industry-relevant dataset for 3D anomaly detection, addressing the lack of high-quality datasets in manufacturing.


<details>
  <summary>Details</summary>
Motivation: Surface defects significantly impact manufacturing yield, but current defect detection methods struggle in real-world settings due to inadequate datasets.
...
Result: Evaluation shows 3D-ADAM poses a significant challenge to state-of-the-art models, highlighting its industrial relevance.

Conclusion: 3D-ADAM aims to advance robust 3D anomaly detection models for modern manufacturing.
...
Method: THUNDER is introduced as a dynamic benchmark supporting diverse models and tasks, with a focus on feature spaces, uncertainty, and robustness.

Result: A comprehensive comparison of 23 foundation models on 16 datasets is provided, showcasing THUNDER's capability for efficient evaluation.

Conclusion: THUNDER offers a fast, easy-to-use solution for benchmarking digital pathology models, with public code availability for broader adoption.
...
Result: SLURPP is 200X faster than current diffusion-based methods and improves PSNR by ~3 dB on synthetic benchmarks, with superior real-world performance.

Conclusion: SLURPP advances underwater image restoration by balancing efficiency and quality, making it suitable for diverse applications.
...
Method: Introduces MIRA with two components: (1) a calibrated Rethinking and Rearrangement module for dynamic context adjustment, and (2) a medical RAG framework integrating image embeddings and a knowledge base with query-rewrite.
...
TL;DR: Proposed an embedded, unsupervised architecture for feature point detection and description using a quantized SuperPoint CNN, optimized for FPGA SoC platforms to achieve high performance with minimal computational demands.


<details>
  <summary>Details</summary>
Motivation: Accurate position estimation is crucial for autonomous platforms, requiring efficient feature extraction in VSLAM systems, especially for resource-limited devices.

Method: Implemented a quantized SuperPoint CNN on an FPGA SoC (AMD/Xilinx Zynq UltraScale+), leveraging Brevitas and FINN for quantization and optimization, achieving 54 fps on 640x480 images.

Result: Outperformed state-of-the-art solutions in processing speed (54 fps) while maintaining detection quality, validated on the TUM dataset.

Conclusion: The proposed method enables efficient deployment of high-performance VSLAM systems on resource-constrained platforms, balancing accuracy and computational efficiency.
...
TL;DR: A novel Test-Time Adaptation (TTA) strategy, CiCi, is proposed for rPPG tasks, leveraging spatio-temporal consistency and inconsistency in signals to enhance real-time model adaptation without source data.
...
Result: The method outperforms existing techniques on five datasets under TTA, achieving state-of-the-art performance in real-time self-supervised adaptation.

Conclusion: CiCi offers a robust, privacy-preserving solution for real-world rPPG deployment, advancing real-time adaptation capabilities.
...
<details>
  <summary>Details</summary>
Motivation: Automated monitoring of laboratory mice enhances data accuracy and welfare, but individual identification is challenging due to housing density and similar appearances.

Method: Developed a pipeline with a custom tracker (MouseTracks), transformer-based ID classifier (Mouseformer), and tracklet associator (MouseMap) for real-time ID assignment.
...
Conclusion: The proposed solution effectively addresses challenges in mouse monitoring, offering improved accuracy and reliability for research applications.
...
TL;DR: TinierHAR is an ultra-lightweight deep learning model for Human Activity Recognition (HAR) on wearable devices, achieving state-of-the-art efficiency with minimal performance loss.
...
Method: TinierHAR combines residual depthwise separable convolutions, GRUs, and temporal aggregation to optimize efficiency and performance.

Result: TinierHAR reduces parameters by 2.7x (vs. TinyHAR) and 43.3x (vs. DeepConvLSTM), and MACs by 6.4x and 58.6x, while maintaining F1-scores.
...
TL;DR: A method for synthesizing realistic Martian landscape videos using a data curation pipeline (M3arsSynth) and a video generator (MarsGen), addressing data scarcity and domain gaps.


<details>
  <summary>Details</summary>
Motivation: To enable mission rehearsal and robotic simulation by overcoming the challenges of limited Martian data and the domain gap with terrestrial imagery.

Method: 1) M3arsSynth reconstructs 3D Martian environments from stereo images and renders high-fidelity video sequences. 2) MarsGen synthesizes realistic videos conditioned on initial frames, camera trajectories, or text prompts.

Result: The approach outperforms terrestrial dataset-trained models in visual fidelity and 3D consistency.

Conclusion: The proposed solution effectively synthesizes realistic Martian videos, aiding mission preparation and simulation.
...
<details>
  <summary>Details</summary>
Motivation: Video diffusion models often lack geometric-aware structure, limiting their ability to represent the 3D nature of videos.
...
<details>
  <summary>Details</summary>
Motivation: Existing benchmarks lack evaluation of real-world embodied perception, focusing on offline settings. OST-Bench addresses this gap by assessing online, incremental reasoning.

Method: OST-Bench uses 1.4k scenes and 10k QA pairs from ScanNet, Matterport3D, and ARKitScenes. It evaluates MLLMs on tasks requiring spatio-temporal reasoning and memory integration.

Result: Leading MLLMs perform poorly on OST-Bench, especially with extended exploration and memory demands. Error patterns reveal challenges in spatial reasoning and long-term memory retrieval.

Conclusion: OST-Bench exposes critical limitations in MLLMs for online embodied reasoning, providing a foundation for future research. The dataset and benchmark are publicly available.
...
<details>
  <summary>Details</summary>
Motivation: CLIP models struggle with binding (e.g., distinguishing object-attribute pairs), and previous fixes like hard negatives or architecture changes were insufficient. The study explores data's role in this problem.

Method: The authors use a synthetic dataset to rigorously analyze how data properties (e.g., attribute density, caption completeness, saliency bias) impact CLIP's binding performance.

Result: Common natural data properties hinder binding. Neither scaling batch size nor hard negatives help; only data with specific properties enables reliable binding.

Conclusion: Data properties are crucial for CLIP's binding ability. Addressing these in training data can significantly improve performance.
...
<details>
  <summary>Details</summary>
Motivation: Video LLMs face quadratic computational scaling with token count, which STTM addresses by exploiting overlooked local redundancy.

Method: STTM transforms frames into multi-granular spatial tokens via quadtree search, then merges them temporally.

Result: STTM achieves 2×-3× speed-ups with minimal accuracy drops (0.5%-2%) under token budgets of 50%-30%.

Conclusion: STTM is efficient, query-agnostic, and outperforms existing token reduction methods in video QA benchmarks.
...
TL;DR: The paper introduces BASIC, a unified evaluation framework for brain visual decoding, addressing limitations of coarse metrics by incorporating structural fidelity, inferential alignment, and contextual coherence.
...
Conclusion: BASIC offers a unified, multigranular approach to improve the evaluation of brain visual decoding, enhancing interpretability and discriminative power.
...
TL;DR: The paper proposes a framework for few-shot keypoint detection using sketches, overcoming cross-modal and style challenges with a prototypical setup and domain adaptation.


<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of few-shot keypoint detection when source data is unavailable by leveraging sketches as a source-free alternative.
...
Result: Demonstrates success in few-shot convergence across novel keypoints and classes through experiments.
...
Method: KARL uses a single-pass approach to predict token halting based on reconstruction quality, trained similarly to Upside-Down RL.
...
Result: \NickName outperforms existing methods, achieving rFID 0.49 vs. 0.91 on ImageNet and superior PSNR on zero-shot benchmarks.

Conclusion: \NickName advances VQ-VAE reconstruction quality, supporting high-fidelity HD image processing. Code is publicly available.
...
<details>
  <summary>Details</summary>
Motivation: To understand the impact of concept combinations in training data on CLIP/LMM performance, especially for uncommon pairings.

Method: Uses PMI to measure co-occurrence, tests on synthetic and edited natural images, and evaluates CLIP/LMM performance.

Result: Strong correlation between PMI and accuracy (r=0.97 for CLIP, r=0.70-0.62 for LMMs), showing performance depends on concept combinations.

Conclusion: Highlights the need for better algorithms to improve compositional generalization without exponentially scaling training data.
...
TL;DR: The paper investigates cognitive biases in LLMs, attributing them primarily to pretraining rather than finetuning or random training noise, using a novel two-step causal experimental approach.


<details>
  <summary>Details</summary>
Motivation: To understand the origins of cognitive biases in LLMs and determine whether they stem from pretraining, finetuning, or random training noise.

Method: A two-step approach: (1) finetuning models with different random seeds to assess training randomness effects, and (2) cross-tuning by swapping instruction datasets to isolate bias sources.

Result: Biases are mainly shaped by pretraining; models with the same pretrained backbone show more similar bias patterns than those sharing only finetuning data.
...
<details>
  <summary>Details</summary>
Motivation: To understand the reliability and susceptibility of LLMs to response biases in normative survey contexts, given their increasing use as human proxies.

Method: Tested nine diverse LLMs on WVS questions, applying 11 perturbations to question phrasing and answer options, resulting in over 167,000 simulated interviews.

Result: LLMs exhibit vulnerabilities to perturbations, including a consistent recency bias, with larger models being more robust but still sensitive to semantic variations.

Conclusion: Prompt design and robustness testing are critical when using LLMs for synthetic survey data due to their alignment with human response biases.
...
Method: The toolkit allows users to evaluate synthetic data along multiple dimensions, including downstream utility, fairness, privacy leakage, distributional differences, and expert feedback.

Result: SynthTextEval is demonstrated to be effective in high-stakes domains like healthcare and law, standardizing evaluation metrics.

Conclusion: The toolkit aims to enhance the viability of synthetic text and improve privacy-preservation in AI systems.
...
TL;DR: The paper introduces a safety evaluation protocol for medical LLMs, addressing gaps in domain-specific safety assessments by focusing on patient and clinician perspectives.
...
Method: Developed a tailored safety protocol, including PatientSafetyBench with 466 samples across 5 categories, and applied red-teaming on MediPhi models.

Result: Bridged the literature gap by defining safety criteria for medical LLMs from patient, clinician, and general user perspectives.

Conclusion: Established foundational safety evaluation for safer deployment of medical LLMs, addressing critical domain-specific concerns.
...
TL;DR: The paper explores interruption detection in collaborative learning, proposing a robust method for identifying interruptions in multi-group settings with overlapping speech.


<details>
  <summary>Details</summary>
Motivation: Interruptions are key in collaborative learning, but existing AI-driven detection methods focus on single-conversation environments with clean audio, not addressing the challenges of multi-group classrooms.

Method: The study analyzes interruption detection in single and multi-group dialogues, then develops a state-of-the-art method resilient to overlapping speech for classroom deployment.

Result: The proposed method effectively identifies interruptions in noisy, multi-group settings and provides insights into linguistic and prosodic patterns of interruptions.

Conclusion: This work advances interruption detection for collaborative learning and sets a foundation for future research on multi-group dialogue tracking.
...
Method: Proposes a multi-agent framework integrating static and dynamic evidence, using multiple LLMs for retrieval, enhancement, and refinement.
...
TL;DR: A novel model combining GNNs and CNNs with real-time graph generation addresses inefficiencies of Transformers in processing long texts, achieving competitive performance in text classification tasks.
...
Method: Integrates GNNs and CNNs with real-time graph generation, uses LLM information via dictionary lookups, and employs small-world graphs for document-level aggregation.

Result: Model shows structural properties of semantic organization (clustering coefficient ~0.45, shortest path length 4-5) and performs competitively in text classification tasks.
...
<details>
  <summary>Details</summary>
Motivation: To improve human-AI communication in healthcare by ensuring personalized and understandable content.

Method: Introduces MedReadCtrl, a readability-controlled instruction tuning framework for LLMs.

Result: Achieves lower readability errors than GPT-4 and higher performance on clinical tasks, with expert preference (71.7%).

Conclusion: MedReadCtrl offers a scalable solution for accessible healthcare communication, enhancing patient education and equitable AI care access.
...
Method: Combines LLMs, human-in-the-loop annotation, and APO to extract and categorize eviction data from clinical notes.
...
TL;DR: The paper explores distilling time series reasoning into small language models using synthetic data and multimodal annotations, achieving interpretable results for on-device use.


<details>
  <summary>Details</summary>
Motivation: To build interpretable time series foundation models by compressing reasoning capabilities into lightweight, language-capable models.

Method: Uses synthetic mean-reverting time series data with varied trends/noise, annotated by a large multimodal model, to fine-tune compact Qwen models. Introduces evaluation metrics for reasoning quality.

Result: Post-trained models gain meaningful interpretive capabilities in trend direction, noise intensity, and extremum localization.

Conclusion: Demonstrates feasibility of lightweight, interpretable models for explaining temporal patterns in natural language, suitable for privacy-sensitive deployment.
...
Method: Proposes SAND framework with self-consistency action sampling and execution-guided critique for step-wise deliberation.
...
TL;DR: RLEP (Reinforcement Learning with Experience rePlay) improves RL for large language models by replaying verified trajectories, enhancing stability and performance.
...
Method: RLEP uses a two-phase framework: collecting verified trajectories and replaying them during training, blending new rollouts with replayed successes.

Result: RLEP achieves faster convergence and higher accuracy, improving performance on benchmarks like AIME and AMC.

Conclusion: RLEP is effective for RL in large language models, offering reproducibility and open resources for further research.
...
TL;DR: The paper introduces 'machine bullshit' as a framework to analyze LLMs' indifference to truth, proposing a Bullshit Index and taxonomy. Empirical results show RLHF and CoT prompting worsen bullshit, especially in political contexts.
...
Result: RLHF fine-tuning and CoT prompting increase bullshit, with weasel words dominant in political contexts.
...
<details>
  <summary>Details</summary>
Motivation: Smaller LLMs lack the planning capabilities of larger models, limiting their performance in complex reasoning tasks. PLAN-TUNING addresses this gap.

Method: Distills planning trajectories from large LLMs and fine-tunes smaller models using supervised and reinforcement-learning objectives.
...
Conclusion: PLAN-TUNING effectively enhances smaller LLMs' reasoning capabilities by mimicking planning processes.
...
TL;DR: TeaR improves LLM reasoning by guiding models to discover optimal reasoning paths via curated data and reinforcement learning, achieving significant performance gains.
...
Conclusion: TeaR effectively enhances reasoning in LLMs by optimizing reasoning paths, validated by strong experimental results.
...
TL;DR: A study proposes using NER and RE with BERT variants to extract ORR catalyst data from literature, achieving high accuracy with domain-specific models like PubMedBERT and MatSciBERT.


<details>
  <summary>Details</summary>
Motivation: Extracting structured ORR catalyst information from complex literature is challenging, necessitating advanced NLP methods.
...
Conclusion: Domain-specific BERT models are reliable for scalable, automated ORR catalyst extraction from literature.
...
Method: Analyzed the computational complexity of LLM inference, providing examples of tasks beyond their capability.

Result: LLMs fail at tasks exceeding a certain complexity and cannot verify accuracy for such tasks.

Conclusion: This highlights inherent limitations of LLMs in complex, real-world applications.
...
TL;DR: A framework for generating and refining psychological counseling dialogues in Chinese, combining expert knowledge and limited real-world data to create CPsDD and CADSS, achieving top performance in support tasks.


<details>
  <summary>Details</summary>
Motivation: Address the scarcity of non-English psychological support datasets by leveraging expert knowledge and limited data to improve dialogue quality.

Method: Fine-tune two models (Dialog Generator and Dialog Modifier) to create and refine dialogues, then build CPsDD and CADSS for automated support.

Result: CPsDD contains 68K dialogues; CADSS excels in Strategy Prediction and ESC tasks on CPsDD and ESConv datasets.

Conclusion: The proposed framework effectively addresses dataset scarcity and enhances psychological support performance in non-English contexts.
...
<details>
  <summary>Details</summary>
Motivation: To address the gap in turn-taking research for multi-party (triadic) spoken dialogue, extending VAP beyond dyadic settings.
...
Result: Triadic VAP models outperformed dyadic baselines, though accuracy varied by conversation type.

Conclusion: VAP is viable for triadic turn-taking, with potential integration into spoken dialogue systems for future work.
...
TL;DR: LLMs with few-shot prompting outperform fine-tuned SLMs in multilingual subjectivity detection, especially in noisy data, achieving top rankings in CheckThat! 2025.


<details>
  <summary>Details</summary>
Motivation: To explore the effectiveness of LLMs with few-shot prompting for multilingual subjectivity detection, particularly in noisy or low-quality data settings.

Method: Used LLMs with carefully designed few-shot prompts, experimenting with advanced techniques like debating LLMs and example selection strategies.
...
TL;DR: The paper studies cross-lingual RAG in domain-specific settings, revealing retrieval as a bottleneck, and proposes a simple strategy to improve performance.


<details>
  <summary>Details</summary>
Motivation: To address hidden retrieval challenges in cross-lingual RAG, especially in domain-specific scenarios, by using real-world corporate datasets.

Method: Analyzed Arabic-English RAG with benchmarks derived from corporate data, studying retrieval behavior systematically.

Result: Retrieval is a bottleneck in cross-lingual scenarios, with performance drops when query and document languages differ. A proposed retrieval strategy improves performance.

Conclusion: The study highlights opportunities for enhancing multilingual retrieval in practical RAG applications.
...
TL;DR: The paper investigates the roles of long-CoT SFT and RL in VLMs, finding SFT improves complex reasoning but harms simpler tasks, while RL enhances generalization but struggles with hard questions. Combining them fails to yield additive benefits, revealing a 'synergy dilemma.'


<details>
  <summary>Details</summary>
Motivation: To understand the distinct roles and interplay of long-CoT SFT and RL in VLMs, as their joint effectiveness remains uncertain despite synergy in language-only models.
...
Result: SFT improves complex reasoning but introduces verbosity and degrades simpler task performance. RL enhances generalization and brevity but less so for hard questions. Combining them leads to trade-offs without additive benefits.
...
TL;DR: M4Doc is a framework for Document Image Machine Translation (DIMT) that aligns an image-only encoder with a Multimodal Large Language Model (MLLM) to improve translation quality and generalization.
...
Method: Introduces M4Doc, a single-to-mix modality alignment framework leveraging MLLMs for visual-textual correlation learning.
...
Conclusion: M4Doc effectively enhances DIMT performance while maintaining computational efficiency.
...
Method: Monte Carlo marginalization over K corruptions to approximate the posterior, with a lightweight ensemble averaging K mask-and-denoise passes.
...
Conclusion: The method provides a consistent, efficient way to enhance language model performance and uncertainty estimation using Bayesian principles.
...
<details>
  <summary>Details</summary>
Motivation: LLMs are resource-intensive, limiting real-world deployment. This work explores KD to compress LLMs for QA tasks without significant performance loss.

Method: KD is applied to Pythia and Qwen2.5 models, evaluated on SQuAD and MLQA benchmarks under zero-shot and one-shot prompting.
...
Conclusion: KD with minimal prompting enables efficient, high-performing QA systems for resource-constrained environments.
...
TL;DR: The paper challenges the need for large-scale fine-tuning in retrieval-augmented generation (RAG) for complex QA tasks, showing improved performance with better prompts and frugality via supervised/RL fine-tuning.


<details>
  <summary>Details</summary>
Motivation: To address the overlooked efficiency metric (number of retrieval searches) in RAG systems and reduce reliance on large-scale fine-tuning.

Method: Uses a standard ReAct pipeline with improved prompts and demonstrates frugality via supervised/RL fine-tuning with minimal training data (1000 examples).

Result: Outperforms state-of-the-art methods on HotPotQA with fewer searches (half the cost) and small training overhead.

Conclusion: Efficient RAG is achievable without extensive fine-tuning, emphasizing frugality and improved prompting.
...
TL;DR: The paper introduces Phonetic Cloaking Replacement (PCR) in Chinese content moderation, presents a dataset of real-world PCR examples, benchmarks LLMs, and proposes a Pinyin-based solution to improve detection.


<details>
  <summary>Details</summary>
Motivation: PCR is a growing challenge in Chinese content moderation, but existing evaluations rely on synthetic data, ignoring real user creativity.

Method: The authors organize PCR into a taxonomy, compile a dataset of 500 real PCR posts, and test LLMs, including zero-shot chain-of-thought prompting. They revisit Pinyin-based prompting for improvement.

Result: State-of-the-art LLMs perform poorly (F1-score: 0.672), and zero-shot prompting worsens results. Pinyin-based prompting recovers lost accuracy.

Conclusion: The study provides a PCR taxonomy, a realistic benchmark, and a lightweight mitigation technique, advancing robust toxicity detection.
...
<details>
  <summary>Details</summary>
Motivation: To provide an objective, automated metric for assessing summarization quality without relying on human-generated references.
...
Result: NOIR effectively captures the tradeoff and correlates with human perception of summarization quality.

Conclusion: NOIR is a versatile tool for evaluating and improving summarization algorithms and prompts.
...
TL;DR: The paper introduces Simulated Attention Score (SAS), a method to enhance Transformer performance by simulating more attention heads and larger hidden dimensions without increasing parameters, and proposes Parameter-Efficient Attention Aggregation (PEAA) to control costs.


<details>
  <summary>Details</summary>
Motivation: The performance of multi-head attention (MHA) improves with more heads and larger hidden sizes, but increasing these directly raises parameter costs. SAS aims to achieve similar gains efficiently.

Method: SAS projects low-dimensional head representations into higher-dimensional spaces to simulate more heads and larger hidden dimensions. PEAA is introduced to manage parameter costs.

Result: Experiments show SAS outperforms other attention variants across tasks and datasets, achieving performance gains with minimal parameter overhead.

Conclusion: SAS effectively enhances Transformer performance by simulating larger models without increasing parameters, validated by comprehensive experiments.
...
TL;DR: K2RAG is a novel framework combining dense/sparse vector search, knowledge graphs, and summarization to improve RAG scalability and accuracy, achieving faster training and execution.
...
TL;DR: The paper verifies and extends the Vec2Text framework, confirming its ability to reconstruct original texts from embeddings but highlighting privacy risks and proposing defenses like quantization.
...
Method: Reproduces Vec2Text, validates claims, and conducts additional experiments like parameter sensitivity analysis and evaluating defenses (e.g., quantization).

Result: Vec2Text effectively reconstructs texts, even sensitive inputs like passwords, but is sensitive to sequence length. Quantization and noise mitigate privacy risks.
...
TL;DR: The paper introduces Selective-DPO, a method for post-training alignment of LLMs by prioritizing high-impact tokens, reducing computational costs and improving alignment fidelity.


<details>
  <summary>Details</summary>
Motivation: Aligning large language models is challenging due to unequal token contributions. The goal is to optimize alignment by focusing on informative tokens.

Method: The approach uses token-level log-probability differences between the current policy and a reference model to select high-impact tokens for alignment.

Result: Experiments on Arena-Hard and MT-Bench show Selective-DPO outperforms standard DPO and distillation-based methods.
...
Method: Collection and manual annotation of peer-reviewed papers, documenting languages, datasets, metrics, models, and performance.

Result: Insights into current research efforts, available resources, and challenges in end-to-end ASR for code-switching.
...
TL;DR: A comprehensive review of LLMs in the legal domain, introducing a dual-lens taxonomy, highlighting advancements and challenges, and proposing future directions.
...
Conclusion: Proposes a roadmap for future research and practice, emphasizing low-resource systems, multimodal integration, and dynamic rebuttal handling.
...
TL;DR: StreamUni introduces a unified Large Speech-Language Model (LSLM) for Streaming Speech Translation (StreamST), eliminating the need for separate segmentation models and policy training by using speech Chain-of-Thought (CoT) for multi-stage outputs.


<details>
  <summary>Details</summary>
Motivation: Existing StreamST methods rely on sentence-level segments (SimulST), limiting context and complicating policy learning due to speech complexity and cross-lingual challenges.

Method: StreamUni integrates speech CoT into LSLM to guide multi-stage outputs, enabling simultaneous segmentation, policy decisions, and translation without extensive policy training. A streaming CoT training method enhances low-latency performance.

Result: StreamUni achieves state-of-the-art performance on StreamST tasks.

Conclusion: StreamUni offers a unified, efficient solution for StreamST, overcoming limitations of existing methods.
...
Method: A Transformer-based decoder-only model is trained to invert STL formula embeddings, using a small vocabulary derived from STL syntax.

Result: The model generates valid formulae quickly (after 1 epoch) and generalizes to STL semantics in about 10 epochs, producing simpler yet semantically close formulae.

Conclusion: The model effectively captures semantic information, generalizes well, and is successfully deployed for requirement mining tasks, optimizing directly in the semantic space.
...
TL;DR: The paper explores how repetition neurons in LLMs affect in-context learning (ICL) performance, showing layer-dependent impacts and suggesting ways to reduce repetitive outputs without compromising ICL.


<details>
  <summary>Details</summary>
Motivation: To understand the role of repetition neurons (not just attention heads) in LLMs' ICL performance and address repetitive output issues.

Method: Examined repetition neurons' impact on ICL across different layers and compared them with induction heads.

Result: Repetition neurons' influence on ICL varies by layer depth; strategies to reduce repetition while preserving ICL were identified.

Conclusion: Layer-specific repetition neurons play a key role in ICL, offering insights for optimizing LLM performance and reducing redundancy.
...
<details>
  <summary>Details</summary>
Motivation: The conventional auto-regressive objective in instruction tuning, which ignores prompt tokens in loss computation, may not be optimal. This work investigates the impact of weighting prompt and response tokens differently.

Method: The authors systematically study the effect of weighting prompt and response tokens in instruction tuning loss and introduce WIT. Experiments are conducted on five language models, three datasets, and five benchmarks.

Result: Standard instruction tuning often performs suboptimally. A balanced weighting (low-to-moderate for prompts, moderate-to-high for responses) yields the best performance and robustness.

Conclusion: The findings suggest rethinking instruction tuning loss for better robustness and generalizability. WIT offers a practical improvement, and the code is open-sourced.
...
TL;DR: A novel conditional unigram tokenization method is introduced, extending unigram tokenization by conditioning on source-language tokens. It aims to improve cross-lingual semantic alignment but shows mixed results in machine translation and language modeling.


<details>
  <summary>Details</summary>
Motivation: To enhance cross-lingual semantic alignment in tokenization by leveraging parallel data and source-language tokens.

Method: Conditional unigram tokenization, where target token probabilities are conditioned on source-language tokens from parallel data.

Result: Mixed results: no improvement in machine translation but consistent perplexity reductions in language modeling. Data efficiency is a bottleneck due to quadratic scaling.

Conclusion: Alternative parameterizations may be needed for practical cross-lingual tokenization, as the current method faces scalability issues.
...
TL;DR: The study examines how coreferential complexity in retrieved documents impacts RAG systems, showing that coreference resolution improves retrieval and QA performance, especially for smaller models.


<details>
  <summary>Details</summary>
Motivation: To address the ambiguity caused by coreferential complexity in RAG systems, which disrupts in-context learning and retrieval effectiveness.
...
TL;DR: Extends Alpay Algebra into a multi-layered semantic game architecture, formalizing AI-document alignment as a meta-game with nested sub-games, proving existence of semantic equilibria.


<details>
  <summary>Details</summary>
Motivation: To bridge AI systems and documents through game-theoretic reasoning, leveraging fixed-point iteration for natural emergence of alignment.

Method: Introduces a composite operator for semantic convergence and sub-game resolution, supported by category theory, information theory, and cognitive models.

Result: Proves existence and uniqueness of semantic equilibria, with verification via Banach's theorem adaptations and novel topology.

Conclusion: Demonstrates practical applicability of the framework, embedding the paper itself as a semantic artifact to propagate its concepts.
...
<details>
  <summary>Details</summary>
Motivation: Existing CHAs lack adaptive reasoning and transparency, limiting their clinical use.
...
TL;DR: An automated pipeline using LLMs (Gemini 2.0 Flash) and web automation streamlines MD input file generation, reducing setup time and errors.
...
Method: Integrates LLMs (Gemini 2.0 Flash), Python scripting, and Selenium web automation with CHARMM GUI to generate NAMD input files.

Result: Reduces setup time, minimizes errors, and scales for parallel processing of multiple protein systems.
...
<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of uncovering evolving themes in growing textual data and improving fragmented pipelines in existing dynamic topic modeling techniques.

Method: Introduces DTECT, a unified workflow with preprocessing, multiple model architectures, evaluation metrics, LLM-driven labeling, trend analysis, visualizations, and a chat interface.

Result: Enhances interpretability and user-friendly exploration of temporal topic models.

Conclusion: DTECT provides a cohesive platform for tracking thematic dynamics, available as open-source.
...
TL;DR: SAGE is a VLM-based framework improving industrial anomaly detection with Self-Guided Fact Enhancement and Entropy-aware Direct Preference Optimization, outperforming existing models in zero-shot and one-shot settings.
...
Method: SAGE integrates domain knowledge via SFE and aligns outputs with expert preferences using E-DPO, supported by the AD-PL dataset.

Result: SAGE achieves superior performance on industrial anomaly datasets, validated by the Multiscale Logical Evaluation framework.

Conclusion: SAGE addresses key limitations of VLMs in anomaly detection, offering a robust, interpretable, and generalizable solution.
...
TL;DR: MIRIX is a modular, multi-agent memory system for AI, addressing limitations of existing solutions by incorporating rich multimodal experiences and structured memory types. It outperforms baselines in accuracy and efficiency.


<details>
  <summary>Details</summary>
Motivation: Existing AI memory solutions are limited in personalization, abstraction, and recall. MIRIX aims to enable language models to truly remember by embracing multimodal data and structured memory.

Method: MIRIX uses six structured memory types (Core, Episodic, Semantic, Procedural, Resource Memory, Knowledge Vault) and a multi-agent framework for dynamic control. It is validated on multimodal (ScreenshotVQA) and textual (LOCOMO) benchmarks.

Result: MIRIX achieves 35% higher accuracy than RAG on ScreenshotVQA and 85.4% on LOCOMO, setting new performance standards. It also reduces storage by 99.9%.

Conclusion: MIRIX redefines AI memory with its modular, multimodal approach, demonstrating superior performance and practical applicability in real-world scenarios.
...
TL;DR: Smaller language models (SLMs) with retrieval-augmented generation (RAG) outperform larger models in rheumatology, offering energy efficiency and local deployment, but still require expert oversight.
...
Method: Evaluated smaller language models (SLMs) combined with retrieval-augmented generation (RAG) against larger models for diagnostic and therapeutic performance.

Result: SLMs with RAG achieved higher performance than larger models, with lower energy costs and suitability for local deployment.

Conclusion: While SLMs with RAG are promising for rheumatology, expert oversight is necessary as they do not consistently match specialist-level accuracy.
...
Result: LLM-w-Ref correlates strongly with expert judgments. Smaller models like MedGemma-27B outperform larger proprietary models (e.g., OpenAI-o3).

Conclusion: MedThink-Bench provides a foundational tool for safe and responsible LLM deployment in clinical practice.
...
<details>
  <summary>Details</summary>
Motivation: Prior approaches in visual reasoning are limited by predefined workflows and static toolsets, restricting flexibility and interpretability.

Method: PyVision is an interactive, multi-turn framework that allows MLLMs to create, execute, and refine task-specific Python tools.
...
TL;DR: Frontier LLMs fail on simple reasoning tasks despite excelling in complex ones, highlighting issues with out-of-distribution generalization and systematic errors.


<details>
  <summary>Details</summary>
Motivation: To study why state-of-the-art LLMs struggle with tasks easy for humans, despite their advanced reasoning capabilities.

Method: Created a suite of procedurally generated simple reasoning tasks and introduced the unpuzzles dataset to analyze model behavior.

Result: LLMs consistently fail on simple tasks due to statistical shortcuts, intermediate errors, and long-context processing issues.

Conclusion: Out-of-distribution generalization remains a challenge for LLMs, even for trivial tasks, and simplifying tasks doesn't guarantee better performance.
...
<details>
  <summary>Details</summary>
Motivation: Accurate segmentation of carotid arteries and plaques is vital for atherosclerosis and stroke risk assessment, but complex morphology and scarce labeled data pose challenges.

Method: Proposes a two-network system: coarse localization followed by fine segmentation, with multi-level multi-sequence U-Net and semi-supervised learning for data efficiency.

Result: Evaluated on 52 patients, the approach shows effectiveness, emphasizing fusion strategy importance and achieving expert-validated accuracy.
...
<details>
  <summary>Details</summary>
Motivation: The increasing volume of imaging data requires efficient storage solutions, prompting investigation into deep learning-based compression for XCT data.
...
Result: Different architectures and compression rates are needed based on desired data characteristics, with findings aiding storage and analysis strategy decisions.

Conclusion: The study provides guidance for selecting compression methods tailored to specific XCT data analysis needs.
...
TL;DR: GridTD is an unsupervised continuous representation framework for compressive imaging (CI) reconstruction, combining tensor decomposition and multi-resolution grid encoding for efficient and accurate high-dimensional image recovery.


<details>
  <summary>Details</summary>
Motivation: Existing unsupervised representations for CI reconstruction struggle to balance representation ability and efficiency. GridTD addresses this by leveraging tensor decomposition and multi-resolution grid encoding.

Method: GridTD optimizes a lightweight neural network and tensor decomposition model using multi-resolution hash grid encoding, combining hierarchical modeling and compactness.

Result: Theoretical analyses and experiments show GridTD outperforms existing methods in tasks like video SCI, spectral SCI, and compressive dynamic MRI reconstruction.
...
<details>
  <summary>Details</summary>
Motivation: The scarcity of expert-annotated breast ultrasound (BUS) data limits robust deep learning model development.

Method: Proposes a generative framework integrating clinical descriptions and structural masks to synthesize BUS images with controlled tumor characteristics. Includes a semantic-curvature mask generator for diverse tumor masks.
...
Conclusion: The framework effectively addresses data scarcity and supports clinical applications by generating realistic BUS images.
...
<details>
  <summary>Details</summary>
Motivation: Traditional prognostic models for ccRCC recurrence, relying on single data modalities, often fail due to disease complexity and heterogeneity.
...
Result: The multimodal DL approach enhances predictive accuracy by combining complementary data sources.

Conclusion: This framework improves ccRCC recurrence prediction and clinical decision-making, even with missing data.
...
<details>
  <summary>Details</summary>
Motivation: Current methods for assessing cerebral vasculature lack standardized quantitative metrics and face challenges like user variability. ArteryX aims to improve sensitivity to subtle vascular changes.

Method: ArteryX uses a semi-supervised, vessel-fused network-based approach to track and quantify arterial features, integrating a simulation framework for validation.

Result: ArteryX processes data in ~10-15 minutes per subject, outperforms existing methods, and detects subtle vascular changes effectively.

Conclusion: ArteryX offers a standardized, efficient tool for early cerebrovascular pathology detection and comparative studies.
